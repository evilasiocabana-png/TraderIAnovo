"""Testes do experimento controlado da Alpha003."""
...
from research.alpha003.alpha003_experiment import (
    Alpha003Experiment,
    Alpha003ExperimentResult,
)
...
class Alpha003ExperimentTest(unittest.TestCase):
    """Valida execucao estrutural da Alpha003 sem metricas financeiras."""

    def test_resultado_e_dataclass_frozen(self) -> None:
        self.assertTrue(is_dataclass(Alpha003ExperimentResult))
        self.assertTrue(Alpha003ExperimentResult.__dataclass_params__.frozen)

    def test_resultado_e_imutavel(self) -> None:
        result = Alpha003ExperimentResult(
            total_candles=0,
            total_signals=0,
            total_buy=0,
            total_sell=0,
    ...
    def test_experiment_executa_replay_e_consolida_sinais(self) -> None:
        ...
        self.assertIsInstance(result, Alpha003ExperimentResult)
    ...
    def test_experiment_default_gera_features_da_opening_range(self) -> None:
        experiment = Alpha003Experiment(
            config=self._config(),
            candles=self._candles(),
            strategy=_InspectingStrategy(),
    ...
    def test_experiment_nao_calcula_metricas_financeiras(self) -> None:
        source = read_source(Path("research/alpha003/alpha003_experiment.py"))
        forbidden_fragments = (
            "gross_profit",
            "gross_loss",
            "net_profit",
    ...
    def test_experiment_permanece_desacoplado_de_operacao(self) -> None:
        path = Path("research/alpha003/alpha003_experiment.py")
    ...
    def _candles(self) -> tuple[Candle, ...]:
        return (
            ...
            Candle("2026-06-27T10:02:00-03:00", 5500.0, 5510.0, 5490.0, 5500.0, 1800),
        )
    ...
    def _feature_report(
        ...
        return FeatureReport(
            ...
            calculated_values={
                ...
                "opening_range_high": candle.maxima,
                "opening_range_low": candle.minima,
