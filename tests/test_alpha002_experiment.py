"""Testes do experimento controlado da Alpha002."""
...
from research.alpha002.alpha002_experiment import (
    Alpha002Experiment,
    Alpha002ExperimentResult,
)
...
class Alpha002ExperimentTest(unittest.TestCase):
    """Valida execucao estrutural da Alpha002 sem metricas financeiras."""

    def test_resultado_e_dataclass_frozen(self) -> None:
        self.assertTrue(is_dataclass(Alpha002ExperimentResult))
        self.assertTrue(Alpha002ExperimentResult.__dataclass_params__.frozen)

    def test_resultado_e_imutavel(self) -> None:
        result = Alpha002ExperimentResult(
            total_candles=0,
            total_signals=0,
            total_buy=0,
            total_sell=0,
    ...
    def test_experiment_executa_replay_e_consolida_sinais(self) -> None:
        ...
        self.assertIsInstance(result, Alpha002ExperimentResult)
    ...
    def test_experiment_nao_calcula_metricas_financeiras(self) -> None:
        source = read_source(Path("research/alpha002/alpha002_experiment.py"))
        forbidden_fragments = (
            "gross_profit",
            "gross_loss",
            "net_profit",
    ...
    def test_experiment_permanece_desacoplado_de_operacao(self) -> None:
        path = Path("research/alpha002/alpha002_experiment.py")
