...
EXPECTED_PUBLIC_API: dict[str, dict[str, object]] = {'Alpha001ResearchService': {'methods': {'run': '(self, experiment_result: '
 ...
 'ConfigurationService': {'methods': {'delete_preset': '(self, name: str) -> None',
 ...
 'DashboardService': {'methods': {'analyze_selected_historical_dataset_quality': '(self) -> '
                                                                                 'application.dashboard_service.HistoricalDatasetQualityReport',
                                  'arm_demo_robot': "(self, pair: str = 'TODOS', timeframe: str = "
                                                    "'H1') -> "
                                  ...
                                  'evaluate_armed_demo_robot_once': "(self, pair: str = 'TODOS', "
                                                                    "timeframe: str = 'H1') -> "
                                                                    'application.dashboard_view_model.DashboardDemoRobotViewModel',
                                  'execute_dynamic_exit_demo_sl_assisted': '(self, *, symbol: str, '
                                                                           'ticket: int, side: '
                                                                           'str, current_stop: '
                                                                           'float, approved_stop: '
                                                                           'float, current_price: '
                                                                           'float, candle_key: str '
                                                                           "= 'N/D', "
                                                                           'user_confirmed: bool = '
                                                                           'False) -> '
                                                                           'domain.contracts.dynamic_exit_demo_sl.DynamicExitDemoSLExecutionResult',
                                  'export_alpha001_results_to_csv': '(self, output_path: object) '
                                                                    '-> object',
                                  'export_mt5_visual_signals': '(self, output_path: object | None '
                                                               '= None) -> '
                                                               'application.mt5_visual_signal_exporter.MT5VisualSignalExportResult',
                                  'filter_alpha001_parameter_ranking': '(self, validation_status: '
                                                                       'str) -> '
                                  ...
                                  'get_alpha001_status': '(self) -> '
                                                         'application.dashboard_service.Alpha001StatusData',
                                  'get_dashboard_contract_version': '(self) -> str',
                                  'get_dashboard_data': '(self) -> '
                                                        'application.dashboard_service.DashboardData',
                                  ...
                                  'get_mt5_alpha_research_report': '(self, alpha_id: str = '
                                  ...
                                  'list_dynamic_exit_demo_sl_audit_log': '(self) -> '
                                                                         'list[domain.contracts.dynamic_exit_demo_sl.DynamicExitDemoSLExecutionResult]',
                                  'list_historical_dataset_quality_validations': '(self, '
                                                                                 'dataset_id: str) '
                                                                                 '-> '
                                  ...
                                  'load_configuration_preset': '(self, name: str) -> '
                                                               'application.configuration_service.ConfigurationData',
                                  'load_demo_replay_candles': '(self) -> '
                                                              'application.replay_service.ReplayData',
                                  'load_historical_replay_csv': '(self, path: object) -> '
                                                                'application.replay_service.ReplayData',
                                  'load_mt5_forex_signals': "(self, timeframe: str = 'M1') -> "
                                                            'application.mt5_market_data_service.MT5ForexSignalDashboard',
                                  'load_mt5_market_data': "(self, symbol: str = 'EURUSD', "
                                                          "timeframe: str = 'M1', count: int | "
                                                          'None = None) -> '
                                                          'application.mt5_market_data_service.MT5DashboardMarketData',
                                  ...
                                  'run_demo_research_experiment': '(self) -> '
                                                                  'application.research_lab_service.ResearchExperimentData',
                                  'run_demo_robot_for_all': '(self, pairs: list[str] | None = '
                                                            "None, timeframe: str = 'H1') -> "
                                                            'application.dashboard_view_model.DashboardDemoRobotViewModel',
                                  ...
                                  'run_online_demo_robot_cycle': "(self, pair: str = 'TODOS', "
                                                                 "timeframe: str = 'H1') -> "
                                                                 'application.dashboard_view_model.DashboardDemoRobotViewModel',
                                  'run_selected_historical_dataset_research_experiment': '(self, '
                                                                                         'strategy_name: '
                                                                                         'str = '
                                                                                         "'alpha001_iorb', "
                                                                                         'stop_points: '
                                  ...
                                  'suggest_mt5_lab_setups': '(self, target_confidence: float = '
                                                            '0.7) -> '
 ...
 'DemoExecutionService': {'methods': {'get_atr': "(self, symbol: 'str', timeframe: "
                                      ...
                                      'prepare_order': "(self, strategy_signal: 'StrategySignal', "
                                                       ...
                                                       "entry_price: 'float', stop_points: "
                                                       "'float', target_points: 'float') -> "
                                                       "'tuple[DecisionContext, ExecutionOrder | "
                                                       "None]'",
                                      'register_daily_result': "(self, result_points: 'float') -> "
                                                               "'None'",
                                      'submit_demo_order': '(self, decision_context: '
                                                           "'DecisionContext', order: "
                                                           "'ExecutionOrder | None', "
                                                           "paper_validated: 'bool') -> "
                                                           "'ExecutionResult'"},
                          'module': 'application.demo_execution_service'},
 'DynamicExitDemoSLExecutionService': {'methods': {'execute_assisted': '(self, *, decision: '
                                                                       "'DynamicExitSimulationDecision', "
                                                                       'executor: '
                                                                       "'DynamicExitDemoSLExecutor "
                                                                       "| None', enabled: 'bool' = "
                                                                       'False, user_confirmed: '
                                                                       "'bool' = False, "
                                                                       "robot_armed: 'bool' = "
                                                                       'False, '
                                       ...
                                       'module': 'application.dynamic_exit_demo_sl_execution_service'},
 'DynamicExitSimulationService': {'methods': {'list_decisions': '(self) -> '
                                                                "'list[DynamicExitSimulationDecision]'",
                                              'simulate': '(self, *, reading: '
                                                          "'DynamicExitMarketReading', "
                                                          'recommendation: '
                                                          "'DynamicExitRecommendation', "
                                                          "plan_status: 'str' = 'PLANO_VALIDO', "
                                                          "enabled: 'bool' = False, robot_armed: "
                                                          "'bool' = False, ticket: 'int | None' = "
                                                          "None, candle_key: 'str' = 'N/D', "
                                                          "atr_multiplier: 'float' = 1.0) -> "
                                                          "'DynamicExitSimulationDecision'"},
                                  'module': 'application.dynamic_exit_simulation_service'},
 'ForexMT5Service': {'methods': {'get_open_positions': "(self) -> 'list[dict[str, object]]'",
                                 'get_signals': "(self, timeframe: 'str' = 'M1') -> "
                                                "'list[ForexSignal]'",
 ...
 'LiveResearchService': {'methods': {'get_latest_data': "(self) -> 'LiveResearchData | None'",
                                     ...
                                     'ingest_from_mt5': "(self, symbol: 'str', timeframe: 'Any', "
                                                        "count: 'int' = 10) -> 'LiveResearchData | "
                                                        "None'",
                                     'list_signal_quality': '(self) -> '
                                                            "'list[LiveResearchSignalQuality]'",
                                     'list_snapshot_history': '(self) -> '
                                                              "'list[LiveResearchSnapshotRecord]'",
                                     'process_candle': "(self, candle: 'Candle', symbol: 'str' = "
                                                       "'UNKNOWN', timeframe: 'str' = 'UNKNOWN', "
                                                       "ingestion_summary: 'MT5IngestionSummary | "
                                                       "None' = None, publish_new_candle: 'bool' = "
                                                       "True) -> 'LiveResearchData'",
                                     'set_snapshot_history_limit': "(self, limit: 'int') -> "
                                                                   "'None'"},
                         'module': 'application.live_research_service'},
 'MT5DemoRobotService': {'methods': {'evaluate_once': "(self, signal: 'MT5DemoRobotSignal', "
 ...
 'MT5MarketDataService': {'methods': {'diagnose_mt5_connection': "(self, symbol: 'str' = 'EURUSD', "
                                      ...
                                      'ingest_candles': "(self, symbol: 'str', timeframe: 'Any', "
                                                        "count: 'int' = 10) -> "
                                                        "'MT5IngestionSummary'",
                                      'load_dashboard_market_data': "(self, symbol: 'str' = "
                                                                    "'EURUSD', timeframe: 'str' = "
                                                                    "'M1', count: 'int | None' = "
                                                                    'None) -> '
                                                                    "'MT5DashboardMarketData'",
                                      ...
                                      'load_forex_signal_dashboard': "(self, timeframe: 'str' = "
                                                                     "'M1', recalculate_research: "
                                                                     "'bool | None' = None) -> "
                                                                     "'MT5ForexSignalDashboard'",
                                      'load_forex_signal_dashboard_for_timeframes': '(self, '
                                                                                    'timeframes_by_pair: '
                                                                                    "'dict[str, "
                                                                                    "str]', "
                                                                                    'fallback_timeframe: '
 ...
 'MT5TradeAuditService': {'methods': {'build_report': "(self, *, signals: 'list[ForexSignal]', "
                                                      ...
                                                      "'TradeAuditReport'"},
                          'module': 'application.mt5_trade_audit_service'},
 'MarketService': {'methods': {'get_latest_market_dna': '(self) -> '
                                                        'domain.contracts.market_snapshot.MarketSnapshot '
                                                        '| None',
 ...
 'PaperTradingService': {'methods': {'alpha001_strategy': '(self) -> '
 ...
 'ReplayService': {'methods': {'disable_auto_run': '(self) -> '
                                                   'application.replay_service.ReplayData',
                               ...
                               'load_candles': '(self, candles: list[domain.candle.Candle]) -> '
                                               'application.replay_service.ReplayData',
                               'load_demo_candles': '(self) -> '
                                                    'application.replay_service.ReplayData',
                               'load_historical_csv': '(self, path: object) -> '
                                                      'application.replay_service.ReplayData',
                               ...
                               'load_historical_dataset': '(self, dataset: '
                                                          ...
                                                          '-> '
                                                          'application.replay_service.ReplayData',
                               'load_real_historical_dataset': "(self, symbol: str = 'WDO', "
                                                               "timeframe: str = '1m', period: str "
                                                               "= '2025') -> "
                                                               'application.replay_service.ReplayData',
                               'next_candle': '(self) -> application.replay_service.ReplayData',
                               'reset': '(self) -> application.replay_service.ReplayData',
                               'select_strategy': '(self, strategy_name: str) -> '
                                                  'application.replay_service.ReplayData',
 ...
 'ReportService': {'methods': {'build_rows': "(self, forex: 'MT5Status', lab: 'LabResult') -> "
                                             "'list[ReportRow]'",
                               'build_summary': "(self, forex: 'MT5Status', lab: 'LabResult', "
                                                "audit: 'TradeAuditReport') -> 'dict[str, "
                                                "object]'"},
                   'module': 'application.report_service'},
 'ResearchLabService': {'methods': {'alpha001_dashboard_research_metrics': '(self) -> '
                                    ...
                                    'compare_benchmarks': '(self) -> '
                                                          'application.research_lab_service.BenchmarkComparisonData',
                                    'export_alpha001_results_to_csv': '(self, output_path: str | '
                                                                      'pathlib.Path) -> '
                                                                      'pathlib.Path',
                                    'get_alpha001_research_summary': '(self) -> '
                                                                     'application.research_lab_service.Alpha001ResearchSummaryData',
                                    ...
                                    'live_experiment_summary': '(self) -> '
                                                               'application.research_lab_service.LiveExperimentSummaryData',
                                    'research_report': '(self) -> '
                                                       'application.research_lab_service.ResearchReportData',
                                    'run_alpha001_parameter_ranking': '(self) -> '
                                                                      'list[application.research_lab_service.Alpha001ParameterRankingData]',
                                    'run_alpha001_research': '(self, candles: '
                                                             'list[domain.candle.Candle], config: '
                                                             'alpha.alpha001_config.Alpha001Config '
                                                             '| None = None, experiment_name: str '
                                                             "= 'Alpha001 Research') -> "
                                                             'research.alpha001_research_report.Alpha001ResearchResult',
                                    'run_demo_alpha001_experiment': '(self) -> '
                                                                    'application.research_lab_service.ResearchExperimentData',
                                    ...
                                    'run_demo_parameter_grid': '(self) -> '
                                                               'list[application.research_lab_service.ParameterGridData]',
                                    'run_historical_csv_experiment': '(self, path: str | '
                                                                     'pathlib.Path, '
                                                                     'experiment_name: str = '
                                                                     "'Historical WDO Research', "
                                                                     'strategy_name: str = '
                                                                     "'alpha001_iorb', "
                                                                     ...
                                                                     '100.0) -> '
                                                                     'application.research_lab_service.ResearchExperimentData',
                                    'run_historical_data_experiment': '(self, source: object, '
                                                                      'experiment_name: str = '
                                                                      "'Historical WDO Research', "
                                                                      'strategy_name: str = '
                                                                      "'alpha001_iorb', "
                                                                      'stop_points: float = 50.0, '
                                                                      'target_points: float = '
                                                                      "100.0, symbol: str = 'WDO', "
                                                                      "timeframe: str = 'UNKNOWN') "
                                                                      '-> '
                                                                      'application.research_lab_service.ResearchExperimentData',
                                    'run_historical_experiment': '(self, candles: '
                                                                 'list[domain.candle.Candle], '
                                                                 'experiment_name: str = '
                                                                 "'Historical WDO Research', "
                                                                 'strategy_name: str = '
                                                                 "'alpha001_iorb', stop_points: "
                                                                 'float = 50.0, target_points: '
                                                                 'float = 100.0) -> '
                                                                 'application.research_lab_service.ResearchExperimentData',
                                    'run_real_data_benchmarks': "(self, symbol: str = 'WDO', "
                                                                "timeframe: str = '1m', period: "
                                                                "str = '2025') -> "
                                                                'list[application.research_lab_service.BenchmarkData]',
                                    'run_real_data_research': "(self, symbol: str = 'WDO', "
                                                              "timeframe: str = '1m', period: str "
                                                              "= '2025') -> "
 ...
 'ResearchService': {'methods': {'analyze': '(self, feature_snapshot: '
                                            'market.feature_engine.FeatureSnapshot, '
                                            'regime_analysis: market.regime_engine.RegimeAnalysis, '
