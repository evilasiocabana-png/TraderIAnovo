"""Testes do experimento controlado da Alpha201."""
...
from research.alpha201.alpha201_experiment import (
    Alpha201Experiment,
    Alpha201ExperimentResult,
)
...
class Alpha201ExperimentTest(unittest.TestCase):
    """Valida execucao estrutural da Alpha201 sem metricas financeiras."""

    def test_resultado_e_dataclass_frozen(self) -> None:
        self.assertTrue(is_dataclass(Alpha201ExperimentResult))
        self.assertTrue(Alpha201ExperimentResult.__dataclass_params__.frozen)

    def test_resultado_e_imutavel(self) -> None:
        result = Alpha201ExperimentResult(
            total_candles=0,
            total_signals=0,
            total_buy=0,
            total_sell=0,
    ...
    def test_experiment_executa_replay_e_consolida_sinais(self) -> None:
        ...
        self.assertIsInstance(result, Alpha201ExperimentResult)
    ...
    def test_experiment_default_gera_features_de_position_trade(self) -> None:
        experiment = Alpha201Experiment(
            config=self._config(),
            candles=self._candles(),
            strategy=_InspectingStrategy(),
    ...
    def test_experiment_nao_calcula_metricas_financeiras(self) -> None:
        source = read_source(Path("research/alpha201/alpha201_experiment.py"))
        forbidden_fragments = (
            "gross_profit",
            "gross_loss",
            "net_profit",
    ...
    def test_experiment_permanece_desacoplado_de_operacao(self) -> None:
        path = Path("research/alpha201/alpha201_experiment.py")
    ...
    def _feature_report(
        ...
        return FeatureReport(
            ...
            calculated_values={
                ...
                "structural_trend": "UP",
                "directional_persistence": 1.0 if momentum > 0 else -1.0 if momentum < 0 else 0.0,
