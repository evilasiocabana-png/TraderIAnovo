...
_MODEL15_RUNTIME_STATE_PATH = Path(".traderia") / "model15_runtime_state.json"
_MODEL16_RUNTIME_STATE_PATH = Path(".traderia") / "model16_runtime_state.json"
_MT5_TRADE_AUDIT_SNAPSHOT_PATH = (
    Path(".traderia") / "runtime" / "mt5_trade_audit_report.json"
)
...
from application.lab_operational_model_service import (
    ...
    MODEL_3_ID as MT5_HISTORICAL_MODEL_3,
    MODEL_4_ID as MT5_OPERATIONAL_MODEL_4,
    MODEL_5_ID as MT5_OPERATIONAL_MODEL_5,
    MODEL_8_ID as MT5_HISTORICAL_MODEL_8,
    MODEL_9_ID as MT5_HISTORICAL_MODEL_9,
    MODEL_10_ID as MT5_HISTORICAL_MODEL_10,
    MODEL_22_ID as MT5_HISTORICAL_MODEL_22,
)
from application.model6_original_trend_momentum import (
    ...
    MODEL_6_EXIT_POLICY,
    MODEL_6_CONFIDENCE,
    MODEL_6_ID as MT5_HISTORICAL_MODEL_6,
    MODEL_6_LEGACY_ID,
...
from application.model23_basket_accumulator import (
    MODEL_23_ALPHA_ID,
    MODEL_23_ALPHA_VERSION,
    MODEL_23_BETA_ID,
    MODEL_23_BETA_VERSION,
    MODEL_23_ENTRY_SOURCE,
    MODEL_23_EXIT_POLICY,
...
from application.model24_xau_basket import (
    ...
    mark_model24_initial_target_armed,
...
from application.xau_m5_sma_rsi_model_family import (
    ...
    MODEL_11_ID as MT5_OPERATIONAL_MODEL_11,
    MODEL_12_ID as MT5_OPERATIONAL_MODEL_12,
    MODEL_18_ID as MT5_OPERATIONAL_MODEL_18,
    MODEL_19_ID as MT5_OPERATIONAL_MODEL_19,
    MODEL_20_ID as MT5_OPERATIONAL_MODEL_20,
    MODEL_21_ID as MT5_OPERATIONAL_MODEL_21,
    ...
    evaluate_xau_native_trend_filter_entry,
    trend_filter_spec,
    xau_reentry_target,
...
from application.model15_xau_m5_breakout import (
    MODEL_15_ALPHA_ID,
    MODEL_15_ALPHA_VERSION,
    MODEL_15_BETA_ID,
    MODEL_15_BETA_VERSION,
    MODEL_15_ID as MT5_HISTORICAL_XAU_MODEL_15,
    MODEL_15_PIP_SIZE,
    ...
    model15_stop_management_parameters,
)
from application.model16_xau_m5_price_ema_breakout import (
    MODEL_16_ALPHA_ID,
    MODEL_16_ALPHA_VERSION,
    MODEL_16_BETA_ID,
    MODEL_16_BETA_VERSION,
    MODEL_16_ID as MT5_HISTORICAL_XAU_MODEL_16,
    MODEL_16_PIP_SIZE,
    ...
    model16_stop_management_parameters,
)
from application.dynamic_exit_model_family import (
    DYNAMIC_EXIT_BETA_MODE,
    DYNAMIC_EXIT_MODEL_IDS,
    DYNAMIC_EXIT_POLICY,
    MODEL_8_ID as MT5_HISTORICAL_DYNAMIC_MODEL_8,
    MODEL_9_ID as MT5_HISTORICAL_DYNAMIC_MODEL_9,
    MODEL_10_ID as MT5_HISTORICAL_DYNAMIC_MODEL_10,
    MODEL_11_ID as MT5_HISTORICAL_DYNAMIC_MODEL_11,
    MODEL_12_ID as MT5_HISTORICAL_DYNAMIC_MODEL_12,
    MODEL_13_ID as MT5_HISTORICAL_DYNAMIC_MODEL_13,
    MODEL_14_ID as MT5_HISTORICAL_DYNAMIC_MODEL_14,
    dynamic_exit_model_spec,
    dynamic_exit_parameters,
    dynamic_exit_source_model,
)
from application.forex_m5_sma_rsi_model_family import (
    MODEL_13_ID as MT5_OPERATIONAL_MODEL_13,
    MODEL_14_ID as MT5_OPERATIONAL_MODEL_14,
    MODEL_15_ID as MT5_OPERATIONAL_MODEL_15,
    MODEL_16_ID as MT5_OPERATIONAL_MODEL_16,
    MODEL_17_ID as MT5_OPERATIONAL_MODEL_17,
    FOREX_SMA_RSI_POSITION_MANAGEMENT_MODEL_IDS as FOREX_SMA_RSI_MODEL_IDS,
    FOREX_SMA_RSI_PAIRS,
    FOREX_SMA_RSI_TIMEFRAME,
    evaluate_forex_sma_rsi_entry,
    evaluate_forex_native_sma_rsi_entry,
    forex_sma_rsi_parameters,
    forex_sma_rsi_spec,
    load_forex_sma_rsi_runtime_state,
)
from application.mt5_native_m5_indicators import (
    load_native_m5_indicator_snapshot,
    load_native_m5_indicator_snapshots,
)
from application.mt5_position_profit_peak_store import (
    MT5PositionProfitPeak,
    MT5PositionProfitPeakStore,
)
...
from application.dashboard_view_model import (
    ...
    DashboardMT5LabReplayProofViewModel,
    DashboardMT5LabReplayTradeViewModel,
...
ENTRY_FILTER_SUPPORTED_INDICATORS = {
    "ADX baixo",
    "ATR em queda",
    "ATR subindo",
    "Momentum contra",
...
MT5_DYNAMIC_EXIT_OPERATIONAL_MODELS = set(DYNAMIC_EXIT_MODEL_IDS)
MT5_CUSTOM_OPERATIONAL_MODELS = {
    ...
    MT5_OPERATIONAL_MODEL_17,
    MT5_OPERATIONAL_MODEL_18,
...
MT5_OPERATIONAL_MODEL_8_TO_17_IDS = MT5_OPERATIONAL_MODEL_8_TO_22_IDS
MT5_OPERATIONAL_MODEL_BY_NUMBER = {
    1: MT5_OPERATIONAL_MODEL_1,
    2: MT5_OPERATIONAL_MODEL_2,
    3: MT5_OPERATIONAL_MODEL_3,
    4: MT5_OPERATIONAL_MODEL_4,
    5: MT5_OPERATIONAL_MODEL_5,
    6: MT5_OPERATIONAL_MODEL_6,
    7: MT5_OPERATIONAL_MODEL_7,
    8: MT5_OPERATIONAL_MODEL_8,
    9: MT5_OPERATIONAL_MODEL_9,
    10: MT5_OPERATIONAL_MODEL_10,
    11: MT5_OPERATIONAL_MODEL_11,
    12: MT5_OPERATIONAL_MODEL_12,
    13: MT5_OPERATIONAL_MODEL_13,
    14: MT5_OPERATIONAL_MODEL_14,
    15: MT5_OPERATIONAL_MODEL_15,
    16: MT5_OPERATIONAL_MODEL_16,
    17: MT5_OPERATIONAL_MODEL_17,
    18: MT5_OPERATIONAL_MODEL_18,
    19: MT5_OPERATIONAL_MODEL_19,
    20: MT5_OPERATIONAL_MODEL_20,
...
MT5_RETIRED_OPERATIONAL_MODEL_IDS = (
    ...
    MT5_HISTORICAL_MODEL_9,
    MT5_HISTORICAL_MODEL_10,
    MT5_HISTORICAL_DYNAMIC_MODEL_8,
    MT5_HISTORICAL_DYNAMIC_MODEL_9,
    MT5_HISTORICAL_DYNAMIC_MODEL_10,
    MT5_HISTORICAL_DYNAMIC_MODEL_11,
    MT5_HISTORICAL_DYNAMIC_MODEL_12,
    MT5_HISTORICAL_DYNAMIC_MODEL_13,
    MT5_HISTORICAL_DYNAMIC_MODEL_14,
    MT5_HISTORICAL_XAU_MODEL_15,
    MT5_HISTORICAL_XAU_MODEL_16,
    *OFFICIAL_ALPHA_MODEL_IDS,
    MT5_HISTORICAL_MODEL_22,
)
LEGACY_MT5_OPERATIONAL_MODELS = {
    ...
    MT5_HISTORICAL_MODEL_6: MT5_OPERATIONAL_MODEL_6,
    MT5_HISTORICAL_MODEL_7: MT5_OPERATIONAL_MODEL_7,
    "MODELOS_8_A_17": MT5_OPERATIONAL_MODEL_8_TO_22,
}
...
class MT5ScenarioHistoricalEvidence:
    ...
    discrimination_summary: str = "N/D"
    discrimination_metrics: dict[str, dict[str, float]] = field(default_factory=dict)
...
class DashboardService:
    ...
    mt5_position_profit_peak_store: MT5PositionProfitPeakStore = field(
        default_factory=MT5PositionProfitPeakStore,
        repr=False,
        compare=False,
    )
    ...
    mt5_trade_audit_report_cache: DashboardMT5TradeAuditViewModel | None = None
    mt5_trade_audit_snapshot_signature: str = ""
    mt5_demo_execution_records_cache: list[dict[str, Any]] = field(
        default_factory=list
    )
    mt5_demo_execution_records_cache_offset: int = 0
    mt5_scenario_snapshot_cache: dict[tuple[object, ...], list[object]] = field(
        default_factory=dict,
        repr=False,
        compare=False,
    )
    mt5_scenario_trigger_cache: dict[
        tuple[object, ...],
        list[tuple[int, str, object]],
    ] = field(default_factory=dict, repr=False, compare=False)
    mt5_scenario_evidence_cache: dict[
        tuple[object, ...],
        MT5ScenarioHistoricalEvidence,
    ] = field(default_factory=dict, repr=False, compare=False)
    mt5_scenario_discrimination_cache: dict[
        tuple[object, ...],
        dict[str, bool],
    ] = field(default_factory=dict, repr=False, compare=False)
    mt5_scenario_time_context_cache: dict[tuple[str, str, str, str], object] = field(
        default_factory=dict,
        repr=False,
        compare=False,
    )
    lab_operational_decision_cache: dict[tuple[str, str], object] = field(
        default_factory=dict,
        repr=False,
        compare=False,
    )
    mt5_server_timestamp_cache_value: str = "N/D"
    mt5_server_timestamp_cache_started: float = 0.0
    mt5_visual_auto_export_last_run: float = 0.0
    model15_runtime_state_signature: str = ""
    model16_runtime_state_signature: str = ""
    ...
    entry_filter_max_rules: int | None = ENTRY_FILTER_MAX_RULES
    mt5_operational_model: str = MT5_OPERATIONAL_MODEL_1
    ...
    def _set_entry_filter_max_rules(self, max_rules: int | None) -> None:
        """Sincroniza o limite operacional do filtro NV-V sem abrir API publica."""
        if max_rules is None:
            object.__setattr__(self, "entry_filter_max_rules", None)
            return
        object.__setattr__(self, "entry_filter_max_rules", max(1, int(max_rules)))

    def _entry_filter_rule_limit(self) -> int | None:
        value = getattr(self, "entry_filter_max_rules", ENTRY_FILTER_MAX_RULES)
        if value is None:
            return None
        return max(1, int(value or ENTRY_FILTER_MAX_RULES))
    ...
    def set_mt5_operational_model(self, model: str) -> None:
        ...
        object.__setattr__(
            self,
            "mt5_model23_enabled",
            normalized in {MT5_OPERATIONAL_MODEL_23, MT5_OPERATIONAL_MODEL_WITH_23},
        )
        object.__setattr__(
            self,
            "mt5_model24_enabled",
        ...
        if normalized == MT5_OPERATIONAL_MODEL_ALL:
            object.__setattr__(
                self,
                "mt5_selected_operational_models",
                MT5_ACTIVE_SOURCE_MODEL_IDS,
            )
        ...
        if normalized == MT5_OPERATIONAL_MODEL_23:
            ...
            object.__setattr__(
                self, "mt5_selected_direct_operational_models", direct_models
            )
            object.__setattr__(self, "mt5_selected_basket_models", ())

    def set_mt5_operational_models(
        self,
        models: tuple[str, ...] | list[str],
        *,
        basket_mode: bool = False,
        basket_models: tuple[str, ...] | list[str] = (),
        direct_models_enabled: bool = True,
    ) -> None:
        """Seleciona livremente modelos diretos e cestas para novas entradas."""
        selected: list[str] = []
        for model in models:
            normalized = LEGACY_MT5_OPERATIONAL_MODELS.get(
                str(model or "").upper(),
                str(model or "").upper(),
            )
            if (
                normalized in MT5_ACTIVE_SOURCE_MODEL_IDS
        ...
        if basket_mode and MT5_OPERATIONAL_MODEL_23 not in selected_baskets:
            selected_baskets.append(MT5_OPERATIONAL_MODEL_23)
        if not selected and not selected_baskets:
            selected = [MT5_OPERATIONAL_MODEL_1]
        direct_enabled = bool(direct_models_enabled and selected)
        ...
        if len(selected_baskets) > 1:
            mode = MT5_OPERATIONAL_MODEL_CUSTOM
        elif selected_baskets == [MT5_OPERATIONAL_MODEL_23] and direct_enabled:
            ...
            mode = MT5_OPERATIONAL_MODEL_ALL
        elif len(selected) == 1:
            mode = selected[0]
        else:
            mode = MT5_OPERATIONAL_MODEL_CUSTOM
        object.__setattr__(self, "mt5_operational_model", mode)

    def get_mt5_operational_model(self) -> str:
        selected = str(
            getattr(self, "mt5_operational_model", MT5_OPERATIONAL_MODEL_1)
    ...
    def _mt5_operational_models_to_evaluate(self) -> tuple[str, ...]:
        ...
        if selected == MT5_OPERATIONAL_MODEL_23:
            configured = tuple(
                getattr(self, "mt5_selected_operational_models", ()) or ()
            )
        ...
        if selected == MT5_OPERATIONAL_MODEL_CUSTOM:
            ...
            return configured or (MT5_OPERATIONAL_MODEL_1,)
        if selected == MT5_OPERATIONAL_MODEL_WITH_23:
            configured = tuple(
                getattr(self, "mt5_selected_operational_models", ()) or ()
            )
            return configured or MT5_MODEL_23_SOURCE_MODEL_IDS
    ...
    def _mt5_multi_model_selection_active(self) -> bool:
    ...
    def _mt5_model23_routing_enabled(self) -> bool:
        configured = getattr(self, "mt5_model23_enabled", None)
    ...
    def _mt5_entry_source_models_to_evaluate(self) -> tuple[str, ...]:
        ...
        sources: list[str] = []
        for model_id in self._mt5_operational_models_to_evaluate():
            source = dynamic_exit_source_model(model_id) or model_id
            if source not in sources:
                sources.append(source)
        return tuple(sources)

    def get_lab_operational_decision_snapshot(self) -> dict[tuple[str, str], object]:
        """Expoe somente decisoes compactas ja calculadas pelo ciclo MT5."""
        return dict(self.lab_operational_decision_cache)

    def refresh_lab_operational_decision_snapshot(
        self,
        ...
        selected_models = tuple(
            model_id
            for model_id in self._mt5_entry_source_models_to_evaluate()
            if model_id != MT5_OPERATIONAL_MODEL_1
        )
        ...
        rows_by_pair = {
            str(getattr(row, "pair", "") or "").upper(): row
        ...
        if not isinstance(candles_by_market, dict):
            candles_by_market = {}
        refreshed: dict[tuple[str, str], object] = {}
        for model_id in selected_models:
            if model_id in MT5_CUSTOM_OPERATIONAL_MODELS:
                # M15 usa diretamente o snapshot XAUUSD/M5 e nao pertence ao
                # manifesto do Lab operacional M2/M4/M5.
                continue
            if model_id in MT5_SCOPED_M1_OPERATIONAL_MODELS:
                # M3/M6/M7 reuse the M1 Lab row already calculated in this cycle.
                continue
            for pair in self.lab_operational_model_service.results(model_id):
                source_row = rows_by_pair.get(pair)
                decision = self.lab_operational_model_service.evaluate(
                    model_id=model_id,
                    pair=pair,
                    ...
                    demo_forward_override=demo_forward_override,
                )
                refreshed[(str(model_id).upper(), pair)] = decision
        self.lab_operational_decision_cache.clear()
        self.lab_operational_decision_cache.update(refreshed)
    ...
    def get_mt5_forex_runtime_view_model(self) -> DashboardMT5ForexSignalViewModel:
        """Publica leitura Forex leve ja enriquecida pelas constantes do Lab."""
        return self._to_view_model_mt5_forex_signals(
            self.get_mt5_forex_signals(),
            self.get_mt5_research_constants(),
        )
    ...
    def load_mt5_forex_signals(
        ...
        selected_models = self._mt5_entry_source_models_to_evaluate()
        self._seed_operational_m5_from_local_history(selected_models)
        ensure_connection = getattr(
            self.mt5_market_data_service,
            "ensure_provider_connection",
            None,
        )
        if callable(ensure_connection):
            # O aquecimento M5 ocorre antes do lote principal. No provider
        ...
        researched_models = tuple(
            ...
            and model not in MT5_SCOPED_M1_OPERATIONAL_MODELS
            and model not in MT5_CUSTOM_OPERATIONAL_MODELS
        )
        required = (
    ...
    def _seed_operational_m5_from_local_history(
        ...
        """Preaquece M3 e M8-M17 com 200 fechadas mais a atual, sem dado stale."""
        ...
        if set(FOREX_SMA_RSI_MODEL_IDS).intersection(selected_models):
            requested.update(FOREX_SMA_RSI_PAIRS)
        if MT5_OPERATIONAL_MODEL_25 in selected_models:
            requested.update(MODEL_25_SYMBOLS)
        candles_by_market = getattr(
            self.mt5_market_data_service,
            "latest_forex_candles",
            {},
        ...
        missing = {
            ...
            if len(list(candles_by_market.get((pair, "M5"), []) or []))
            < OPERATIONAL_INDICATOR_RAW_CANDLES
        }
        if not missing:
            return
        ...
        if not database_path.exists():
            return
        seeded: dict[tuple[str, str], list[Candle]] = {}
        try:
            ...
            with sqlite3.connect(uri, uri=True, timeout=3.0) as connection:
                for pair in sorted(missing):
                    records = connection.execute(
                        ...
                        WHERE pair = ? AND timeframe = 'M5'
                        ORDER BY candle_time DESC
                        LIMIT ?
                        """,
                        (pair, OPERATIONAL_INDICATOR_RAW_CANDLES),
                    ).fetchall()
                    if len(records) != OPERATIONAL_INDICATOR_RAW_CANDLES:
                        continue
                    seeded[(pair, "M5")] = [
                        Candle(
                            data=str(candle_time),
                            abertura=float(open_price),
                            maxima=float(high),
                            minima=float(low),
        ...
        seed = getattr(
            self.mt5_market_data_service,
            "seed_supplemental_forex_candles",
            None,
        )
        if callable(seed):
            seed(seeded)
    ...
    def _mt5_lab_timeframes_by_pair(self) -> dict[str, str]:
        selected = self.get_mt5_operational_model()
        selected = dynamic_exit_source_model(selected) or selected
        if selected == MT5_OPERATIONAL_MODEL_25:
        ...
        if selected == MT5_OPERATIONAL_MODEL_6:
            allowed_pairs = set(MODEL_6_FOREX_EXPANSION_PAIRS)
        elif selected == MT5_OPERATIONAL_MODEL_7:
            allowed_pairs = set(MODEL_7_ALTERNATIVE_MARKETS)
    ...
    def suggest_mt5_lab_setups(
        ...
        for pair in pairs:
            ...
            if selected is not None:
                selected_parameters = dict(getattr(selected, "parameters", {}) or {})
                beta_id, beta_version, beta_mode, beta_reason = (
                    self._mt5_beta_descriptor_from_parameters(
                        selected_parameters,
                        beta_id=str(getattr(selected, "beta_id", "BETA001") or "BETA001"),
                        beta_version=str(
                            getattr(selected, "beta_version", "BETA v1") or "BETA v1"
                        ),
                        beta_mode=str(
                ...
                suggestions.append(
                    DashboardMT5SetupSuggestionViewModel(
                        ...
                        lab_confidence_sample_size=int(
                            getattr(selected, "lab_confidence_sample_size", 0) or 0
                        ),
                        lab_confidence_profit_factor=float(
                            getattr(selected, "lab_confidence_profit_factor", 0.0)
                            or 0.0
                        ),
                        lab_confidence_expectancy=float(
                            getattr(selected, "lab_confidence_expectancy", 0.0)
                            or 0.0
                        ),
                        lab_confidence_max_drawdown=float(
                            getattr(selected, "lab_confidence_max_drawdown", 0.0)
                            or 0.0
                        ),
                        lab_confidence_source=str(
                            getattr(selected, "lab_confidence_source", "N/D")
                            or "N/D"
                        ),
        ...
        for row in list(getattr(research, "rows", []) or []):
            ...
            suggestions.append(
                DashboardMT5SetupSuggestionViewModel(
                    ...
                    lab_confidence_sample_size=int(
                        getattr(row, "sample_size", 0) or 0
                    ),
                    lab_confidence_profit_factor=float(
                        getattr(row, "profit_factor", 0.0) or 0.0
                    ),
                    lab_confidence_expectancy=float(
                        getattr(row, "avg_return", 0.0) or 0.0
                    ),
                    lab_confidence_max_drawdown=float(
                        getattr(row, "max_drawdown", 0.0) or 0.0
                    ),
                    lab_confidence_source=str(
                        getattr(row, "research_cache_status", "ROW_SUMMARY")
                        or "ROW_SUMMARY"
                    ),
                    target_confidence=float(target_confidence),
                    status=(
    ...
    def _run_mt5_research_for_pair(
        ...
        try:
            ...
            self._clear_mt5_scenario_caches(pair_key)
    ...
    def list_mt5_research_replay_scenarios(
        ...
        """Lista os vencedores por par que podem ser comprovados no Replay."""
        research = self._load_mt5_research_runtime_index()
        if not list(getattr(research, "best_scenarios_by_market", []) or []):
            research = self._load_mt5_research_snapshot()
        if research is None:
            return []
        return sorted(
            list(getattr(research, "best_scenarios_by_market", []) or []),
            key=lambda scenario: (
                str(getattr(scenario, "pair", "") or ""),
                str(getattr(scenario, "timeframe", "") or ""),
            ),
        )

    def get_mt5_research_replay_proof(
        self,
        pair: str,
    ) -> DashboardMT5LabReplayProofViewModel:
        """Executa sob demanda a prova do vencedor de um par nos candles salvos."""
        pair_key = str(pair or "").upper().strip()
        research = self._load_mt5_research_snapshot()
        if research is None:
            raise ValueError("Snapshot do Research Lab nao encontrado.")
        scenario = next(
            (
                item
                for item in list(
                    getattr(research, "best_scenarios_by_market", []) or []
                )
                if str(getattr(item, "pair", "") or "").upper() == pair_key
            ),
            None,
        )
        if scenario is None:
        ...
        parameters: dict[str, object] = {
            "modelo": str(getattr(scenario, "model", "") or ""),
            "alpha": str(getattr(scenario, "alpha_id", "") or ""),
            **dict(getattr(scenario, "parameters", {}) or {}),
        }
        minimum = self._scenario_evidence_minimum_candles(
            str(getattr(scenario, "model", "") or ""),
            parameters,
        )
        trades: list[DashboardMT5LabReplayTradeViewModel] = []
        last_exit_index = -1
        try:
            triggers = self._mt5_scenario_entry_triggers(
                row,
                candles,
                str(getattr(scenario, "model", "") or ""),
                parameters,
            ...
            for entry_index, direction, snapshot in triggers:
                if entry_index <= last_exit_index:
                    continue
                trade = self._mt5_initial_plan_replay_trade(
                    candles,
                    entry_index,
                    direction,
                    snapshot,
                ...
                if trade is None:
                    break
                trades.append(replace(trade, trade_number=len(trades) + 1))
                last_exit_index = trade.exit_index
        finally:
            self._clear_mt5_scenario_caches(pair_key)

        returns = [trade.return_fraction for trade in trades]
        evidence = self._mt5_scenario_evidence_from_returns(
            returns,
            source="SCENARIO_TRADE_PLAN_REPLAY_V2",
        )
        dataset_sha256 = self._mt5_research_replay_dataset_sha256(
            pair_key,
            timeframe,
            candles,
        )
        execution_sha256 = self._mt5_research_replay_execution_sha256(
            scenario,
            dataset_sha256,
            trades,
        )
        expected_candles = self.get_mt5_research_history_candle_count()
        verification_messages = self._mt5_research_replay_verification_messages(
            scenario,
            evidence,
        ...
        proof_path = self._mt5_research_replay_proof_path(
            pair_key,
            timeframe,
            str(getattr(scenario, "alpha_id", "ALPHA")),
        )
        proof = DashboardMT5LabReplayProofViewModel(
            status="GERADA",
            verification_status=(
                "CONFERE_COM_SNAPSHOT"
                if not verification_messages
                else "DIVERGE_DO_SNAPSHOT"
            ),
            verification_messages=tuple(verification_messages),
            pair=pair_key,
            timeframe=timeframe,
            alpha_id=str(getattr(scenario, "alpha_id", "N/D") or "N/D"),
            alpha_model=str(getattr(scenario, "model", "N/D") or "N/D"),
            snapshot_beta_id=str(
                getattr(scenario, "beta_id", "BETA001") or "BETA001"
            ),
            stop_management=str(
                parameters.get("stop_management", "FIXED_STOP") or "FIXED_STOP"
            ),
            scenario_status=str(
                getattr(scenario, "status", "REJEITADO") or "REJEITADO"
            ),
            certification_status=str(
                getattr(scenario, "ict_status", "REJEITADA") or "REJEITADA"
            ),
            ict_score=float(getattr(scenario, "ict_score", 0.0) or 0.0),
            parameters={str(key): str(value) for key, value in parameters.items()},
            source=evidence.source,
            snapshot_updated_at=str(
                getattr(research, "last_update", "N/D") or "N/D"
            ),
            history_updated_at=str(
                history_metadata.get("last_update", "N/D") or "N/D"
            ),
            generated_at=generated_at,
            expected_candle_count=expected_candles,
            candle_count=len(candles),
            first_candle_time=str(getattr(candles[0], "data", "N/D")),
            last_candle_time=str(getattr(candles[-1], "data", "N/D")),
            ...
            snapshot_win_rate=float(
                getattr(scenario, "lab_confidence", 0.0) or 0.0
            ),
            snapshot_profit_factor=float(
                getattr(scenario, "lab_confidence_profit_factor", 0.0) or 0.0
            ),
            snapshot_expectancy=float(
                getattr(scenario, "lab_confidence_expectancy", 0.0) or 0.0
            ),
            snapshot_max_drawdown=float(
                getattr(scenario, "lab_confidence_max_drawdown", 0.0) or 0.0
            ),
            replay_sample_size=evidence.sample_size,
            replay_win_rate=evidence.win_rate,
            replay_profit_factor=evidence.profit_factor,
            replay_expectancy=evidence.avg_return,
            replay_max_drawdown=evidence.max_drawdown,
            candles=[
                DashboardMT5CandleViewModel(
                    timestamp=str(getattr(candle, "data", "N/D")),
                    open=float(getattr(candle, "abertura", 0.0) or 0.0),
                    high=float(getattr(candle, "maxima", 0.0) or 0.0),
                    low=float(getattr(candle, "minima", 0.0) or 0.0),
                    close=float(getattr(candle, "fechamento", 0.0) or 0.0),
        ...
        self._save_mt5_research_replay_proof(proof)
        return proof

    def _load_mt5_research_replay_market_from_database(
        self,
        pair: str,
        timeframe: str,
    ) -> tuple[MT5ForexSignalRow | None, list[Candle], dict[str, str]]:
        database_path = self.mt5_research_history_database_path()
        if not database_path.exists():
            return None, [], {}
        with sqlite3.connect(database_path, timeout=10.0) as connection:
            pair_record = connection.execute(
                """
                SELECT payload_json
                FROM mt5_history_pairs
                WHERE pair = ? AND timeframe = ?
                """,
                (pair, timeframe),
            ).fetchone()
            candle_records = connection.execute(
                """
                SELECT candle_time, open, high, low, close, volume
                FROM mt5_history_candles
                WHERE pair = ? AND timeframe = ?
            ...
            metadata = {
                ...
                for key, value in connection.execute(
                    "SELECT key, value FROM mt5_history_metadata"
                ).fetchall()
            }
        if pair_record is None:
            return None, [], metadata
        try:
            payload = json.loads(str(pair_record[0]))
        except (TypeError, json.JSONDecodeError):
            return None, [], metadata
        allowed_fields = {item.name for item in dataclass_fields(MT5ForexSignalRow)}
        ...
        candles = [
            Candle(
                data=str(record[0]),
                abertura=float(record[1]),
                maxima=float(record[2]),
                minima=float(record[3]),
                fechamento=float(record[4]),
                volume=int(record[5]),
            )
            for record in candle_records
        ]
        return row, candles, metadata

    def _mt5_research_replay_dataset_sha256(
        self,
        pair: str,
        timeframe: str,
        candles: list[object],
        ...
        digest.update(f"{pair}|{timeframe}\n".encode("utf-8"))
        for candle in candles:
            line = "|".join(
                (
                    str(getattr(candle, "data", "")),
                    format(float(getattr(candle, "abertura", 0.0) or 0.0), ".12g"),
                    format(float(getattr(candle, "maxima", 0.0) or 0.0), ".12g"),
                    format(float(getattr(candle, "minima", 0.0) or 0.0), ".12g"),
                    format(float(getattr(candle, "fechamento", 0.0) or 0.0), ".12g"),
                    str(int(getattr(candle, "volume", 0) or 0)),
                )
            )
            digest.update(f"{line}\n".encode("utf-8"))
        return digest.hexdigest()

    def _mt5_research_replay_execution_sha256(
        self,
        scenario: DashboardMT5ScenarioViewModel,
        dataset_sha256: str,
        trades: list[DashboardMT5LabReplayTradeViewModel],
    ...
    def _mt5_research_replay_verification_messages(
        self,
        scenario: DashboardMT5ScenarioViewModel,
        ...
        *,
        ...
        if candle_count != expected_candle_count:
            messages.append(
                f"Candles: replay={candle_count}, esperado={expected_candle_count}."
            )
        comparisons = (
            (
                "Trades",
                float(evidence.sample_size),
                float(getattr(scenario, "lab_confidence_sample_size", 0) or 0),
                0.0,
            ),
            (
                "Win rate",
        ...
        for label, replay_value, snapshot_value, tolerance in comparisons:
            if math.isinf(replay_value) and math.isinf(snapshot_value):
                continue
            if not math.isclose(
                replay_value,
                snapshot_value,
                ...
                messages.append(
                    f"{label}: replay={replay_value:.10g}, "
                    f"snapshot={snapshot_value:.10g}."
                )
        return messages

    def _mt5_research_replay_proof_path(
        self,
        pair: str,
        timeframe: str,
        alpha_id: str,
        ...
        safe_name = "_".join(
            ...
            for item in (pair, timeframe, alpha_id)
        )
        return Path(".traderia") / "research" / "replay_proofs" / f"{safe_name}.json"

    def _save_mt5_research_replay_proof(
        self,
        proof: DashboardMT5LabReplayProofViewModel,
    ) -> None:
        target = Path(proof.proof_path)
        target.parent.mkdir(parents=True, exist_ok=True)
        payload = asdict(proof)
        payload["candles"] = {
            "database_path": self.get_mt5_research_history_database_path(),
            "pair": proof.pair,
            "timeframe": proof.timeframe,
            "count": proof.candle_count,
    ...
    def _mt5_research_history_candle_count(
        ...
        try:
            override = os.getenv("TRADERIA_MT5_RESEARCH_HISTORY_CANDLES", "").strip()
            configured = int(override) if override else configured_limit
        except ValueError:
            configured = configured_limit
        configured = max(1, configured)
        return min(configured, configured_limit)
    ...
    def _update_mt5_research_history(
        ...
        candle_count = self._mt5_research_history_candle_count(configuration)
        research_symbols = tuple(
            str(symbol or "").upper()
            for symbol in (symbols or SUPPORTED_MT5_SYMBOLS)
            if str(symbol or "").strip()
        )
        stored_history = (
            self._load_mt5_research_history_snapshot() if symbols else None
        )
        preloaded_by_timeframe: dict[str, dict[str, dict[str, Any]]] | None = None
        research_batch_reader = getattr(
            self.mt5_market_data_service.provider,
            "get_research_batch",
            None,
        )
        if len(timeframes) > 1 and callable(research_batch_reader):
            if callable(progress_callback):
                progress_callback(
                    {
                        "phase": "history_batch_started",
                        "index": 0,
            ...
            try:
                preloaded_by_timeframe = research_batch_reader(
                    list(research_symbols),
                    {
                        candidate: self.mt5_market_data_service._timeframe_value(
                            candidate
                        )
            ...
            except Exception:  # noqa: BLE001 - ponte MT5 preserva snapshot anterior
                preloaded_by_timeframe = {}
        snapshots = []
        ...
        for index, candidate_timeframe in enumerate(timeframes, start=1):
            ...
            snapshot = self.mt5_market_data_service.load_forex_research_snapshot(
                ...
                preloaded_market_data=(
                    preloaded_by_timeframe.get(candidate_timeframe, {})
                    if preloaded_by_timeframe is not None
                    else None
                ),
        ...
        if stored_history is not None:
            ...
            preserved_pairs = [
                row
                for row in list(getattr(stored_history, "pairs", []) or [])
                if (
                    str(getattr(row, "pair", "") or "").upper(),
                    str(getattr(row, "timeframe", "") or "").upper(),
                )
            ...
            all_pairs = preserved_pairs + all_pairs
        history = MT5ForexSignalDashboard(
            ...
            available_pairs=sorted(
                ...
                | set(
                    list(getattr(stored_history, "available_pairs", []) or [])
                    if stored_history is not None
                    else []
                )
            ),
    ...
    def _save_mt5_research_runtime_index(
        ...
        payload = {
            ...
            "best_scenario": (
                asdict(getattr(research, "best_scenario"))
                if getattr(research, "best_scenario", None) is not None
                else None
            ),
        }
        target.write_text(
    ...
    def _position_manager_plans_from_open_execution_records(
        ...
        """Usa o plano original de cada ordem aberta para gerir cada ticket."""
    ...
    def _position_manager_signal_from_execution_record(
        ...
        return {
            ...
            "stop_management": effective_management,
            ...
            "beta_id": (
                parameters.get("source_beta_id")
                or record.get("beta_id")
                or snapshot.get("beta_id")
            ),
            "beta_version": (
                parameters.get("source_beta_version")
                or record.get("beta_version")
                or snapshot.get("beta_version")
            ),
            "beta_mode": (
                parameters.get("source_beta_mode")
                or record.get("beta_mode")
                or snapshot.get("beta_mode")
            ),
            ...
            "operational_model": effective_model,
            "entry_setup": (
                record.get("entry_setup")
                or snapshot.get("entry_setup")
                or snapshot.get("active_model")
            ),
            "market_indicators": {
    ...
    def _auto_export_mt5_visual_signals(self) -> MT5VisualSignalExportResult | None:
        ...
        try:
            target = self._mt5_visual_signals_output_path(None)
            forex_view_model = self.get_mt5_forex_runtime_view_model()
            result = self.mt5_visual_signal_exporter.export(
                forex_view_model,
                target,
            )
    ...
    def get_mt5_trade_audit_report(self) -> DashboardMT5TradeAuditViewModel:
        """Retorna auditoria MT5 sem expor a UI a chamadas nativas bloqueantes."""
        external_enabled = (
            os.getenv("TRADERIA_MT5_REPORT_EXTERNAL_PROCESS_ENABLED", "0").strip()
            == "1"
        )
        inside_worker = (
            os.getenv("TRADERIA_MT5_REPORT_INPROCESS_WORKER", "0").strip() == "1"
        )
        if external_enabled and not inside_worker:
            external = self._get_mt5_trade_audit_report_external()
            if external is not None:
                merged = self._merge_lightweight_open_positions(external)
                object.__setattr__(self, "mt5_trade_audit_report_cache", merged)
                self._save_mt5_trade_audit_report_snapshot(merged)
                return merged
            cached = self.mt5_trade_audit_report_cache
            if cached is None or not self._mt5_trade_audit_has_closed_rows(cached):
                persisted = self._load_mt5_trade_audit_report_snapshot()
                if persisted is not None:
                    cached = persisted
            if cached is not None:
                merged = self._merge_lightweight_open_positions(cached)
                object.__setattr__(self, "mt5_trade_audit_report_cache", merged)
                return merged
            lightweight = self._lightweight_open_positions_report()
            ...
            return DashboardMT5TradeAuditViewModel(
                ...
                mt5_connection_status="AQUECENDO",
                message=(
                    "Sonda externa MT5 ainda sem resposta; a interface permanece "
                    "leve e preservara o ultimo relatorio valido."
                ),
            )
        return self._get_mt5_trade_audit_report_inline()

    def _merge_lightweight_open_positions(
        self,
        report: DashboardMT5TradeAuditViewModel,
    ) -> DashboardMT5TradeAuditViewModel:
        """Atualiza posicoes abertas sem reler todo o historico MT5."""
        lightweight = self._lightweight_open_positions_report(report)
        if lightweight is None:
            return self._with_mt5_position_profit_peaks(report)
        open_statuses = {"ABERTA", "ORDEM_ABERTA"}
        closed_rows = [
            row
            for row in report.rows
            if str(row.operation_status or "").upper() not in open_statuses
        ]
        merged = replace(
            report,
            rows=[*lightweight.rows, *closed_rows],
            mt5_connection_status="CONNECTED",
            last_update=lightweight.last_update,
            mt5_source=lightweight.mt5_source,
            message=lightweight.message,
        )
        return self._with_mt5_position_profit_peaks(merged)

    def _lightweight_open_positions_report(
        self,
        base_report: DashboardMT5TradeAuditViewModel | None = None,
    ) -> DashboardMT5TradeAuditViewModel | None:
        """Le somente positions_get e preserva metadados auditados por ticket."""
        try:
            self._enable_mt5_demo_provider()
            provider = self.demo_robot_execution_service.provider
            positions = list(provider.list_open_positions() or [])
        except (AttributeError, ImportError, OSError, RuntimeError, TypeError):
            return None
        if not positions:
            return None

        peaks = self.mt5_position_profit_peak_store.observe_positions(positions)

        existing_by_ticket = {
            int(ticket): row
            for row in list(getattr(base_report, "rows", []) or [])
            if (ticket := getattr(row, "mt5_ticket", None)) is not None
        }
        rows = [
            self._lightweight_open_position_row(
                position,
                existing_by_ticket.get(
                    int(getattr(position, "ticket", 0) or 0)
                ),
                peaks.get(int(getattr(position, "ticket", 0) or 0)),
            )
        ...
        return DashboardMT5TradeAuditViewModel(
            ...
            total_local_records=int(
                getattr(base_report, "total_local_records", 0) or 0
            ),
            total_accepted_local=int(
                getattr(base_report, "total_accepted_local", 0) or 0
            ),
            total_audited=int(getattr(base_report, "total_audited", 0) or 0),
            total_matched=int(getattr(base_report, "total_matched", 0) or 0),
            total_mismatched=int(
                getattr(base_report, "total_mismatched", 0) or 0
            ),
            mt5_connection_status="CONNECTED",
            mt5_account_balance=float(
                getattr(base_report, "mt5_account_balance", 0.0) or 0.0
            ),
            equity_curve_default_start_date=str(
                getattr(
                    base_report,
                    "equity_curve_default_start_date",
                    "2026-07-22",
                )
                or "2026-07-22"
            ),
            last_update=now,
            source=str(
                getattr(base_report, "source", ".traderia/mt5_demo_execution.jsonl")
            ),
            mt5_source="MetaTrader5 positions_get (leitura leve)",
            message=f"{len(rows)} posicoes abertas atualizadas pela leitura leve MT5.",
        )

    def _lightweight_open_position_row(
        self,
        position: object,
        existing: DashboardMT5TradeAuditRowViewModel | None,
        peak: MT5PositionProfitPeak | None = None,
    ) -> DashboardMT5TradeAuditRowViewModel:
        ticket = int(getattr(position, "ticket", 0) or 0)
        symbol = str(getattr(position, "symbol", "N/D") or "N/D").upper()
        side = self._mt5_side_from_type(getattr(position, "type", None))
        volume = float(getattr(position, "volume", 0.0) or 0.0)
        entry = float(getattr(position, "price_open", 0.0) or 0.0)
        current = float(getattr(position, "price_current", 0.0) or 0.0)
        stop_value = float(getattr(position, "sl", 0.0) or 0.0)
        target_value = float(getattr(position, "tp", 0.0) or 0.0)
        stop = stop_value if stop_value > 0.0 else None
        target = target_value if target_value > 0.0 else None
        opened_at = self._mt5_history_time(getattr(position, "time", None))
        comment = str(getattr(position, "comment", "") or "").strip()
        model = self._mt5_model_from_position_comment(comment)
        common = {
            "timestamp": opened_at,
            "symbol": symbol,
            "side": side,
            ...
            "stop": stop,
            "target": target,
            "local_status": "OPEN_FROM_MT5",
            "local_message": comment or "Posicao aberta confirmada pelo MT5.",
            "local_ticket": ticket,
            "mt5_found": True,
            "mt5_ticket": ticket,
            "mt5_source": "positions_get lightweight",
            ...
            "mt5_price": current,
            "mt5_stop": stop,
            "mt5_realized_profit": float(
                getattr(position, "profit", 0.0) or 0.0
            ),
            "mt5_peak_open_profit": (
                float(peak.peak_profit) if peak is not None else None
            ),
            "mt5_peak_open_profit_at": (
                str(peak.peak_at) if peak is not None else "N/D"
            ),
            "mt5_swap": float(getattr(position, "swap", 0.0) or 0.0),
            "mt5_time": opened_at,
            "audit_status": "MT5_OPEN",
            "audit_message": "Posicao aberta confirmada pela leitura leve MT5.",
        }
        if existing is not None:
            if str(existing.operational_model or "N/D").upper() not in {
                "",
                "N/D",
            }:
                model = existing.operational_model
            return replace(existing, operational_model=model, **common)
        return DashboardMT5TradeAuditRowViewModel(
            operational_model=model,
            position_manager_status="MONITORANDO",
            position_manager_message="Posicao aberta disponivel para acompanhamento.",
            plan_snapshot={
                "operational_model": model,
                "mt5_comment": comment,
                "source": "MT5_LIGHTWEIGHT_POSITION",
            },
            **common,
        )

    def _mt5_model_from_position_comment(self, comment: str) -> str:
        normalized = str(comment or "").upper().replace("-", " ")
        for token in normalized.split():
            if token.startswith("M") and token[1:].isdigit():
                number = int(token[1:])
                model = MT5_OPERATIONAL_MODEL_BY_NUMBER.get(number)
                if model is not None:
                    return model
        return "N/D"

    def _with_mt5_position_profit_peaks(
        self,
        report: DashboardMT5TradeAuditViewModel,
    ) -> DashboardMT5TradeAuditViewModel:
        candidates = {
            int(ticket)
            for row in report.rows
            for ticket in (row.mt5_ticket, row.local_ticket)
            if ticket is not None and int(ticket) > 0
        }
        peaks = self.mt5_position_profit_peak_store.get_many(candidates)
        if not peaks:
            return report
        ...
        for row in report.rows:
            peak = next(
                (
                    peaks[int(ticket)]
                    for ticket in (row.mt5_ticket, row.local_ticket)
                    if ticket is not None and int(ticket) in peaks
                ),
                None,
            )
            if peak is None:
            ...
            rows.append(
                replace(
                    row,
                    mt5_peak_open_profit=float(peak.peak_profit),
                    mt5_peak_open_profit_at=str(peak.peak_at),
                )
            )
            changed = True
        return replace(report, rows=rows) if changed else report

    def _get_mt5_trade_audit_report_external(
        self,
    ) -> DashboardMT5TradeAuditViewModel | None:
        timeout_seconds = max(
            float(os.getenv("TRADERIA_MT5_REPORT_EXTERNAL_TIMEOUT_SECONDS", "15")),
            3.0,
        )
        code = (
            "import json, os\n"
            "from dataclasses import asdict\n"
            "os.environ['TRADERIA_MT5_REPORT_INPROCESS_WORKER'] = '1'\n"
            "from application.dashboard_service import DashboardService\n"
            "report = DashboardService().get_mt5_trade_audit_report()\n"
        ...
        slot_wait_seconds = max(
            float(
                os.getenv(
                    "TRADERIA_MT5_REPORT_EXTERNAL_SLOT_WAIT_SECONDS",
                    "2",
                )
            ),
            0.05,
        ...
        with mt5_external_process_slot(timeout=slot_wait_seconds) as acquired:
            if not acquired:
                return None
            try:
        ...
        try:
            ...
            rows = [
                DashboardMT5TradeAuditRowViewModel(**dict(row))
                for row in list(payload.pop("rows", []))
            ]
            return DashboardMT5TradeAuditViewModel(rows=rows, **payload)
        except (json.JSONDecodeError, TypeError, ValueError):
            return None

    def _save_mt5_trade_audit_report_snapshot(
        self,
        report: DashboardMT5TradeAuditViewModel,
    ) -> None:
        """Persiste o ultimo relatorio completo sem bloquear sua leitura futura."""
        if os.getenv("PYTEST_CURRENT_TEST"):
            return
        signature = self._mt5_trade_audit_closed_rows_signature(report)
        if signature == self.mt5_trade_audit_snapshot_signature:
            return
        target = _MT5_TRADE_AUDIT_SNAPSHOT_PATH
        ...
        object.__setattr__(
            self,
            "mt5_trade_audit_snapshot_signature",
            signature,
        )

    def _load_mt5_trade_audit_report_snapshot(
        self,
    ) -> DashboardMT5TradeAuditViewModel | None:
        """Restaura curvas encerradas enquanto a sonda MT5 estiver ocupada."""
        target = _MT5_TRADE_AUDIT_SNAPSHOT_PATH
        try:
            payload = json.loads(target.read_text(encoding="utf-8"))
            rows = [
            ...
            report = DashboardMT5TradeAuditViewModel(rows=rows, **payload)
            object.__setattr__(
                self,
                "mt5_trade_audit_snapshot_signature",
                self._mt5_trade_audit_closed_rows_signature(report),
            )
            return report
        except (OSError, json.JSONDecodeError, TypeError, ValueError):
            return None

    def _mt5_trade_audit_closed_rows_signature(
        self,
        report: DashboardMT5TradeAuditViewModel,
    ) -> str:
        """Assina apenas o historico fechado para evitar escrita a cada tick."""
        open_statuses = {"ABERTA", "ORDEM_ABERTA"}
        rows = [
            (
                getattr(row, "mt5_ticket", None),
                getattr(row, "local_ticket", None),
                str(getattr(row, "operation_status", "") or "").upper(),
                str(getattr(row, "operational_model", "") or ""),
                float(getattr(row, "mt5_realized_profit", 0.0) or 0.0),
                getattr(row, "mt5_peak_open_profit", None),
                str(getattr(row, "mt5_peak_open_profit_at", "") or ""),
                float(getattr(row, "mt5_commission", 0.0) or 0.0),
                float(getattr(row, "mt5_swap", 0.0) or 0.0),
                float(getattr(row, "mt5_fee", 0.0) or 0.0),
                str(getattr(row, "mt5_time", "") or ""),
            )
            for row in report.rows
            if str(getattr(row, "operation_status", "") or "").upper()
    ...
    def _mt5_trade_audit_has_closed_rows(
        self,
        report: DashboardMT5TradeAuditViewModel,
    ) -> bool:
        open_statuses = {"ABERTA", "ORDEM_ABERTA"}
    ...
    def _get_mt5_trade_audit_report_inline(self) -> DashboardMT5TradeAuditViewModel:
    ...
    def _load_mt5_trade_history(self) -> tuple[dict[int, dict[str, Any]], str, str]:
        ...
        positions = self._merge_mt5_current_positions(mt5, current_trades) or []
        self.mt5_position_profit_peak_store.observe_positions(positions)
        ...
        self._attach_mt5_position_profit_peaks(history)
    ...
    def _merge_mt5_current_positions(
        ...
        if not callable(positions_get):
            return []
        positions = list(positions_get() or [])
        for position in positions:
    ...
    def _attach_mt5_position_profit_peaks(
        self,
        history: dict[int, dict[str, Any]],
    ) -> None:
        tickets = {
            int(candidate)
            for ticket, payload in history.items()
            for candidate in (
                ticket,
                self._int_or_none(payload.get("ticket")),
                self._int_or_none(payload.get("position_id")),
                self._int_or_none(payload.get("order")),
            )
            if candidate is not None and int(candidate) > 0
        }
        peaks = self.mt5_position_profit_peak_store.get_many(tickets)
        if not peaks:
            return
        closing_samples: list[tuple[int, str, float, str]] = []
        for ticket, payload in history.items():
            if self._mt5_operation_status(payload) != "FECHADA/HISTORICO":
                continue
            matched_ticket = next(
                (
                    int(candidate)
                    ...
                    if candidate is not None and int(candidate) in peaks
                ),
                None,
            )
            ...
            closing_samples.append(
                (
                    matched_ticket,
                    str(payload.get("symbol") or peaks[matched_ticket].symbol),
                    float(payload.get("profit") or 0.0),
                    str(payload.get("time") or datetime.now(timezone.utc).isoformat()),
                )
            )
        if closing_samples:
            peaks.update(
                self.mt5_position_profit_peak_store.raise_existing_peaks(
                    closing_samples
                )
            )
        for ticket, payload in history.items():
            ...
            if peak is not None:
                payload["peak_open_profit"] = float(peak.peak_profit)
                payload["peak_open_profit_at"] = str(peak.peak_at)
    ...
    def _mt5_history_payload(
        ...
        side = self._mt5_side_from_type(data.get("type"), source=source)
    ...
    def _mt5_trade_audit_row(
        ...
        if mt5_record is None:
            return DashboardMT5TradeAuditRowViewModel(
                ...
                timeframe=self._timeframe_from_mt5_execution_record(record),
                risk_reward=self._risk_reward_from_mt5_execution_record(record),
                beta_id=str(
                    record.get("beta_id")
                ...
                operational_model=str(record.get("operational_model") or "N/D"),
        ...
        return DashboardMT5TradeAuditRowViewModel(
            ...
            mt5_peak_open_profit=self._float_or_none(
                mt5_record.get("peak_open_profit")
            ),
            mt5_peak_open_profit_at=str(
                mt5_record.get("peak_open_profit_at") or "N/D"
            ),
    ...
    def _timeframe_from_mt5_execution_record(self, record: dict[str, Any]) -> str:
    ...
    def _risk_reward_from_mt5_execution_record(self, record: dict[str, Any]) -> float:
        explicit = self._float_or_none(record.get("risk_reward"))
    ...
    def _position_manager_record_for_trade(
        ...
        if mt5_record is not None and self._mt5_operation_status(mt5_record) == "FECHADA/HISTORICO":
            return None
        symbol = str(record.get("symbol") or "").upper()
    ...
    def _mt5_side_from_type(self, value: object, *, source: str = "") -> str:
        try:
            numeric = int(value)
        except (TypeError, ValueError):
            return "N/D"
        if str(source or "").upper() in {"ORDER", "ORDER_OPEN"}:
            return {
                0: "BUY",
                1: "SELL",
                2: "BUY LIMIT",
    ...
    def evaluate_armed_demo_robot_once(
        ...
        """Avalia uma vez o robo armado e executa os gatilhos validos do lote.

        Os modelos diretos preservam o roteamento vigente. O M25, por ser um
        agregador, percorre no mesmo snapshot todas as fontes XAU prontas.
        """
        ...
        basket25_block = self._evaluate_model25_risk_gate(pair, timeframe)
        ...
        for source_row in rows:
            ...
            for operational_model in selected_models:
                ...
                for route in routes:
                    ...
                    if source_model is None:
                        ...
                        if source_result is None:
                            source_result = self._mt5_apply_operational_model(
                                ...
                                allow_demo_forward_override=route_to_basket,
                            )
                            entry_source_results[cache_key] = source_result
                        model_row, model_plan = source_result
                    else:
                        cache_key = (source_model, route)
                        source_result = entry_source_results.get(cache_key)
                        if source_result is None:
                            source_result = self._mt5_apply_operational_model(
                                row,
                            ...
                            entry_source_results[cache_key] = source_result
                        model_row, model_plan = self._mt5_dynamic_exit_variant_from_source(
                            *source_result,
                            operational_model=operational_model,
                        )
                    source_ready = (
                    ...
                    if route != "M24" and not source_ready:
                        continue
                    if route == "M23":
                        ...
                        model_candidates.append(
                            (operational_model, model_row, model_plan)
                        )
            if self._mt5_multi_model_selection_active():
            ...
            for operational_model, model_row, model_plan in model_candidates:
                ...
                if candidate_is_m23:
                    ...
                    if not entry_allowed:
                        last_waiting = self._demo_robot_view_model(
                            row=model_row,
                            status="ARMED_WAITING",
                            message="M23 aguardando sinal novo apos zeragem completa.",
                            result_status="M23_ROUND_GATE",
                            result_message=entry_gate_reason,
                            entry_price=model_plan.entry_price,
                            stop=model_plan.stop,
                            target=model_plan.target,
                            provider="MT5_DEMO",
                ...
                robot_plan = self._to_mt5_demo_trade_plan(
                    model_row,
                    model_plan,
                    operational_model=operational_model,
                )
                ...
                if result.status in {"EXECUTED", "REJECTED"}:
                    ...
                    if candidate_is_m23 and result.status == "EXECUTED":
                        ...
                        # confirma o Full Exit antes da proxima exposicao.
                        basket_after_entry = self._evaluate_model23_risk_gate(
                            pair,
                            timeframe,
                        )
                        ...
                        # independentes que estiverem prontos neste ciclo.
                    ...
                    if candidate_is_m24 and result.status == "EXECUTED":
                        ...
                        if accepted_role == "INITIAL" and accepted_order_type == "MARKET":
                            ...
                            and accepted_order_type in {"BUY_STOP", "SELL_STOP"}
                        ):
                            mark_model24_continuation_accepted(
                                parameters.get("source_operational_model"),
                                model_plan.direction,
                        ...
                        basket24_after_entry = self._evaluate_model24_risk_gate(
                            pair,
                            timeframe,
                        )
                        if basket24_after_entry is not None:
                    ...
                    if candidate_is_m25:
                        if result.status == "EXECUTED":
                            ...
                            if basket25_after_entry is not None:
                                return basket25_after_entry
                            last_executed = status_view
                        else:
                            last_waiting = status_view
                        # Todos os candidatos M25 deste lote foram calculados
                        # com o mesmo snapshot. Nao adiar as demais fontes para
                        # o proximo ciclo, pois o preco pode cruzar o gatilho
                        # pendente durante essa espera.
                        continue
                    if not self._mt5_multi_model_selection_active():
                        return status_view
                    last_executed = status_view
                    continue
                last_waiting = self._demo_robot_view_model(
    ...
    def _mt5_demo_signal_from_view_row(
        ...
        *,
        ...
        hard_temporal_block = temporal_status.upper() in {
        ...
        return MT5DemoRobotSignal(
            ...
            session_filter_result=(
                "SAFETY_BLOCKED"
                if hard_temporal_block and temporal_blocked
                else "BLOCKED"
            ...
            forex_session_open=not temporal_blocking_enabled,
            ...
            entry_filter_blocked=str(row.entry_filter_status).upper() != "OK",
            entry_filter_status=row.entry_filter_status,
            entry_filter_reason=row.entry_filter_reason,
            entry_filter_parameter=row.entry_filter_parameter,
            entry_filter_reading=row.entry_filter_reading,
    ...
    def _evaluate_model23_risk_gate(
        self,
        pair: str,
        timeframe: str,
        ...
        try:
            ...
            blocked = DashboardDemoRobotViewModel(
                status="M23_RISK_READ_BLOCKED",
                message=(
                    "M23 bloqueado: nao foi possivel confirmar o resultado "
                    "financeiro atual da cesta no MT5."
                ),
                selected_pair=pair,
                timeframe=timeframe,
                model=MT5_OPERATIONAL_MODEL_23,
                decision="WAIT",
                result_status="M23_RISK_READ_ERROR",
        ...
        blocked = DashboardDemoRobotViewModel(
            ...
            message="M23 zerando a cesta; novas entradas permanecem bloqueadas.",
            selected_pair=pair,
            timeframe=timeframe,
            model=MT5_OPERATIONAL_MODEL_23,
            decision="WAIT",
    ...
    def _evaluate_model24_risk_gate(
        self,
        pair: str,
        timeframe: str,
    ) -> DashboardDemoRobotViewModel | None:
        """Executa a defesa financeira da cesta M24 antes de novas entradas."""
        if not self._mt5_model24_routing_enabled():
            return None
        try:
            ...
            blocked = DashboardDemoRobotViewModel(
                status="M24_RISK_READ_BLOCKED",
                message="M24 bloqueado: resultado financeiro da cesta indisponivel.",
                selected_pair=pair,
                timeframe=timeframe,
                model=MT5_OPERATIONAL_MODEL_24,
                decision="WAIT",
                result_status="M24_RISK_READ_ERROR",
                result_message=str(exc),
                provider="MT5_DEMO",
                mt5_order_send_enabled=False,
                audit_log=self._demo_robot_audit_rows(),
            ...
            object.__setattr__(self, "last_demo_robot_status", blocked)
            return blocked
        if snapshot.status not in {"EXIT_SUBMITTED", "EXIT_PARTIAL"}:
            return None
        blocked = DashboardDemoRobotViewModel(
            status=snapshot.status,
            message="M24 zerando a cesta; novas entradas estao bloqueadas.",
            selected_pair=pair,
            timeframe=timeframe,
            model=MT5_OPERATIONAL_MODEL_24,
            decision="WAIT",
            result_status=snapshot.exit_reason or snapshot.status,
            result_message=(
                f"Fechados: {snapshot.closed}; rejeitados: {snapshot.rejected}; "
                f"posicoes avaliadas: {snapshot.positions}."
            ),
            provider="MT5_DEMO",
            mt5_order_send_enabled=False,
            audit_log=self._demo_robot_audit_rows(),
    ...
    def _evaluate_model25_risk_gate(
        self,
        pair: str,
        timeframe: str,
    ) -> DashboardDemoRobotViewModel | None:
        """Executa a defesa financeira exclusiva da cesta M25."""
        if not self._mt5_model25_routing_enabled():
            return None
        try:
            ...
            blocked = DashboardDemoRobotViewModel(
                status="M25_RISK_READ_BLOCKED",
                message="M25 bloqueado: resultado financeiro da cesta indisponivel.",
                selected_pair=pair,
                timeframe=timeframe,
                model=MT5_OPERATIONAL_MODEL_25,
                decision="WAIT",
                result_status="M25_RISK_READ_ERROR",
                result_message=str(exc),
                provider="MT5_DEMO",
                mt5_order_send_enabled=False,
                audit_log=self._demo_robot_audit_rows(),
        ...
        blocked = DashboardDemoRobotViewModel(
            status=snapshot.status,
            message="M25 zerando a cesta; novas entradas estao bloqueadas.",
            selected_pair=pair,
            timeframe=timeframe,
            model=MT5_OPERATIONAL_MODEL_25,
            decision="WAIT",
    ...
    def run_demo_robot_for_all(
        ...
        if self._mt5_model23_routing_enabled() or self._mt5_model24_routing_enabled():
            ...
            return self.evaluate_armed_demo_robot_once(
                pair="TODOS",
                timeframe=timeframe,
            )
    ...
    def _ordered_demo_model_candidates_per_pair(
        ...
        """Ordena modelos sem criar dependencia operacional entre eles."""
        priority = {
            MT5_OPERATIONAL_MODEL_1: 10,
            MT5_OPERATIONAL_MODEL_2: 20,
            MT5_OPERATIONAL_MODEL_3: 30,
            ...
            MT5_OPERATIONAL_MODEL_11: 110,
            MT5_OPERATIONAL_MODEL_12: 120,
            MT5_OPERATIONAL_MODEL_13: 130,
            MT5_OPERATIONAL_MODEL_14: 140,
            MT5_OPERATIONAL_MODEL_15: 150,
            MT5_OPERATIONAL_MODEL_16: 160,
            MT5_OPERATIONAL_MODEL_17: 170,
            MT5_OPERATIONAL_MODEL_18: 180,
            MT5_OPERATIONAL_MODEL_19: 190,
            MT5_OPERATIONAL_MODEL_20: 200,
            MT5_OPERATIONAL_MODEL_21: 210,
    ...
    def _mt5_model23_variant_from_source(
        ...
        *,
        ...
        parameters.update(
            {
                ...
                "full_exit_usd": MODEL_23_FULL_EXIT_USD,
                "m23_structural_target_enabled": structural_target_valid,
                "m23_structural_target_price": (
        ...
        if is_xau_reentry and not structural_target_valid:
            ...
            reason = (
                "M23 aguardando ultimo topo/fundo M5 confirmado no lado "
        ...
        basket_plan = replace(
            ...
            exit_model=MODEL_23_BETA_VERSION,
            stop_reason=f"M23 copiou o SL individual do {source_label}: {plan.stop_reason}",
            target_reason=(
                "M23 XAU usa o ultimo topo/fundo M5 estrutural confirmado; "
                "a cesta tambem encerra em +US$1.000, o que ocorrer primeiro."
                if structural_target_valid
                else f"M23 copiou o TP individual do {source_label}: {plan.target_reason}"
            ),
            stop_management=MODEL_23_EXIT_POLICY,
            stop_management_parameters=parameters,
            stop_management_reason=(
            ...
            alpha_id=MODEL_23_ALPHA_ID,
            alpha_version=MODEL_23_ALPHA_VERSION,
            beta_id=MODEL_23_BETA_ID,
            beta_version=MODEL_23_BETA_VERSION,
            beta_mode="FULL_EXIT_1000_ONLY",
            beta_reason="Zeragem coletiva somente em +US$1.000 liquidos.",
            source=MODEL_23_ENTRY_SOURCE,
            reason=(
                f"M23 herdou o contrato operacional completo do {source_label}: "
                f"{plan.reason}"
            ),
        )
        basket_row = replace(
            row,
            active_model=f"M23 <- {source_label} | {row.active_model}",
            reason=f"M23 captou a entrada valida do {source_label}. {row.reason}",
            lab_alpha_id=MODEL_23_ALPHA_ID,
            lab_alpha_version=MODEL_23_ALPHA_VERSION,
            beta_id=MODEL_23_BETA_ID,
            beta_version=MODEL_23_BETA_VERSION,
            beta_mode="FULL_EXIT_1000_ONLY",
            lab_parameters=parameters,
            lab_configuration_source=MODEL_23_ENTRY_SOURCE,
            research_plan_source=MODEL_23_ENTRY_SOURCE,
    ...
    def _mt5_model24_variant_from_source(
        ...
        *,
        ...
        continuation_target_exit_confirmed = False
        ...
        role = (
            model24_market_entry_role(source, crossing_side)
        ...
        filter_reason = (
            ...
            if role == "REENTRY"
            else "M24_CONTINUATION_STOP_UM_PIP_ALEM_TP_INITIAL"
            if role == "CONTINUATION"
        ...
        source_parameters = {
            **dict(plan.stop_management_parameters or {}),
            ...
            "m24_last_price": entry_decision.last_price,
            "m24_rsi14": entry_decision.rsi14,
            "m24_previous_rsi14": entry_decision.previous_rsi14,
            "m24_sma20": entry_decision.sma20,
            "m24_sma50": entry_decision.sma50,
            "m24_atr14": entry_decision.atr14,
            "m24_distance_atr": entry_decision.distance_atr,
            "m24_distance_atr_min": MODEL_24_DISTANCE_ATR_MIN,
            "m24_distance_atr_filter_enabled": (
        ...
        if use_market:
            ...
            entry = float(entry_decision.entry_price or 0.0)
            stop = float(entry_decision.initial_stop or 0.0)
            active_order_type = str(entry_decision.entry_order_type or "").upper()
            if active_order_type not in {"MARKET", "BUY_STOP", "SELL_STOP"}:
            ...
            stop = float(entry_decision.initial_stop or 0.0)
            active_order_type = str(entry_decision.entry_order_type or "").upper()
            if active_order_type not in {"BUY_STOP", "SELL_STOP"}:
                active_order_type = "BUY_STOP" if direction == "BUY" else "SELL_STOP"
        ...
        structural_target = (
            ...
            if is_reentry or entry_role == "INITIAL"
            else 0.0
        )
        structural_target_valid = bool(
            (is_reentry or entry_role == "INITIAL")
            and structural_target > 0.0
            and (
                structural_target > entry
                if direction == "BUY"
        ...
        if is_reentry and not structural_target_valid:
            ...
            return (
                ...
                replace(
                    ...
                    reason=wait_reason,
                    invalid_reason=wait_status,
                    invalid_fields=("m24_structural_target",),
        ...
        if entry_role == "INITIAL" and not structural_target_valid:
            wait_status = "M24_INITIAL_AGUARDA_PROJECAO_FIBONACCI_100_VALIDA"
            wait_reason = (
                f"M24/{source_label}: perna estrutural anterior ausente; "
                "TP Fibonacci de 100% e obrigatorio e nao possui fallback fixo."
            )
            wait_parameters = {
                **source_parameters,
                "source_operational_model": source,
                "m24_entry_role": entry_role,
                "m24_individual_target_enabled": False,
                "m24_initial_target_source": MODEL_24_SETUP.initial_target_source,
                "full_exit_usd": MODEL_24_FULL_EXIT_USD,
            }
            return (
                replace(
                ...
                replace(
                    ...
                    reason=wait_reason,
                    invalid_reason=wait_status,
                    invalid_fields=("m24_initial_fibonacci_target",),
                    stop_management_parameters=wait_parameters,
                ),
            )
        parameters = {
            **source_parameters,
            ...
            "m24_lateralization_volume": MODEL_24_LATERALIZATION_VOLUME,
            "execution_volume": (
                MODEL_24_INITIAL_VOLUME
            ...
            "m24_micro_pivot_stop_enabled": (
                is_reentry or entry_role == "INITIAL"
            ),
            "m24_initial_stop_from_micro_pivot": (
                entry_role == "INITIAL"
                and MODEL_24_SETUP.initial_requires_micro_pivot
            ),
            "m24_initial_micro_pivot_trailing_enabled": (
                entry_role == "INITIAL"
            ),
            "m24_initial_structure_break_trailing_enabled": (
                entry_role == "INITIAL"
            ),
            "m24_initial_sma20_trailing_enabled": False,
            ...
            "m24_continuation_sma20_trailing_enabled": False,
            ...
            "m24_structural_target_time": (
                entry_decision.structural_target_time
                if structural_target_valid
                else "N/D"
            ),
            ...
            "m24_initial_target_source": MODEL_24_SETUP.initial_target_source,
            "m24_initial_fibonacci_projection": (
                MODEL_24_SETUP.initial_target_fibonacci_projection
            ),
            "m24_initial_fibonacci_target_price": (
                structural_target
                if entry_role == "INITIAL" and structural_target_valid
                else None
            ),
            ...
            "m24_entry_signal_candle_time": candle_time,
            "m24_initial_rsi50_exit_wait_closed_candles": (
        ...
        transformed_plan = replace(
            ...
            invalid_fields=(),
            stop_reason=(
                "SL um pip alem da extremidade do candle M5 que cruzou a SMA20."
                if entry_role == "INITIAL"
                else (
                    "SL da CONTINUATION no extremo do ultimo M5 fechado; "
                    "acompanha o mesmo extremo a cada novo candle, somente a favor."
                )
                if is_continuation
                else (
            ...
            target_reason=(
                "TP da reentrada pela projecao Fibonacci de 100% da ultima "
                "perna estrutural completa anterior."
                if is_reentry and structural_target_valid
                else (
                    "TP INITIAL pela projecao Fibonacci de 100% da ultima perna "
                    "estrutural completa, projetada a partir da entrada."
                )
                if entry_role == "INITIAL"
                else "CONTINUATION sem TP; BUY sai no RSI70 e SELL no RSI30."
            ),
            stop_management=MODEL_24_EXIT_POLICY,
            stop_management_parameters=parameters,
            stop_management_reason=(
                "M24 usa o preco contra a SMA20 para a direcao e nao fecha por "
                "SMA20/SMA50; INITIAL espera dois M5 fechados antes de liberar "
                "o Full Exit RSI50; CONTINUATION usa SL pelo extremo de cada M5 "
                "fechado e Full Exit no RSI70/30; cesta em +US$1.000."
            ),
            exit_model=MODEL_24_BETA_VERSION,
            alpha_id=MODEL_24_ALPHA_ID,
            alpha_version=MODEL_24_ALPHA_VERSION,
            beta_id=MODEL_24_BETA_ID,
            beta_version=MODEL_24_BETA_VERSION,
            beta_mode="SOURCE_EXIT_PLUS_BASKET_1000",
            beta_reason=(
                "Saida RSI do M24 sem inversao SMA20/SMA50, mais Full Exit "
                "financeiro da cesta."
            ),
            source=MODEL_24_ENTRY_SOURCE,
        )
        transformed_row = replace(
            row,
            timeframe=MODEL_8_TIMEFRAME,
            lab_timeframe=MODEL_8_TIMEFRAME,
            last_price=entry_decision.last_price,
            last_candle_time=candle_time,
            trend=(
                "ALTA"
                if entry_decision.last_price is not None
                and entry_decision.sma20 is not None
                and entry_decision.last_price > entry_decision.sma20
                else "BAIXA"
                if entry_decision.last_price is not None
                and entry_decision.sma20 is not None
                and entry_decision.last_price < entry_decision.sma20
            ...
            momentum=None,
            volatility=None,
            rsi=entry_decision.rsi14,
            short_average=entry_decision.sma20,
            long_average=entry_decision.sma50,
            mid_average=None,
            ema_fast=None,
            ema_mid=None,
            ema_slow=None,
            atr=entry_decision.atr14,
            support=None,
            resistance=None,
            swing_high=None,
            swing_low=None,
            ...
            theoretical_entry_status=(
                "ORDEM_STOP_TEORICA"
                if use_structural and active_order_type in {"BUY_STOP", "SELL_STOP"}
                else "SINAL_TEORICO"
            ),
            ...
            beta_mode="SOURCE_EXIT_PLUS_BASKET_1000",
            lab_parameters=parameters,
            lab_configuration_source=MODEL_24_ENTRY_SOURCE,
            research_plan_status="PLANO_VALIDO",
            research_plan_source=MODEL_24_ENTRY_SOURCE,
            ...
            research_plan_stop_management=MODEL_24_EXIT_POLICY,
    ...
    def model25_theoretical_entry_rows(self) -> list[dict[str, object]]:
        ...
        research = self._mt5_research_source_for_reports()
        active_models = self._active_mt5_research_models_by_market(research)
        active_rows = self._active_mt5_research_rows_by_market(research)
        ...
        for source_row in self._candidate_rows_for_demo_robot(forex, "TODOS"):
            ...
            view_row = self._to_view_model_mt5_forex_signal_row(
                source_row,
                self._active_mt5_research_model_for_row(source_row, active_models, research),
    ...
    def _to_mt5_demo_trade_plan(
        ...
        return MT5DemoTradePlan(
            ...
            stop_management_parameters=dict(plan.stop_management_parameters),
    ...
    def _mt5_apply_operational_model(
        ...
        operational_model: str | None = None,
        *,
        allow_demo_forward_override: bool = False,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        selected_model = str(
            operational_model or self.get_mt5_operational_model()
        ).upper()
        source_model = dynamic_exit_source_model(selected_model)
        if source_model is not None:
            source_row, source_plan = self._mt5_apply_operational_model(
                row,
                plan,
                operational_model=source_model,
                allow_demo_forward_override=allow_demo_forward_override,
            )
            return self._mt5_dynamic_exit_variant_from_source(
                source_row,
                source_plan,
                operational_model=selected_model,
            )
        if selected_model == MT5_OPERATIONAL_MODEL_1:
            return self._mt5_scoped_m1_plan(
                row,
                plan,
                model_id=selected_model,
                allowed_pairs=MODEL_1_FOREX_PAIRS,
        ...
        if selected_model in MT5_LAB_OPERATIONAL_MODELS:
            return self._mt5_lab_operational_plan(
                row,
                plan,
                selected_model,
                allow_demo_forward_override=allow_demo_forward_override,
        ...
        if selected_model == MT5_OPERATIONAL_MODEL_6:
            return self._mt5_scoped_m1_plan(
                ...
                plan,
                model_id=selected_model,
                allowed_pairs=MODEL_6_FOREX_EXPANSION_PAIRS,
                scope_label="M6_FOREX_EXPANSION",
            )
        if selected_model == MT5_OPERATIONAL_MODEL_7:
            return self._mt5_scoped_m1_plan(
                ...
                plan,
                model_id=selected_model,
                allowed_pairs=MODEL_7_ALTERNATIVE_MARKETS,
                scope_label="M7_XAU_BTC",
            )
        ...
        if selected_model in FOREX_SMA_RSI_MODEL_IDS:
            return self._mt5_forex_sma_rsi_plan(row, plan, selected_model)
        return row, plan

    def _mt5_forex_sma_rsi_plan(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
        model_id: str,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        """Materializa M13-M17 por par sobre o cache M5 compartilhado."""
        spec = forex_sma_rsi_spec(model_id)
        pair = str(row.pair or "").upper()
        if spec is None:
            return row, fallback_plan
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = list(candles.get((pair, FOREX_SMA_RSI_TIMEFRAME), []) or [])
        runtime = load_forex_sma_rsi_runtime_state(model_id, pair)
        decision = evaluate_forex_sma_rsi_entry(
            model_id, pair, rows,
            awaiting_reentry_side=str(runtime.get("entry_intent_side") or ""),
        )
        decision = self._block_seed_only_forex_m5_decision(decision, pair)
        parameters = forex_sma_rsi_parameters(model_id, pair)
        parameters["active_entry_order_type"] = decision.base.entry_order_type
        parameters.update(
            {
                "indicator_source": OPERATIONAL_INDICATOR_SOURCE,
                "indicator_generated_at": decision.base.current_candle_time,
                "indicator_closed_candle_time": decision.base.closed_candle_time,
            }
        )
        diagnostics = (
            f"SETUP={spec.setup}", f"SMA20={decision.base.sma20}",
            f"SMA50={decision.base.sma50}", f"RSI14={decision.base.rsi14}",
            f"ADX14={decision.adx14}", f"ATR14={decision.atr14}",
            f"DISTANCE_ATR={decision.distance_atr}",
            f"SMA50_SLOPE_ATR={decision.sma50_slope_atr}",
            f"ENTRY={decision.base.entry_order_type}",
        )
        common = dict(
            symbol=pair, timeframe=FOREX_SMA_RSI_TIMEFRAME, target=None,
            risk_reward=0.0, source=spec.source,
            stop_management=spec.stop_management,
            stop_management_parameters=parameters,
            alpha_id=spec.alpha_id, alpha_version=spec.alpha_version,
            beta_id=spec.beta_id, beta_version=spec.beta_version,
            beta_mode="FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
            diagnostics=diagnostics,
        )
        if not decision.ready:
            wait_plan = replace(
                fallback_plan, direction="WAIT", entry_price=None, stop=None,
                status=decision.status, reason=decision.reason,
                invalid_reason=decision.status, invalid_fields=("entry_trigger",),
                **common,
            )
            return replace(
                row, timeframe="M5", lab_timeframe="M5", decision="WAIT",
                theoretical_entry_direction="WAIT",
                theoretical_entry_status=decision.status,
                theoretical_entry_price=None,
                theoretical_entry_reason=decision.reason,
                active_model=f"M{spec.number}_SETUP_{spec.setup}_FOREX_M5",
                active_model_indicators=diagnostics, reason=decision.reason,
                lab_alpha_id=spec.alpha_id, lab_alpha_version=spec.alpha_version,
                beta_id=spec.beta_id, beta_version=spec.beta_version,
                beta_mode="FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
                lab_parameters=parameters, lab_configuration_source=spec.source,
                research_plan_status=decision.status,
                research_plan_source=spec.source,
                research_plan_reason=decision.reason,
                research_plan_diagnostics=diagnostics,
            ), wait_plan
        entry = float(decision.base.entry_price or 0.0)
        stop = float(decision.base.initial_stop or 0.0)
        risk = abs(entry - stop)
        trade_plan = MT5ResearchTradePlan(
            direction=decision.base.direction, entry_price=entry, stop=stop,
            target=0.0, risk_reward=0.0, stop_multiplier=0.0, exit_model=spec.beta_version,
            exit_score=0.0, exit_candidates=2, status="PLANO_VALIDO",
            risk_pips=risk, risk_percent=abs(risk / entry) if entry else 0.0,
            reward_pips=0.0, reward_percent=0.0,
            stop_reason="Um pip alem do ultimo pivo M5 confirmado 2+2.",
            target_reason="Sem TP fixo.",
            stop_management_reason="Full Exit RSI 70/30 ou inversao SMA.",
            beta_reason="Full Exit RSI 70/30 ou inversao SMA.",
            reason=decision.reason, rr_current=0.0, rr_minimum=0.0,
            certification_score=100.0, certification_grade="USER_DEFINED_DEMO",
            certification_status="USER_APPROVED_DEMO_RULE",
            certification_usage="Regra manual autorizada somente para MT5 Demo.",
            certification_demo_allowed=True,
            **{key: value for key, value in common.items() if key not in {"target", "risk_reward"}},
        )
        return replace(
            row, timeframe="M5", lab_timeframe="M5",
            decision=decision.base.direction,
            theoretical_entry_direction=decision.base.direction,
            theoretical_entry_status=("ORDEM_STOP_TEORICA" if decision.base.signal_kind == "REENTRY" else "SINAL_TEORICO"),
            theoretical_entry_candle=decision.base.closed_candle_time,
            theoretical_entry_price=entry, theoretical_entry_reason=decision.reason,
            active_model=f"M{spec.number}_SETUP_{spec.setup}_FOREX_M5",
            active_model_indicators=diagnostics, reason=decision.reason,
            short_average=decision.base.sma20, long_average=decision.base.sma50,
            lab_alpha_id=spec.alpha_id, lab_alpha_version=spec.alpha_version,
            beta_id=spec.beta_id, beta_version=spec.beta_version,
            beta_mode="FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
            lab_parameters=parameters, lab_configuration_source=spec.source,
            lab_confidence=1.0, lab_ict_score=100.0,
            lab_ict_grade="USER_DEFINED_DEMO", lab_ict_status="USER_APPROVED_DEMO_RULE",
            lab_ict_usage=trade_plan.certification_usage, lab_ict_demo_allowed=True,
            entry_filter_status="OK", entry_filter_parameter=f"SETUP_{spec.setup}",
            entry_filter_reading=decision.status, entry_filter_reason=decision.reason,
            research_plan_status="PLANO_VALIDO", research_plan_source=spec.source,
            research_plan_entry_price=entry, research_plan_stop=stop,
            research_plan_target=0.0, research_plan_risk_reward=0.0,
            research_plan_risk_pips=risk,
            research_plan_stop_management=spec.stop_management,
            research_plan_stop_management_parameters=parameters,
            research_plan_reason=decision.reason,
            research_plan_diagnostics=diagnostics,
        ), trade_plan

    def get_model3_entry_decision(self) -> Model3EntryDecision:
        """Avalia o M3 somente com o snapshot XAUUSD/M5 compartilhado."""
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = (
            list(candles.get((MODEL_3_SYMBOL, MODEL_3_TIMEFRAME), []) or [
            ])[-OPERATIONAL_INDICATOR_RAW_CANDLES:]
            if isinstance(candles, dict)
            else []
        )
        decision = evaluate_model3_entry(rows)
        if self._supplemental_m5_is_seed_only(MODEL_3_SYMBOL):
            return replace(
                decision,
                direction="WAIT",
                status="M3_AQUECIDO_200_FECHADOS_AGUARDA_ATUALIZACAO_MT5",
                reason=(
                    "M3 possui 200 velas M5 fechadas para indicadores, mas aguarda "
                    "um candle atual confirmado pelo MT5 antes de operar."
                ),
                entry_price=None,
                initial_stop=None,
            )
    ...
    def get_model8_entry_decision(self) -> Model8EntryDecision:
        ...
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = (
            list(candles.get((MODEL_8_SYMBOL, MODEL_8_TIMEFRAME), []) or [
            ])[-OPERATIONAL_INDICATOR_RAW_CANDLES:]
            if isinstance(candles, dict)
            else []
        )
        ...
        decision = evaluate_model8_entry(
            rows,
            awaiting_reentry_side=str(state.get("entry_intent_side") or ""),
        )
        if self._supplemental_m5_is_seed_only(MODEL_8_SYMBOL):
            return replace(
                decision, direction="WAIT",
                status="M8_AQUECIDO_200_FECHADOS_AGUARDA_ATUALIZACAO_MT5",
                reason=(
                    "M8 possui 200 velas fechadas locais, mas aguarda lote completo "
                    "e atual do MT5 antes de calcular/liberar entrada."
                ),
                signal_kind="NONE", entry_order_type="NONE",
                entry_price=None, initial_stop=None,
            )
        return decision

    def get_xau_trend_filter_entry_decision(self, model_id: str):
        """Avalia M9-M12 e M18-M22 no snapshot XAUUSD/M5 compartilhado."""
        if trend_filter_spec(model_id) is None:
            raise ValueError(f"Modelo XAU/M5 desconhecido: {model_id}")
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = (
            list(candles.get((MODEL_8_SYMBOL, MODEL_8_TIMEFRAME), []) or [
            ])[-OPERATIONAL_INDICATOR_RAW_CANDLES:]
        ...
        runtime = load_model8_runtime_state(operational_model=model_id)
        decision = evaluate_xau_trend_filter_entry(
            model_id, rows,
            awaiting_reentry_side=str(runtime.get("entry_intent_side") or ""),
        )
        if model_id in XAU_IMPROVED_REENTRY_MODEL_IDS and decision.base.direction in {
            "BUY",
            "SELL",
        }:
            cycle_side = str(runtime.get("signal_cycle_side") or "").upper()
            if cycle_side != decision.base.direction:
                runtime = update_model8_runtime_state(
                    operational_model=model_id,
                    signal_cycle_side=decision.base.direction,
                    initial_entry_consumed=False,
                    reentry_consumed=False,
                    entry_intent_side="",
                    entry_intent_kind="",
                )
                decision = evaluate_xau_trend_filter_entry(model_id, rows)
            is_reentry = decision.base.entry_order_type in {"BUY_STOP", "SELL_STOP"}
            blocked = (
                False
                if is_reentry
                else bool(runtime.get("initial_entry_consumed"))
            )
            if blocked:
                stage = "REENTRADA" if is_reentry else "ENTRADA_INICIAL"
                status = f"M{trend_filter_spec(model_id).number}_{stage}_JA_CONSUMIDA"
                reason = (
                    f"{stage.replace('_', ' ').title()} ja executada neste ciclo; "
                    "aguardando nova direcao SMA/RSI para rearmar o modelo."
                )
                decision = replace(
                    decision,
                    base=replace(
        ...
        if self._supplemental_m5_is_seed_only(MODEL_8_SYMBOL):
            ...
            status = f"M{spec.number}_AQUECIDO_200_FECHADOS_AGUARDA_ATUALIZACAO_MT5"
            reason = "Aguardando 200 velas M5 fechadas e a vela atual do MT5."
            return replace(
                decision,
                base=replace(
                    decision.base, direction="WAIT", status=status, reason=reason,
                    signal_kind="NONE", entry_order_type="NONE",
                    entry_price=None, initial_stop=None,
                ),
                filter_allowed=False, status=status, reason=reason,
                failed_filters=tuple(
                    dict.fromkeys((*decision.failed_filters, "LIVE_CLOSED_CANDLES_200"))
                ),
            )
        return decision

    def _supplemental_m5_is_seed_only(self, pair: str) -> bool:
        keys = getattr(
            self.mt5_market_data_service,
            "supplemental_forex_seed_only_keys",
            set(),
        )
        return (str(pair).upper(), "M5") in set(keys or set())

    def _block_seed_only_forex_m5_decision(self, decision, pair: str):
        if not self._supplemental_m5_is_seed_only(pair):
            return decision
        spec = forex_sma_rsi_spec(decision.model_id)
        status = (
            f"M{spec.number}_AQUECIDO_200_FECHADOS_AGUARDA_ATUALIZACAO_MT5"
            if spec is not None
            else "AQUECIDO_200_FECHADOS_AGUARDA_ATUALIZACAO_MT5"
        )
        reason = (
            f"{str(pair).upper()} possui 200 velas M5 fechadas para indicadores, "
            "mas aguarda candle atual confirmado pelo MT5 antes de operar."
        )
        return replace(
            decision,
            base=replace(
            ...
            reason=reason,
            failed_filters=tuple(
                dict.fromkeys((*decision.failed_filters, "LIVE_CANDLE"))
            ),
        )

    def get_xau_m5_operational_decision_snapshot(
        self,
    ) -> dict[tuple[str, str], object]:
        """Expoe os modelos XAU ativos calculados sobre o cache M5 do ciclo."""
        selected = set(self._mt5_entry_source_models_to_evaluate())
        active = selected.intersection(
            {
                MT5_OPERATIONAL_MODEL_3,
                MT5_OPERATIONAL_MODEL_8,
                MT5_OPERATIONAL_MODEL_10,
        ...
        if MT5_OPERATIONAL_MODEL_3 in active:
            decisions[(MT5_OPERATIONAL_MODEL_3, MODEL_3_SYMBOL)] = (
                self.get_model3_entry_decision()
            )
        ...
        for model_id in XAU_TREND_FILTER_MODEL_IDS:
            if model_id in active:
                decisions[(model_id, MODEL_8_SYMBOL)] = (
                    self.get_xau_trend_filter_entry_decision(model_id)
                )
        return decisions

    def get_forex_m5_sma_rsi_decision_snapshot(
        self,
    ) -> dict[tuple[str, str], object]:
        """Publica M13-M17 e a contagem da janela M5 do mesmo ciclo."""
        active = set(self._mt5_entry_source_models_to_evaluate()).intersection(
            FOREX_SMA_RSI_MODEL_IDS
        )
        candles_by_market = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        if not isinstance(candles_by_market, dict):
            candles_by_market = {}
        decisions: dict[tuple[str, str], object] = {}
        for pair in FOREX_SMA_RSI_PAIRS:
            rows = list(
                candles_by_market.get((pair, FOREX_SMA_RSI_TIMEFRAME), []) or []
            )[-OPERATIONAL_INDICATOR_RAW_CANDLES:]
            decisions[("__FOREX_M5__", pair)] = len(rows)
            for model_id in active:
                runtime = load_forex_sma_rsi_runtime_state(model_id, pair)
                decisions[(model_id, pair)] = evaluate_forex_sma_rsi_entry(
                    model_id, pair, rows,
                    awaiting_reentry_side=str(runtime.get("entry_intent_side") or ""),
                )
                decisions[(model_id, pair)] = self._block_seed_only_forex_m5_decision(
                    decisions[(model_id, pair)], pair,
                )
        return decisions

    def _mt5_model3_xau_m5_plan(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        """Materializa o M3: direcao e reversao pelo RSI14 em torno de 50."""
        pair = str(row.pair or "").upper()
        if pair != MODEL_3_SYMBOL:
            reason = f"M3 opera exclusivamente {MODEL_3_SYMBOL}."
            return (
                replace(
                    row,
                    decision="WAIT",
        ...
        decision = self.get_model3_entry_decision()
        parameters = model3_parameters()
        parameters["active_entry_order_type"] = "MARKET"
        diagnostics = (
            f"RSI14={decision.rsi14 if decision.rsi14 is not None else 'N/D'}",
            "RSI_LEVEL=50",
            f"LAST_SWING={decision.last_swing_price or 'N/D'}",
            "ENTRY=MARKET",
            "TAKE_PROFIT=DISABLED",
            "REVERSE_AFTER_FULL_EXIT=ENABLED",
        )
        common_plan = dict(
            ...
            stop_management=MODEL_3_STOP_MANAGEMENT,
            stop_management_parameters=parameters,
            alpha_id=MODEL_3_ALPHA_ID,
            alpha_version=MODEL_3_ALPHA_VERSION,
        ...
        if not decision.ready:
            ...
            return (
                replace(
                    row,
                    timeframe=MODEL_3_TIMEFRAME,
                    lab_timeframe=MODEL_3_TIMEFRAME,
                    ...
                    reason=decision.reason,
                    lab_alpha_id=MODEL_3_ALPHA_ID,
                    lab_alpha_version=MODEL_3_ALPHA_VERSION,
                    beta_id=MODEL_3_BETA_ID,
                    beta_version=MODEL_3_BETA_VERSION,
                    beta_mode=MODEL_3_BETA_MODE,
                    lab_parameters=parameters,
                    lab_configuration_source="MODEL_3_MANUAL_RULE",
                    research_plan_status=decision.status,
                    research_plan_source="MODEL_3_MANUAL_RULE",
                    research_plan_reason=decision.reason,
                    research_plan_diagnostics=diagnostics,
                ),
                wait_plan,
        ...
        plan = MT5ResearchTradePlan(
            ...
            risk_reward=0.0,
            stop_multiplier=0.0,
            exit_model=MODEL_3_BETA_VERSION,
            exit_score=0.0,
            exit_candidates=2,
            status="PLANO_VALIDO",
            risk_pips=risk,
            ...
            reward_percent=0.0,
            stop_reason="0,01 alem do ultimo fundo/topo M5 confirmado (pivo 2+2).",
            target_reason="M3 nao usa TP fixo.",
            stop_management_reason="Full exit quando o RSI14 fecha no lado oposto de 50; depois inverte.",
            beta_reason="Full exit e inversao pelo nivel RSI14=50 no M5 fechado.",
            source="MODEL_3_MANUAL_RULE",
            reason=decision.reason,
            rr_current=0.0,
            rr_minimum=0.0,
            ...
            certification_status="USER_APPROVED_DEMO_RULE",
            certification_usage="Regra manual autorizada exclusivamente para MT5 Demo.",
            certification_demo_allowed=True,
            **{
                key: value
                for key, value in common_plan.items()
                if key not in {"target", "risk_reward", "source"}
            },
        )
        return (
            replace(
                ...
                active_model="M3_XAU_M5_RSI14_FLIP",
                active_model_indicators=diagnostics,
                active_model_score=1.0,
                reason=decision.reason,
                swing_low=(
                    decision.last_swing_price
                ...
                entry_filter_parameter="M3_RSI14_LEVEL_50",
    ...
    def _mt5_model8_xau_m5_plan(
        ...
        """Materializa entrada inicial a mercado e reentrada Stop do M8."""
        pair = str(row.pair or "").upper()
        if pair != MODEL_8_SYMBOL:
            reason = f"M8 opera exclusivamente {MODEL_8_SYMBOL}."
            return (
                replace(
                    row,
                    decision="WAIT",
        ...
        decision = self.get_model8_entry_decision()
        parameters = model8_parameters()
        parameters["active_entry_order_type"] = decision.entry_order_type
        parameters.update(
            {
                "indicator_source": OPERATIONAL_INDICATOR_SOURCE,
                "indicator_generated_at": decision.current_candle_time,
                "indicator_closed_candle_time": decision.closed_candle_time,
                "structural_target_price": decision.structural_target_price,
                "structural_target_time": decision.structural_target_time,
            }
        )
        diagnostics = (
            f"SMA20={decision.sma20 if decision.sma20 is not None else 'N/D'}",
            f"SMA50={decision.sma50 if decision.sma50 is not None else 'N/D'}",
            f"RSI14={decision.rsi14 if decision.rsi14 is not None else 'N/D'}",
            f"SIGNAL_KIND={decision.signal_kind}",
            f"LAST_SWING={decision.last_swing_price or 'N/D'}",
            f"STRUCTURAL_TARGET={decision.structural_target_price or 'N/D'}",
            f"ENTRY={decision.entry_order_type}",
            "TAKE_PROFIT=DISABLED",
        )
        common_plan = dict(
            ...
            stop_management=MODEL_8_STOP_MANAGEMENT,
            stop_management_parameters=parameters,
            alpha_id=MODEL_8_ALPHA_ID,
            alpha_version=MODEL_8_ALPHA_VERSION,
            beta_id=MODEL_8_BETA_ID,
            beta_version=MODEL_8_BETA_VERSION,
            beta_mode="FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
            diagnostics=diagnostics,
        )
        if not decision.ready:
            ...
            return (
                replace(
                    ...
                    active_model_indicators=diagnostics,
                    reason=decision.reason,
                    short_average=decision.sma20,
                    long_average=decision.sma50,
                    lab_alpha_id=MODEL_8_ALPHA_ID,
                    lab_alpha_version=MODEL_8_ALPHA_VERSION,
                    beta_id=MODEL_8_BETA_ID,
                    beta_version=MODEL_8_BETA_VERSION,
                    beta_mode="FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
                    lab_parameters=parameters,
                    lab_configuration_source="MODEL_8_MANUAL_RULE",
                    research_plan_status=decision.status,
                    research_plan_source="MODEL_8_MANUAL_RULE",
                    research_plan_reason=decision.reason,
                    research_plan_diagnostics=diagnostics,
                ),
                wait_plan,
        ...
        plan = MT5ResearchTradePlan(
            ...
            risk_reward=0.0,
            stop_multiplier=0.0,
            exit_model=MODEL_8_BETA_VERSION,
            exit_score=0.0,
            exit_candidates=2,
            status="PLANO_VALIDO",
            risk_pips=risk,
            ...
            risk_percent=abs(risk / entry) if entry else 0.0,
            reward_percent=0.0,
            stop_reason="1 pip alem do ultimo fundo/topo M5 confirmado (pivo 2+2).",
            target_reason="M8 nao usa TP fixo.",
            stop_management_reason="Full exit no cruzamento confirmado RSI 70/30 ou inversao SMA20/SMA50.",
            beta_reason="Full exit no cruzamento confirmado RSI 70/30 ou inversao SMA20/SMA50.",
            source="MODEL_8_MANUAL_RULE",
            reason=decision.reason,
            rr_current=0.0,
            rr_minimum=0.0,
            ...
            certification_usage="Regra manual autorizada exclusivamente para MT5 Demo.",
            certification_demo_allowed=True,
            **{key: value for key, value in common_plan.items() if key not in {"target", "risk_reward", "source"}},
        )
        return (
            replace(
                row,
                ...
                theoretical_entry_status=(
                    "ORDEM_STOP_TEORICA"
                    if decision.signal_kind == "REENTRY"
                    else "SINAL_TEORICO"
                ),
                theoretical_entry_candle=decision.closed_candle_time,
                theoretical_entry_price=entry,
                ...
                short_average=decision.sma20,
                long_average=decision.sma50,
                swing_low=decision.last_swing_price if decision.direction == "BUY" else row.swing_low,
                swing_high=decision.last_swing_price if decision.direction == "SELL" else row.swing_high,
                lab_alpha_id=MODEL_8_ALPHA_ID,
                lab_alpha_version=MODEL_8_ALPHA_VERSION,
                beta_id=MODEL_8_BETA_ID,
                beta_version=MODEL_8_BETA_VERSION,
                ...
                lab_ict_demo_allowed=True,
                entry_filter_status="OK",
                entry_filter_parameter="M8_RSI50_WITH_SMA_DIRECTION",
                entry_filter_reading=decision.status,
                entry_filter_reason=decision.reason,
                research_plan_status="PLANO_VALIDO",
                research_plan_source="MODEL_8_MANUAL_RULE",
                ...
                research_plan_risk_reward=0.0,
                research_plan_risk_pips=risk,
                research_plan_stop_management=MODEL_8_STOP_MANAGEMENT,
                research_plan_stop_management_parameters=parameters,
                research_plan_reason=decision.reason,
                research_plan_diagnostics=diagnostics,
            ),
    ...
    def _mt5_xau_trend_filter_plan(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
        model_id: str,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        """Materializa B-E sem duplicar o contrato estrutural do setup A."""
        spec = trend_filter_spec(model_id)
        if spec is None:
            return row, fallback_plan
        base_row, base_plan = self._mt5_model8_xau_m5_plan(row, fallback_plan)
        if str(row.pair or "").upper() != MODEL_8_SYMBOL:
            reason = f"M{spec.number} opera exclusivamente {MODEL_8_SYMBOL}."
            return (
                replace(
                    base_row,
                    decision="WAIT",
                    ...
                    theoretical_entry_price=None,
                    theoretical_entry_reason=reason,
                    research_plan_status="PLANO_INVALIDO",
                    research_plan_entry_price=None,
                    research_plan_stop=None,
                    research_plan_target=None,
                    research_plan_reason=reason,
        ...
        decision = self.get_xau_trend_filter_entry_decision(model_id)
        ...
        parameters.update(
            {
                ...
                "indicator_generated_at": decision.base.current_candle_time,
                "indicator_closed_candle_time": decision.base.closed_candle_time,
                "structural_target_price": decision.base.structural_target_price,
                "structural_target_time": decision.base.structural_target_time,
            }
        )
        diagnostics = tuple(base_row.active_model_indicators) + (
            f"SETUP={spec.setup}",
            f"ENTRY={decision.base.entry_order_type}",
            f"ADX14={decision.adx14 if decision.adx14 is not None else 'N/D'}",
            f"ATR14={decision.atr14 if decision.atr14 is not None else 'N/D'}",
            f"DISTANCE_ATR={decision.distance_atr if decision.distance_atr is not None else 'N/D'}",
            f"SMA50_SLOPE_ATR={decision.sma50_slope_atr if decision.sma50_slope_atr is not None else 'N/D'}",
            f"PASSED={','.join(decision.passed_filters) or 'NONE'}",
            f"FAILED={','.join(decision.failed_filters) or 'NONE'}",
        )
        identity = {
            "alpha_id": spec.alpha_id,
            "alpha_version": spec.alpha_version,
            "beta_id": spec.beta_id,
            "beta_version": spec.beta_version,
            "beta_mode": "FULL_EXIT_RSI70_30_CROSS_OR_SMA_INVERSION",
            "source": spec.source,
            "stop_management": spec.stop_management,
            "stop_management_parameters": parameters,
        ...
        if not decision.ready:
            plan = replace(
                ...
                reason=decision.reason,
                invalid_reason=decision.status,
                invalid_fields=("entry_trigger", "sideways_filter"),
                **identity,
            )
            return (
                replace(
                    ...
                    theoretical_entry_price=None,
                    theoretical_entry_reason=decision.reason,
                    active_model=f"M{spec.number}_SETUP_{spec.setup}_XAU_M5",
                    active_model_indicators=diagnostics,
                    reason=decision.reason,
                    lab_alpha_id=spec.alpha_id,
                    lab_alpha_version=spec.alpha_version,
                    beta_id=spec.beta_id,
                    beta_version=spec.beta_version,
                    lab_parameters=parameters,
                    lab_configuration_source=spec.source,
                    entry_filter_status=(
                        "BLOQUEADO" if decision.failed_filters else "AGUARDANDO"
                    ),
                    entry_filter_parameter=f"SETUP_{spec.setup}_SIDEWAYS_FILTER",
                    entry_filter_reading=decision.status,
                    entry_filter_reason=decision.reason,
                    research_plan_status=decision.status,
                    research_plan_source=spec.source,
        ...
        stop = float(decision.base.initial_stop or 0.0)
        risk = abs(entry - stop)
        target = xau_reentry_target(
            model_id,
            decision.base.direction,
            entry,
            decision.base.entry_order_type,
            decision.base.structural_target_price,
        )
        reward = abs(target - entry) if target else 0.0
        risk_reward = reward / risk if risk > 0.0 and reward > 0.0 else 0.0
        plan = replace(
            base_plan,
            direction=decision.base.direction,
            entry_price=entry,
            stop=stop,
            target=target,
            ...
            target_reason=(
                "Reentrada com TP no topo/fundo M5 confirmado antes da correcao; "
                "Full Exit por perda do RSI50 ou inversao SMA permanece ativo."
                if target
                else "Entrada inicial sem TP; Full Exit do modelo permanece ativo."
            ),
            status="PLANO_VALIDO",
            reason=decision.reason,
            invalid_reason="",
        ...
        return (
            replace(
                ...
                theoretical_entry_status=(
                    "ORDEM_STOP_TEORICA"
                    if decision.base.signal_kind == "REENTRY"
                    else "SINAL_TEORICO"
                ),
                theoretical_entry_price=entry,
                active_model=f"M{spec.number}_SETUP_{spec.setup}_XAU_M5",
    ...
    def get_model15_entry_decision(
        self,
        *,
        read_only_fallback: bool = False,
    ) -> Model15EntryDecision:
        """Expoe M15; somente a UI pode reutilizar o ultimo estado auditado."""
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = (
            list(candles.get((MODEL_15_SYMBOL, MODEL_15_TIMEFRAME), []) or [])
            if isinstance(candles, dict)
            else []
        )
        decision = evaluate_model15_entry(rows, pip_size=MODEL_15_PIP_SIZE)
        if read_only_fallback and len(rows) < 51:
            persisted = self._model15_decision_from_runtime_state()
            if persisted is not None:
                return persisted
            return decision
        self._persist_model15_runtime_state(decision)
        return decision

    def _model15_decision_from_runtime_state(
        self,
    ) -> Model15EntryDecision | None:
        payload = self.get_model15_runtime_state()
        status = str(payload.get("status") or "").strip()
        if not status or status == "M15_CANDLES_INSUFICIENTES":
            return None
        try:
            return Model15EntryDecision(
                ...
                current_candle_time=str(
                    payload.get("current_candle_time") or "N/D"
                ),
                previous_candle_time=str(
                    payload.get("previous_candle_time") or "N/D"
                ),
                entry_price=self._optional_float(payload.get("entry_price")),
                initial_stop=self._optional_float(payload.get("initial_stop")),
                ema20=self._optional_float(payload.get("ema20")),
                ema50=self._optional_float(payload.get("ema50")),
                previous_high=self._optional_float(payload.get("previous_high")),
                previous_low=self._optional_float(payload.get("previous_low")),
                current_high=self._optional_float(payload.get("current_high")),
                current_low=self._optional_float(payload.get("current_low")),
            )
        except (TypeError, ValueError):
            return None

    def get_model15_runtime_state(self) -> dict[str, Any]:
        """Return the latest compact M15 audit state persisted by the runtime."""

        try:
            payload = json.loads(
                _MODEL15_RUNTIME_STATE_PATH.read_text(encoding="utf-8")
            )
        except (OSError, json.JSONDecodeError):
            return {}
        return dict(payload) if isinstance(payload, dict) else {}

    def _persist_model15_runtime_state(self, decision: Model15EntryDecision) -> None:
        if os.getenv("PYTEST_CURRENT_TEST"):
            return
        payload = {
            **asdict(decision),
            "symbol": MODEL_15_SYMBOL,
            "timeframe": MODEL_15_TIMEFRAME,
            "operational_model": MT5_OPERATIONAL_MODEL_15,
        ...
        if signature == self.model15_runtime_state_signature:
            return
        if not self.model15_runtime_state_signature:
            previous = self.get_model15_runtime_state()
            previous.pop("captured_at", None)
            if previous == signature_payload:
                object.__setattr__(self, "model15_runtime_state_signature", signature)
                return
        target = _MODEL15_RUNTIME_STATE_PATH
        temporary = target.with_name(
            f"{target.name}.{os.getpid()}.{threading.get_ident()}.tmp"
        )
        try:
    ...
    def _mt5_model15_xau_m5_plan(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        """Materializa o breakout M5 do ouro sem TP fixo ou Lab pesado."""
        pair = str(row.pair or "").upper()
        if pair != MODEL_15_SYMBOL:
            reason = f"M15 opera exclusivamente {MODEL_15_SYMBOL}."
            return (
                replace(
                    row,
                    decision="WAIT",
        ...
        decision = self.get_model15_entry_decision()
        parameters = model15_stop_management_parameters()
        diagnostics = (
            f"EMA20={decision.ema20 if decision.ema20 is not None else 'N/D'}",
            f"EMA50={decision.ema50 if decision.ema50 is not None else 'N/D'}",
            f"PREVIOUS_HIGH={decision.previous_high or 'N/D'}",
            f"PREVIOUS_LOW={decision.previous_low or 'N/D'}",
            f"CURRENT_HIGH={decision.current_high or 'N/D'}",
            f"CURRENT_LOW={decision.current_low or 'N/D'}",
            "ENTRY_BUFFER=1_PIP",
            "STOP_BUFFER=0_EXACT_EXTREME",
            "TAKE_PROFIT=DISABLED",
        )
        if not decision.ready:
            wait_plan = replace(
                ...
                risk_reward=0.0,
                status=decision.status,
                source="MODEL_15_MANUAL_RULE",
                reason=decision.reason,
                invalid_reason=decision.status,
                invalid_fields=("entry_trigger",),
                stop_management=MODEL_15_STOP_MANAGEMENT,
                stop_management_parameters=parameters,
                alpha_id=MODEL_15_ALPHA_ID,
                alpha_version=MODEL_15_ALPHA_VERSION,
            ...
            return (
                replace(
                    row,
                    timeframe=MODEL_15_TIMEFRAME,
                    lab_timeframe=MODEL_15_TIMEFRAME,
                    last_candle_time=decision.current_candle_time,
                    decision="WAIT",
                    theoretical_entry_direction="WAIT",
                    theoretical_entry_status=decision.status,
                    theoretical_entry_candle=decision.current_candle_time,
                    theoretical_entry_price=decision.entry_price,
                    theoretical_entry_reason=decision.reason,
                    active_model="M15_XAU_M5_EMA20_50_BREAKOUT",
                    active_model_indicators=diagnostics,
                    reason=decision.reason,
                    short_average=decision.ema20,
                    long_average=decision.ema50,
                    swing_high=decision.previous_high,
                    swing_low=decision.previous_low,
                    lab_alpha_id=MODEL_15_ALPHA_ID,
                    lab_alpha_version=MODEL_15_ALPHA_VERSION,
                    beta_id=MODEL_15_BETA_ID,
                    beta_version=MODEL_15_BETA_VERSION,
                    beta_mode="TRAILING_ONLY",
                    beta_reason="SL acompanha o extremo do candle M5 anterior.",
                    lab_parameters=parameters,
                    lab_configuration_source="MODEL_15_MANUAL_RULE",
                    entry_filter_status="AGUARDANDO",
                    entry_filter_parameter="M15_EMA_BREAKOUT_PREVIOUS_CANDLE",
                    entry_filter_reading=decision.status,
                    entry_filter_reason=decision.reason,
                    research_plan_status=decision.status,
                    research_plan_source="MODEL_15_MANUAL_RULE",
                    research_plan_entry_price=decision.entry_price,
                    research_plan_stop=decision.initial_stop,
                    research_plan_target=None,
                    research_plan_risk_reward=0.0,
                    research_plan_stop_management=MODEL_15_STOP_MANAGEMENT,
                    research_plan_stop_management_parameters=parameters,
                    research_plan_reason=decision.reason,
                    research_plan_diagnostics=diagnostics,
                ),
        ...
        plan = MT5ResearchTradePlan(
            ...
            risk_reward=0.0,
            stop_multiplier=0.0,
            exit_model=MODEL_15_BETA_VERSION,
            exit_score=0.0,
            exit_candidates=1,
            status="PLANO_VALIDO",
            risk_pips=risk,
            ...
            risk_percent=abs(risk / entry) if entry else 0.0,
            reward_percent=0.0,
            stop_reason="Extremo oposto exato do candle M5 anterior.",
            target_reason="M15 nao usa TP fixo; saida exclusivamente pelo SL movel.",
            stop_management=MODEL_15_STOP_MANAGEMENT,
            stop_management_parameters=parameters,
            stop_management_reason=(
                "A cada ciclo, usar o extremo do ultimo candle M5 fechado e "
                "mover o SL somente quando ficar mais protetivo."
            ),
            alpha_id=MODEL_15_ALPHA_ID,
            alpha_version=MODEL_15_ALPHA_VERSION,
            beta_id=MODEL_15_BETA_ID,
            beta_version=MODEL_15_BETA_VERSION,
            beta_mode="TRAILING_ONLY",
            beta_reason="Sem TP e sem Full Exit; encerramento pelo SL movel.",
            source="MODEL_15_MANUAL_RULE",
            reason=reason,
            rr_current=0.0,
            rr_minimum=0.0,
        ...
        return (
            replace(
                ...
                research_plan_risk_reward=0.0,
                research_plan_risk_pips=risk,
                research_plan_reward_pips=0.0,
                research_plan_risk_percent=plan.risk_percent,
                research_plan_reward_percent=0.0,
                research_plan_stop_reason=plan.stop_reason,
                research_plan_target_reason=plan.target_reason,
                research_plan_exit_model=MODEL_15_BETA_VERSION,
                research_plan_stop_management=MODEL_15_STOP_MANAGEMENT,
                research_plan_stop_management_parameters=parameters,
                research_plan_stop_management_reason=plan.stop_management_reason,
                dynamic_exit_policy=MODEL_15_STOP_MANAGEMENT,
                dynamic_exit_action="HOLD_POSITION",
                dynamic_exit_reason="Aguardar novo candle M5 fechado para atualizar SL.",
                dynamic_exit_confidence=1.0,
                dynamic_exit_candidate_stop=None,
                dynamic_exit_allowed_to_execute_demo=(
                    self._dynamic_exit_demo_sl_assisted_enabled()
                ),
                dynamic_exit_source="M15_PREVIOUS_CANDLE_TRAILING",
                research_plan_reason=reason,
                research_plan_rr_current=0.0,
                research_plan_rr_minimum=0.0,
                research_plan_diagnostics=diagnostics,
            ),
            plan,
        )

    def get_model16_entry_decision(
        self,
        *,
        read_only_fallback: bool = False,
    ) -> Model16EntryDecision:
        """Expoe M16; somente a UI pode reutilizar o ultimo estado auditado."""
        candles = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
        rows = (
            list(candles.get((MODEL_16_SYMBOL, MODEL_16_TIMEFRAME), []) or [])
            if isinstance(candles, dict)
            else []
        )
        decision = evaluate_model16_entry(rows, pip_size=MODEL_16_PIP_SIZE)
        if read_only_fallback and len(rows) < 21:
            persisted = self._model16_decision_from_runtime_state()
            if persisted is not None:
                return persisted
            return decision
        self._persist_model16_runtime_state(decision)
        return decision

    def _model16_decision_from_runtime_state(
        self,
    ) -> Model16EntryDecision | None:
        payload = self.get_model16_runtime_state()
        status = str(payload.get("status") or "").strip()
        if not status or status == "M16_CANDLES_INSUFICIENTES":
            return None
        try:
            return Model16EntryDecision(
                ...
                entry_price=self._optional_float(payload.get("entry_price")),
                initial_stop=self._optional_float(payload.get("initial_stop")),
                current_price=self._optional_float(payload.get("current_price")),
                ema20=self._optional_float(payload.get("ema20")),
                previous_high=self._optional_float(payload.get("previous_high")),
                previous_low=self._optional_float(payload.get("previous_low")),
                current_high=self._optional_float(payload.get("current_high")),
    ...
    def get_model16_runtime_state(self) -> dict[str, Any]:
        """Retorna o ultimo estado compacto e persistido do M16."""
        try:
            payload = json.loads(
                _MODEL16_RUNTIME_STATE_PATH.read_text(encoding="utf-8")
            )
        except (OSError, json.JSONDecodeError):
            return {}
        return dict(payload) if isinstance(payload, dict) else {}

    def _persist_model16_runtime_state(self, decision: Model16EntryDecision) -> None:
        if os.getenv("PYTEST_CURRENT_TEST"):
            return
        payload = {
            **asdict(decision),
            "symbol": MODEL_16_SYMBOL,
            "timeframe": MODEL_16_TIMEFRAME,
            "operational_model": MT5_OPERATIONAL_MODEL_16,
            "captured_at": datetime.now(timezone.utc).isoformat(),
        }
        signature_payload = {
            key: value for key, value in payload.items() if key != "captured_at"
        ...
        if signature == self.model16_runtime_state_signature:
            return
        if not self.model16_runtime_state_signature:
            previous = self.get_model16_runtime_state()
            previous.pop("captured_at", None)
            if previous == signature_payload:
                object.__setattr__(self, "model16_runtime_state_signature", signature)
                return
        target = _MODEL16_RUNTIME_STATE_PATH
        temporary = target.with_name(
            f"{target.name}.{os.getpid()}.{threading.get_ident()}.tmp"
        )
        try:
    ...
    def _mt5_model16_xau_m5_plan(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        """Materializa o M16 por preco/EMA20 sem TP fixo ou Lab pesado."""
        pair = str(row.pair or "").upper()
        if pair != MODEL_16_SYMBOL:
            reason = f"M16 opera exclusivamente {MODEL_16_SYMBOL}."
            return (
                replace(
                    row,
                    decision="WAIT",
        ...
        decision = self.get_model16_entry_decision()
        parameters = model16_stop_management_parameters()
        diagnostics = (
            f"PRICE={decision.current_price if decision.current_price is not None else 'N/D'}",
            f"EMA20={decision.ema20 if decision.ema20 is not None else 'N/D'}",
            f"PREVIOUS_HIGH={decision.previous_high or 'N/D'}",
            f"PREVIOUS_LOW={decision.previous_low or 'N/D'}",
            f"CURRENT_HIGH={decision.current_high or 'N/D'}",
        ...
        if not decision.ready:
            wait_plan = replace(
                ...
                risk_reward=0.0,
                status=decision.status,
                source="MODEL_16_MANUAL_RULE",
                reason=decision.reason,
                invalid_reason=decision.status,
                invalid_fields=("entry_trigger",),
                stop_management=MODEL_16_STOP_MANAGEMENT,
                stop_management_parameters=parameters,
                alpha_id=MODEL_16_ALPHA_ID,
                alpha_version=MODEL_16_ALPHA_VERSION,
            ...
            return (
                replace(
                    row,
                    timeframe=MODEL_16_TIMEFRAME,
                    lab_timeframe=MODEL_16_TIMEFRAME,
                    last_candle_time=decision.current_candle_time,
                    decision="WAIT",
                    theoretical_entry_direction="WAIT",
                    theoretical_entry_status=decision.status,
                    ...
                    theoretical_entry_price=decision.entry_price,
                    theoretical_entry_reason=decision.reason,
                    active_model="M16_XAU_M5_PRICE_EMA20_BREAKOUT",
                    active_model_indicators=diagnostics,
                    reason=decision.reason,
                    short_average=decision.current_price,
                    long_average=decision.ema20,
                    swing_high=decision.previous_high,
                    swing_low=decision.previous_low,
                    lab_alpha_id=MODEL_16_ALPHA_ID,
                    lab_alpha_version=MODEL_16_ALPHA_VERSION,
                    beta_id=MODEL_16_BETA_ID,
                    beta_version=MODEL_16_BETA_VERSION,
                    beta_mode="TRAILING_ONLY",
                    beta_reason="SL acompanha o extremo exato do candle M5 anterior.",
                    lab_parameters=parameters,
                    lab_configuration_source="MODEL_16_MANUAL_RULE",
                    entry_filter_status="AGUARDANDO",
                    entry_filter_parameter="M16_PRICE_EMA20_BREAKOUT_PREVIOUS_CANDLE",
                    entry_filter_reading=decision.status,
                    entry_filter_reason=decision.reason,
                    research_plan_status=decision.status,
                    research_plan_source="MODEL_16_MANUAL_RULE",
                    research_plan_entry_price=decision.entry_price,
                    research_plan_stop=decision.initial_stop,
                    research_plan_target=None,
                    research_plan_risk_reward=0.0,
                    research_plan_stop_management=MODEL_16_STOP_MANAGEMENT,
                    research_plan_stop_management_parameters=parameters,
                    research_plan_reason=decision.reason,
                    research_plan_diagnostics=diagnostics,
                ),
        ...
        plan = MT5ResearchTradePlan(
            ...
            risk_reward=0.0,
            stop_multiplier=0.0,
            exit_model=MODEL_16_BETA_VERSION,
            exit_score=0.0,
            exit_candidates=1,
            status="PLANO_VALIDO",
            risk_pips=risk,
            ...
            reward_percent=0.0,
            stop_reason="Extremo oposto exato do candle M5 anterior.",
            target_reason="M16 nao usa TP fixo; saida exclusivamente pelo SL movel.",
            stop_management=MODEL_16_STOP_MANAGEMENT,
            stop_management_parameters=parameters,
            stop_management_reason=(
                "A cada candle M5 fechado, usar seu extremo e mover o SL "
                "somente quando ficar mais protetivo."
            ),
            alpha_id=MODEL_16_ALPHA_ID,
            alpha_version=MODEL_16_ALPHA_VERSION,
            beta_id=MODEL_16_BETA_ID,
        ...
        return (
            replace(
                ...
                research_plan_stop_reason=plan.stop_reason,
                research_plan_target_reason=plan.target_reason,
                research_plan_exit_model=MODEL_16_BETA_VERSION,
                research_plan_stop_management=MODEL_16_STOP_MANAGEMENT,
                research_plan_stop_management_parameters=parameters,
                research_plan_stop_management_reason=plan.stop_management_reason,
                dynamic_exit_policy=MODEL_16_STOP_MANAGEMENT,
                dynamic_exit_action="HOLD_POSITION",
                dynamic_exit_reason="Aguardar novo candle M5 fechado para atualizar SL.",
                dynamic_exit_confidence=1.0,
                dynamic_exit_candidate_stop=None,
                ...
                dynamic_exit_source="M16_PREVIOUS_CANDLE_TRAILING",
                research_plan_reason=reason,
                research_plan_rr_current=0.0,
                research_plan_rr_minimum=0.0,
                research_plan_diagnostics=diagnostics,
    ...
    def _mt5_dynamic_exit_variant_from_source(
        self,
        ...
        *,
        ...
        """Copy one entry plan and change only its post-entry exit contract."""
        spec = dynamic_exit_model_spec(operational_model)
        if spec is None:
            return source_row, source_plan
        parameters = dynamic_exit_parameters(
            dict(source_plan.stop_management_parameters or {})
        )
        parameters.update(
            {
                "dynamic_exit_source_model": spec.source_model_id,
                "dynamic_exit_source_number": spec.source_number,
            }
        )
        reason = (
            f"{spec.short_name} preserva integralmente a entrada, o SL inicial e "
            f"o TP do {spec.source_short_name}; apos a abertura, o Position "
            "Manager pode somente manter ou tornar o SL mais protetivo."
        )
        diagnostics = tuple(source_plan.diagnostics) + (
            f"DYNAMIC_EXIT_SOURCE={spec.source_short_name}",
        ...
        transformed_plan = replace(
            source_plan,
            exit_model=spec.beta_version,
            stop_management=DYNAMIC_EXIT_POLICY,
            stop_management_parameters=parameters,
            stop_management_reason=reason,
            beta_id=spec.beta_id,
            beta_version=spec.beta_version,
            beta_mode=DYNAMIC_EXIT_BETA_MODE,
            beta_reason=reason,
            diagnostics=diagnostics,
        )
        transformed_row = replace(
            source_row,
            active_model=(
                f"{spec.short_name}_DYNAMIC_FROM_{spec.source_short_name} | "
                f"{source_row.active_model}"
            ),
            active_model_indicators=tuple(source_row.active_model_indicators)
            + (
                f"ENTRY_SOURCE={spec.source_short_name}",
                "EXIT=DYNAMIC_PROTECT_ONLY",
            ),
            beta_id=spec.beta_id,
            beta_version=spec.beta_version,
            beta_mode=DYNAMIC_EXIT_BETA_MODE,
            beta_reason=reason,
            research_plan_exit_model=spec.beta_version,
            research_plan_stop_management=DYNAMIC_EXIT_POLICY,
            research_plan_stop_management_parameters=parameters,
            research_plan_stop_management_reason=reason,
            dynamic_exit_policy=DYNAMIC_EXIT_POLICY,
            dynamic_exit_action="HOLD_POSITION",
            dynamic_exit_reason=(
                "Aguardar 1.50R; depois permitir break-even ou ATR trailing "
                "somente quando o novo SL for mais protetivo."
            ),
    ...
    def _mt5_scoped_m1_plan(
        ...
        *,
        ...
        """Reuse the M1 Lab plan while keeping market groups isolated."""
        pair = str(row.pair or "").upper()
        if pair not in set(allowed_pairs):
            reason = f"{pair} nao pertence ao escopo {scope_label}."
            return (
                replace(
                    row,
                    decision="WAIT",
        ...
        return (
            replace(
                row,
                active_model=f"{scope_label} | {row.active_model}",
                active_model_indicators=tuple(row.active_model_indicators)
                + (f"MODEL_SCOPE={scope_label}",),
                lab_configuration_source=(
                    f"{scope_label} | {row.lab_configuration_source}"
                ),
            ),
            plan,
        )
    ...
    def _mt5_lab_operational_plan(
        ...
        *,
        ...
        """Materializa no MT5 o vencedor pesquisado, sem reinterpretar a Alpha."""
        winner = self.lab_operational_model_service.winner(model_id, row.pair)
        if winner is None:
            return self._mt5_lab_operational_wait(
                row,
                fallback_plan,
                model_id=model_id,
                status="PAIR_NOT_IN_LAB_MODEL",
                reason="Par ausente do modelo operacional pesquisado no Lab.",
            )
        if (
            not bool(winner.get("demo_forward_enabled", False))
            and not allow_demo_forward_override
        ):
            return self._mt5_lab_operational_wait(
                row,
                fallback_plan,
                ...
                reason=str(
                    winner.get("parity_reason")
                    or "Plano bloqueado pela paridade executavel do Lab."
                ),
                winner=winner,
            )
        source_model = str(winner.get("source_model") or "").upper().replace("-P", "")
        if model_id == MT5_OPERATIONAL_MODEL_5 and source_model == "M1":
            return self._mt5_lab_operational_m1_delegate(row, fallback_plan, winner)
        ...
        decision = self.lab_operational_model_service.evaluate(
            ...
            market_row=row,
            demo_forward_override=allow_demo_forward_override,
        )
        ...
        if not decision.ready:
            return self._mt5_lab_operational_wait(
                ...
                signal_candle=decision.signal_candle_time,
            )
        ...
        risk = abs(entry - stop)
        reward = abs(target - entry)
        parameters = self._mt5_lab_operational_parameters(
            model_id,
            winner,
            signal_candle=decision.signal_candle_time,
        )
        model_label = self.lab_operational_model_service.model_label(model_id)
        ...
        transformed_plan = MT5ResearchTradePlan(
            ...
            stop_multiplier=float(
                decision.parameters.get("stop_factor", 0.0) or 0.0
            ),
            exit_model=beta_version,
            exit_score=float(holdout.get("profit_factor", 0.0) or 0.0),
            exit_candidates=1,
            status="PLANO_VALIDO",
            risk_pips=risk,
            reward_pips=reward,
            ...
            stop_management_parameters=parameters,
            stop_management_reason=(
                "Position Manager apenas audita este contrato; nao move SL e nao "
                "encerra antes do SL/TP pesquisado."
            ),
            alpha_id=decision.alpha_id,
            alpha_version="LAB_OPERATIONAL_MANIFEST_V2",
            beta_id=beta_id,
            beta_version=beta_version,
            ...
            rr_minimum=float(decision.risk_reward),
            diagnostics=tuple(decision.diagnostics),
            certification_score=100.0,
            certification_grade="PARITY_DEMO",
            certification_status=str(
                winner.get("parity_status") or "DEMO_PARITY_APPROVED"
            ),
            certification_usage="Modelo do Lab liberado exclusivamente para MT5 Demo.",
            certification_demo_allowed=True,
        )
        historical_confirmation = float(holdout.get("win_rate", 0.0) or 0.0)
        transformed_row = replace(
            row,
            timeframe=decision.timeframe,
            lab_timeframe=decision.timeframe,
            last_candle_time=decision.current_bar_time,
            decision=decision.direction,
            theoretical_entry_direction=decision.direction,
            theoretical_entry_status="SINAL_TEORICO",
            theoretical_entry_candle=decision.signal_candle_time,
            theoretical_entry_price=entry,
            theoretical_entry_reason=decision.reason,
            active_model=(
                f"{model_label}_{decision.source_model}_{decision.family}_"
                f"{decision.alpha_id}"
            ),
            active_model_score=transformed_plan.exit_score,
            active_model_indicators=tuple(decision.diagnostics),
            reason=decision.reason,
            atr=decision.atr,
            lab_alpha_id=decision.alpha_id,
            lab_alpha_version="LAB_OPERATIONAL_MANIFEST_V2",
            beta_id=beta_id,
            beta_version=beta_version,
            beta_mode="FIXED_SL_TP",
            beta_reason=transformed_plan.beta_reason,
            lab_parameters=parameters,
            lab_configuration_source="RESEARCH_LAB_OPERATIONAL_MANIFEST",
            lab_confidence=historical_confirmation,
            lab_ict_score=100.0,
            lab_ict_grade="PARITY_DEMO",
            lab_ict_status=transformed_plan.certification_status,
            lab_ict_usage=transformed_plan.certification_usage,
            lab_ict_demo_allowed=True,
            lab_ict_rejection_reasons=(),
            entry_filter_status="OK",
            entry_filter_parameter="LAB_CANONICAL_CLOSED_CANDLE_SIGNAL",
            entry_filter_reading=decision.status,
            entry_filter_reason=(
                "Sessao, regime e indicadores ja foram avaliados pela Alpha canonica."
            ),
            research_plan_status="PLANO_VALIDO",
            research_plan_source="RESEARCH_LAB",
            research_plan_entry_price=entry,
            research_plan_stop=stop,
            research_plan_target=target,
            research_plan_risk_reward=float(decision.risk_reward),
            research_plan_stop_multiplier=transformed_plan.stop_multiplier,
            research_plan_exit_model=beta_version,
            research_plan_exit_score=transformed_plan.exit_score,
            research_plan_exit_candidates=1,
            research_plan_risk_pips=risk,
            research_plan_reward_pips=reward,
            research_plan_risk_percent=transformed_plan.risk_percent,
            research_plan_reward_percent=transformed_plan.reward_percent,
            research_plan_stop_reason=transformed_plan.stop_reason,
            research_plan_target_reason=transformed_plan.target_reason,
            research_plan_stop_management=LAB_FIXED_EXIT_POLICY,
            research_plan_stop_management_parameters=parameters,
            research_plan_stop_management_reason=(
                transformed_plan.stop_management_reason
            ),
            dynamic_exit_policy=LAB_FIXED_EXIT_POLICY,
            dynamic_exit_action="KEEP_ORIGINAL_PLAN",
            dynamic_exit_reason="Aguardar SL ou TP fixos do replay pesquisado.",
            dynamic_exit_confidence=1.0,
            dynamic_exit_candidate_stop=None,
            dynamic_exit_allowed_to_execute_demo=False,
            dynamic_exit_source="LAB_FIXED_EXIT_CONTRACT",
            research_plan_reason=decision.reason,
            research_plan_rr_current=float(decision.risk_reward),
            research_plan_rr_minimum=float(decision.risk_reward),
            research_plan_diagnostics=tuple(decision.diagnostics),
        )
        return transformed_row, transformed_plan

    def _mt5_lab_operational_m1_delegate(
        self,
        row: DashboardMT5ForexSignalRowViewModel,
        fallback_plan: MT5ResearchTradePlan,
        winner: dict[str, Any],
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        expected_alpha = str(winner.get("alpha_id") or "").upper()
        expected_timeframe = str(winner.get("timeframe") or "H1").upper()
        if (
            str(row.lab_alpha_id or "").upper() != expected_alpha
            or str(row.timeframe or "").upper() != expected_timeframe
            or str(row.decision or "").upper() not in {"BUY", "SELL"}
            or fallback_plan.status != "PLANO_VALIDO"
            or fallback_plan.entry_price is None
            or fallback_plan.stop is None
            or fallback_plan.target is None
        ):
            return self._mt5_lab_operational_wait(
                row,
                fallback_plan,
                model_id=MT5_OPERATIONAL_MODEL_5,
                status="M1_DELEGATE_NOT_READY",
                reason=(
                    f"M5 aguarda o plano M1 {expected_alpha}/{expected_timeframe} "
                    "valido no candle atual."
                ),
                winner=winner,
            )
        parameters = self._mt5_lab_operational_parameters(
            MT5_OPERATIONAL_MODEL_5,
            winner,
            signal_candle=row.theoretical_entry_candle,
        )
        beta_id = "BETA_LAB_M5_FIXED"
        beta_version = f"{beta_id}_V1"
        transformed_plan = replace(
            fallback_plan,
            stop_management=LAB_FIXED_EXIT_POLICY,
            stop_management_parameters=parameters,
            stop_management_reason=(
                "M5 delegou ao vencedor M1; Position Manager apenas audita e "
                "preserva SL/TP originais."
            ),
            exit_model=beta_version,
            beta_id=beta_id,
            beta_version=beta_version,
            beta_mode="FIXED_SL_TP",
            beta_reason="M5 preserva a entrada e a saida fixa do vencedor M1.",
            source="RESEARCH_LAB",
            diagnostics=tuple(fallback_plan.diagnostics)
            + ("M5_SOURCE_MODEL=M1", f"FIXED_EXIT_POLICY={LAB_FIXED_EXIT_POLICY}"),
            certification_demo_allowed=True,
            certification_status="DELEGATE_TO_LAB_M1",
            certification_usage="M5/M1 liberado exclusivamente para MT5 Demo.",
        )
        reason = (
            f"M5 usa o vencedor M1 {expected_alpha}/{expected_timeframe}; "
            "Trade Plan e SL/TP foram preservados."
        )
        return (
            replace(
                row,
                active_model=f"M5_M1_{expected_alpha} | {row.active_model}",
                reason=reason,
                theoretical_entry_reason=reason,
                beta_id=beta_id,
                beta_version=beta_version,
                ...
                lab_ict_demo_allowed=True,
                entry_filter_status="OK",
                entry_filter_parameter="M5_DELEGATE_TO_LAB_M1",
                entry_filter_reading="APPROVED",
                entry_filter_reason="M5 usa o gatilho canonico do vencedor M1.",
                research_plan_exit_model=beta_version,
                research_plan_stop_management=LAB_FIXED_EXIT_POLICY,
                research_plan_stop_management_parameters=parameters,
                research_plan_stop_management_reason=(
                ...
                dynamic_exit_policy=LAB_FIXED_EXIT_POLICY,
                dynamic_exit_action="KEEP_ORIGINAL_PLAN",
                dynamic_exit_reason="M5/M1: aguardar SL ou TP fixos.",
                dynamic_exit_candidate_stop=None,
                dynamic_exit_allowed_to_execute_demo=False,
                dynamic_exit_source="LAB_FIXED_EXIT_CONTRACT",
                research_plan_reason=reason,
    ...
    def _mt5_lab_operational_wait(
        ...
        *,
        ...
        signal_candle: object = "N/D",
    ) -> tuple[DashboardMT5ForexSignalRowViewModel, MT5ResearchTradePlan]:
        values = winner or {}
        timeframe = str(values.get("timeframe") or row.timeframe or "M1").upper()
        alpha_id = str(values.get("alpha_id") or row.lab_alpha_id or "N/D")
        parameters = self._mt5_lab_operational_parameters(
            model_id,
            values,
        ...
        transformed_row = replace(
            ...
            theoretical_entry_reason=reason,
            theoretical_entry_price=None,
            active_model=f"{model_label}_{status}_{alpha_id}",
            reason=reason,
            ...
            lab_configuration_source="RESEARCH_LAB_OPERATIONAL_MANIFEST",
            entry_filter_status=(
                "OK" if bool(values.get("demo_forward_enabled", False)) else "BLOQUEADO"
            ),
            entry_filter_parameter="LAB_EXECUTABLE_PARITY_AND_SIGNAL",
            entry_filter_reading=status,
            entry_filter_reason=reason,
            research_plan_status=status,
            research_plan_reason=reason,
            research_plan_diagnostics=tuple(diagnostics) + (f"LAB_STATUS={status}",),
        )
        return transformed_row, fallback_plan

    def _mt5_lab_operational_parameters(
        self,
        model_id: str,
        winner: dict[str, Any],
        *,
        ...
        parameters = {
            str(key): str(value)
            for key, value in dict(winner.get("parameters") or {}).items()
        }
        parameters.update(
            {
                "alpha": str(winner.get("alpha_id") or parameters.get("alpha") or "N/D"),
                "alpha_version": "LAB_OPERATIONAL_MANIFEST_V2",
                "source_model": str(winner.get("source_model") or model_label),
                "timeframe": str(winner.get("timeframe") or "N/D"),
                "stop_management": LAB_FIXED_EXIT_POLICY,
                "beta_id": f"BETA_LAB_{model_label}_FIXED",
                "beta_version": f"BETA_LAB_{model_label}_FIXED_V1",
                "beta_mode": "FIXED_SL_TP",
                "entry_contract": str(
                    winner.get("entry_contract")
                    or "CLOSED_CANDLE_SIGNAL_NEXT_LIVE_PRICE"
                ),
                "parity_status": str(winner.get("parity_status") or "N/D"),
                "signal_candle": str(signal_candle or "N/D"),
                "position_manager": "AUDIT_ONLY_NO_SL_MOVE_NO_FULL_EXIT",
            }
        )
        return parameters
    ...
    def _mt5_model6_original_decision(
        self,
        pair: str,
        *,
        ...
        """Reproduz o Trend Momentum original no ultimo candle M1 fechado."""
        normalized_pair = str(pair or "").upper()
        candle_cache = candles_by_market
        if candle_cache is None:
            value = getattr(self.mt5_market_data_service, "latest_forex_candles", {})
            candle_cache = value if isinstance(value, dict) else {}
        candles = list(
            (candle_cache or {}).get((normalized_pair, MODEL_6_TIMEFRAME), []) or []
        )
        minimum_candles = original_trend_momentum_configuration().slow_ma_period + 2
        if len(candles) < minimum_candles:
            return LabOperationalDecision(
                model_id=MT5_OPERATIONAL_MODEL_6,
                pair=normalized_pair,
                timeframe=MODEL_6_TIMEFRAME,
                status="INSUFFICIENT_LIVE_CANDLES",
                ready=False,
                reason=(
                    f"M6 original exige ao menos {minimum_candles} candles M1; "
                    f"recebeu {len(candles)}. O cache solicita {MODEL_6_CANDLES}."
                ),
                alpha_id=MODEL_6_ALPHA_ID,
                family="TREND_MOMENTUM",
                source_model="M6_ORIGINAL_MARCO_ZERO",
                parameters=original_trend_momentum_parameters(),
                diagnostics=(f"CANDLES_RECEIVED={len(candles)}",),
                parity_status="DEMO_BASELINE_APPROVED",
            )

        closed_candles = candles[:-1]
        signal_candle_time = str(getattr(closed_candles[-1], "data", "N/D"))
        current_bar_time = str(getattr(candles[-1], "data", "N/D"))
        analysis = self.mt5_market_data_service._analyze_pair(
            normalized_pair,
            closed_candles,
            original_trend_momentum_configuration(),
            microstructure={},
            timeframe=MODEL_6_TIMEFRAME,
            configured_candles=MODEL_6_CANDLES,
            requested_candles=MODEL_6_CANDLES,
            last_update=current_bar_time,
            recalculate_research=False,
        )
        parameters: dict[str, Any] = {
            **original_trend_momentum_parameters(),
            "trend": str(getattr(analysis, "trend", "INDEFINIDA")),
            "momentum": getattr(analysis, "momentum", None),
            "volatility": getattr(analysis, "volatility", None),
            "rsi": getattr(analysis, "rsi", None),
            "short_average": getattr(analysis, "short_average", None),
            "long_average": getattr(analysis, "long_average", None),
            "mid_average": getattr(analysis, "mid_average", None),
            "ema_fast": getattr(analysis, "ema_fast", None),
            "ema_mid": getattr(analysis, "ema_mid", None),
            "ema_slow": getattr(analysis, "ema_slow", None),
            "atr": getattr(analysis, "atr", None),
            "support": getattr(analysis, "support", None),
            "resistance": getattr(analysis, "resistance", None),
            "swing_high": getattr(analysis, "swing_high", None),
            "swing_low": getattr(analysis, "swing_low", None),
        }
        diagnostics = (
            f"TREND={parameters['trend']}",
            f"MA20={float(parameters['short_average'] or 0.0):.8f}",
            f"MA50={float(parameters['long_average'] or 0.0):.8f}",
            f"MOMENTUM10={float(parameters['momentum'] or 0.0):.8f}",
            f"VOLATILITY20={float(parameters['volatility'] or 0.0):.8f}",
            f"RSI14={float(parameters['rsi'] or 0.0):.4f}",
            f"ATR20={float(parameters['atr'] or 0.0):.8f}",
            f"VOLATILITY_MIN={original_trend_momentum_configuration().volatility_low_threshold:.8f}",
            f"CANDLES_RECEIVED={len(candles)}",
        )
        direction = str(getattr(analysis, "decision", "WAIT") or "WAIT").upper()
        entry = self._optional_float(current_price)
        if entry is None or entry <= 0:
            entry = self._optional_float(getattr(candles[-1], "fechamento", None))
        atr = self._optional_float(getattr(analysis, "atr", None))
        if direction not in {"BUY", "SELL"}:
            return LabOperationalDecision(
                model_id=MT5_OPERATIONAL_MODEL_6,
                pair=normalized_pair,
                timeframe=MODEL_6_TIMEFRAME,
                status="NO_CLOSED_CANDLE_SIGNAL",
                ready=False,
                direction="WAIT",
                signal_candle_time=signal_candle_time,
                current_bar_time=current_bar_time,
                risk_reward=MODEL_6_RISK_REWARD,
                atr=atr,
                alpha_id=MODEL_6_ALPHA_ID,
                family="TREND_MOMENTUM",
                source_model="M6_ORIGINAL_MARCO_ZERO",
                reason=str(getattr(analysis, "reason", "Sem sinal M6 no candle fechado.")),
        ...
        if entry is None or atr is None or atr <= 0:
            return LabOperationalDecision(
                ...
                pair=normalized_pair,
                timeframe=MODEL_6_TIMEFRAME,
                status="ENTRY_OR_RISK_INPUT_UNAVAILABLE",
                ready=False,
                direction="WAIT",
                signal_candle_time=signal_candle_time,
                current_bar_time=current_bar_time,
                ...
                family="TREND_MOMENTUM",
                source_model="M6_ORIGINAL_MARCO_ZERO",
                reason="M6 sem preco vivo ou ATR20 para materializar o risco.",
                parameters=parameters,
                diagnostics=diagnostics,
                parity_status="DEMO_BASELINE_APPROVED",
            )
        minimum_distance = abs(entry) * MODEL_6_MINIMUM_DISTANCE_PERCENT
        distance = max(atr * MODEL_6_ATR_STOP_FACTOR, minimum_distance)
        multiplier = 1.0 if direction == "BUY" else -1.0
        stop = entry - multiplier * distance
        target = entry + multiplier * distance * MODEL_6_RISK_REWARD
        return LabOperationalDecision(
            model_id=MT5_OPERATIONAL_MODEL_6,
            pair=normalized_pair,
            timeframe=MODEL_6_TIMEFRAME,
            ...
            source_model="M6_ORIGINAL_MARCO_ZERO",
            reason=(
                f"M6 original confirmou {direction} no candle M1 fechado: "
                "media 20/50, momentum 10, volatilidade 20 e RSI14 alinhados."
            ),
            parameters=parameters,
            diagnostics=diagnostics,
            parity_status="DEMO_BASELINE_APPROVED",
    ...
    def _mt5_model6_original_plan(
        ...
        *,
        ...
        plan = self._mt5_research_trade_plan_for_data(
            ...
            timeframe=MODEL_6_TIMEFRAME,
            decision=decision.direction,
            active_model="M6_TREND_MOMENTUM_ORIGINAL",
            entry_status="SINAL_TEORICO" if decision.ready else "SEM_GATILHO",
            ...
            certification_demo_allowed=True,
            certification_score=100.0,
            certification_grade="BASELINE_M6",
            certification_status="DEMO_BASELINE_APPROVED",
            certification_usage="M6 original liberado exclusivamente para MT5 Demo.",
            alpha_id=MODEL_6_ALPHA_ID,
        ...
        plan = replace(
            ...
            stop_management_parameters=parameters,
            stop_management_reason=(
                "M6 original aguarda o primeiro toque no SL inicial ou no TP RR2; "
                "o Position Manager nao move SL e nao fecha a posicao."
            ),
            exit_model=MODEL_6_BETA_VERSION,
            beta_id=MODEL_6_BETA_ID,
            beta_version=MODEL_6_BETA_VERSION,
            beta_mode="FIXED_SL_TP",
            beta_reason="Saida fixa original por SL ou TP RR2.",
            source="M6_ORIGINAL_MARCO_ZERO",
            diagnostics=tuple(plan.diagnostics)
            + ("M6_EXIT_CONTRACT=FIXED_SL_TP_RR2",),
        )
        values = decision.parameters
        transformed_row = replace(
            row,
            timeframe=MODEL_6_TIMEFRAME,
            lab_timeframe=MODEL_6_TIMEFRAME,
            last_candle_time=decision.current_bar_time,
            trend=str(values.get("trend") or "INDEFINIDA"),
            momentum=self._optional_float(values.get("momentum")),
            volatility=self._optional_float(values.get("volatility")),
            rsi=self._optional_float(values.get("rsi")),
            short_average=self._optional_float(values.get("short_average")),
            long_average=self._optional_float(values.get("long_average")),
            mid_average=self._optional_float(values.get("mid_average")),
            ema_fast=self._optional_float(values.get("ema_fast")),
            ema_mid=self._optional_float(values.get("ema_mid")),
            ema_slow=self._optional_float(values.get("ema_slow")),
            atr=self._optional_float(values.get("atr")),
            support=self._optional_float(values.get("support")),
            resistance=self._optional_float(values.get("resistance")),
            swing_high=self._optional_float(values.get("swing_high")),
            swing_low=self._optional_float(values.get("swing_low")),
            active_model="M6_TREND_MOMENTUM_ORIGINAL",
            active_model_score=MODEL_6_CONFIDENCE if decision.ready else 0.0,
            active_model_indicators=decision.diagnostics,
            lab_alpha_id=MODEL_6_ALPHA_ID,
            lab_alpha_version=MODEL_6_ALPHA_VERSION,
            beta_id=MODEL_6_BETA_ID,
            beta_version=MODEL_6_BETA_VERSION,
            beta_mode="FIXED_SL_TP",
            beta_reason=(
                "M6 original encerra somente no SL inicial ou no TP RR2."
            ),
            lab_parameters=parameters,
            lab_configuration_source="HISTORICAL_BASELINE_A3BC912",
            decision=decision.direction if decision.ready else "WAIT",
            confidence=MODEL_6_CONFIDENCE if decision.ready else 0.0,
            lab_confidence=MODEL_6_CONFIDENCE,
            lab_ict_score=100.0,
            lab_ict_grade="BASELINE_M6",
            lab_ict_status="DEMO_BASELINE_APPROVED",
            lab_ict_usage="M6 original liberado exclusivamente para MT5 Demo.",
            lab_ict_demo_allowed=True,
            lab_ict_rejection_reasons=(),
            reason=decision.reason,
            theoretical_entry_status=(
                "SINAL_TEORICO" if decision.ready else "SEM_GATILHO"
            ),
            theoretical_entry_candle=decision.signal_candle_time,
            theoretical_entry_price=decision.entry_price,
            theoretical_entry_direction=(
                decision.direction if decision.ready else "WAIT"
            ),
            theoretical_entry_reason=decision.reason,
            entry_filter_status="OK",
            entry_filter_parameter="M6_CONFIGURACAO_ORIGINAL_SEM_FILTRO_NV_V",
            entry_filter_reading=decision.status,
            entry_filter_reason=(
                "O M6 usa somente tendencia, momentum, volatilidade e RSI do "
                "contrato original."
            ),
            research_plan_status=plan.status,
            research_plan_source=plan.source,
            research_plan_entry_price=plan.entry_price,
            research_plan_stop=plan.stop,
            research_plan_target=plan.target,
            research_plan_risk_reward=plan.risk_reward,
            research_plan_stop_multiplier=plan.stop_multiplier,
            research_plan_exit_model=plan.exit_model,
            research_plan_exit_score=plan.exit_score,
            research_plan_exit_candidates=plan.exit_candidates,
            research_plan_risk_pips=plan.risk_pips,
            research_plan_reward_pips=plan.reward_pips,
            research_plan_risk_percent=plan.risk_percent,
            research_plan_reward_percent=plan.reward_percent,
            research_plan_stop_reason=plan.stop_reason,
            research_plan_target_reason=plan.target_reason,
            ...
            research_plan_stop_management_reason=plan.stop_management_reason,
            dynamic_exit_policy=MODEL_6_EXIT_POLICY,
            dynamic_exit_action="KEEP_ORIGINAL_PLAN",
            dynamic_exit_reason=(
                "M6 aguarda o SL inicial ou o TP RR2, sem gestao dinamica."
            ),
            dynamic_exit_confidence=1.0,
            dynamic_exit_candidate_stop=None,
            dynamic_exit_allowed_to_execute_demo=False,
            dynamic_exit_source="M6_FIXED_SL_TP_RR2",
            research_plan_reason=plan.reason,
            research_plan_invalid_reason=plan.invalid_reason,
            research_plan_invalid_fields=plan.invalid_fields,
            research_plan_next_retry=plan.next_retry,
    ...
    def _mt5_model4_inverse_m1_plan(
        ...
        reason = (
            ...
            "O stop original do M1 vira alvo; o M4 recebe stop proprio RR1."
        )
        transformed_row = replace(
            row,
    ...
    def _mt5_model4_inverse_plan(
        ...
        diagnostics = tuple(plan.diagnostics) + (
            ...
            f"MODELO4_RR_M1_ORIGINAL={float(plan.risk_reward or 0.0):.4f}",
            "MODELO4_TARGET_STOP_ORIGINAL_M1",
            "MODELO4_STOP_PROPRIO_RR1",
        )
        return replace(
            plan,
            ...
            stop_reason="Modelo 4: stop proprio RR1, oposto ao alvo espelhado.",
            ...
            stop_management_parameters={
                ...
                "stop_modelo4": "DISTANCIA_RR1_PROPRIA",
                "rr_m1_original": f"{float(plan.risk_reward or 0.0):.4f}",
                "rr": "1.0000",
            },
            stop_management_reason=(
                "Modelo 4 adapta somente sua propria perna: inverte a direcao, "
                "usa o stop do M1 como alvo e aplica RR1 proprio."
            ),
            beta_id="BETA004",
            ...
            reason=(
                ...
                "inverte direcao, usa o stop original como alvo e cria stop "
                "proprio RR1 sem alterar o M1."
            ),
            rr_current=1.0,
            rr_minimum=1.0,
            diagnostics=diagnostics,
    ...
    def _demo_robot_rejection_tree(
        ...
        *,
        ...
        entry_filter_ok = str(row.entry_filter_status).upper() == "OK"
        add(
            "Filtro entrada NV-V",
            entry_filter_ok,
            (
                "Filtro robusto ausente ou aprovado."
                if entry_filter_ok
                else row.entry_filter_status
            ),
            f"{row.entry_filter_parameter} | {row.entry_filter_reason}",
        )
        if result_status:
            add(
    ...
    def _to_view_model_mt5_forex_signal_row(
        ...
        entry_filter = self._entry_filter_for_view_row(
            analysis_row,
            active_research_row,
            theoretical_entry,
        )
        ...
        beta_id = research_plan.beta_id
        beta_version = research_plan.beta_version
        beta_mode = research_plan.beta_mode
        ...
        return DashboardMT5ForexSignalRowViewModel(
            ...
            entry_filter_status=str(entry_filter["status"]),
            entry_filter_parameter=str(entry_filter["parameter"]),
            entry_filter_reading=str(entry_filter["reading"]),
            entry_filter_reason=str(entry_filter["reason"]),
    ...
    def _entry_filter_for_view_row(
        self,
        row: object,
        active_research_row: object | None,
        theoretical_entry: dict[str, object],
    ) -> dict[str, str]:
        """Gate operacional: usa somente filtros NV-V robustos e avaliaveis online."""
        rules = self._entry_filter_rules_from_research_row(active_research_row)
        if not rules:
            return {
                "status": "OK",
                ...
                "reading": "N/D",
                "reason": (
                    "Sem filtro NV-V robusto aplicado "
                    f"(min {ENTRY_FILTER_MIN_NV_MINUS_V:.0%}, "
                    f"amostra {ENTRY_FILTER_MIN_SAMPLE_SIZE})."
                ),
            }
        if str(theoretical_entry.get("direction", "WAIT") or "WAIT").upper() not in {
            "BUY",
            "SELL",
        }:
            return {
                "status": "OK",
                "parameter": self._entry_filter_parameter_text(rules),
                "reading": "N/D",
                "reason": "Sem direcao executavel; filtro aguardando BUY/SELL.",
            }
        blocked: list[str] = []
        passed: list[str] = []
        for rule in rules:
            present = self._entry_filter_indicator_present(
                row,
                str(rule["indicator"]),
                str(theoretical_entry.get("direction", "WAIT") or "WAIT"),
            )
            label = self._entry_filter_rule_label(rule)
            if present is None:
                # Regra robusta sem leitura online confiavel nao deve ser aplicada.
                continue
            if present:
        ...
        if blocked:
            return {
                "status": "BLOQUEADO",
                "parameter": self._entry_filter_parameter_text(rules),
                "reading": " | ".join([*passed, *blocked]),
                "reason": "Filtro NV-V presente: " + " | ".join(blocked),
            }
        return {
            "status": "OK",
            "parameter": self._entry_filter_parameter_text(rules),
            "reading": " | ".join(passed) if passed else "SEM_LEITURA_APLICAVEL",
            "reason": "Filtros NV-V robustos ausentes na leitura atual.",
        }

    def _entry_filter_rules_from_research_row(
        self,
        active_research_row: object | None,
        ...
        if active_research_row is None:
            return []
        sample_size = int(
            getattr(active_research_row, "lab_confidence_sample_size", 0)
            or getattr(active_research_row, "sample_size", 0)
            or 0
        )
        if sample_size < ENTRY_FILTER_MIN_SAMPLE_SIZE:
            return []
        metrics = dict(getattr(active_research_row, "lab_discrimination_metrics", {}) or {})
        rules: list[dict[str, object]] = []
        for indicator, metric in metrics.items():
            if indicator not in ENTRY_FILTER_SUPPORTED_INDICATORS:
                continue
            ...
            try:
                ...
                continue
            edge = loser_rate - winner_rate
            if edge < ENTRY_FILTER_MIN_NV_MINUS_V:
                continue
            rules.append(
                {
        ...
        limit = self._entry_filter_rule_limit()
        if limit is None:
            return sorted_rules
        return sorted_rules[:limit]

    def _entry_filter_indicator_present(
        self,
        row: object,
        indicator: str,
        direction: str,
        ...
        if indicator == "ADX baixo":
            adx = self._optional_float(getattr(row, "adx", None))
            return None if adx is None else adx < ENTRY_FILTER_ADX_LOW_THRESHOLD
        if indicator == "ATR em queda":
            atr = self._optional_float(getattr(row, "atr", None))
            atr_average = self._optional_float(getattr(row, "atr_average", None))
            return None if atr is None or atr_average is None else atr < atr_average
        if indicator == "ATR subindo":
            atr = self._optional_float(getattr(row, "atr", None))
            atr_average = self._optional_float(getattr(row, "atr_average", None))
            return None if atr is None or atr_average is None else atr > atr_average
        if indicator == "Momentum contra":
            momentum = self._optional_float(getattr(row, "momentum", None))
            if momentum is None or normalized_direction not in {"BUY", "SELL"}:
                return None
            return momentum < 0.0 if normalized_direction == "BUY" else momentum > 0.0
        if indicator == "MACD hist divergente":
            macd = self._optional_float(getattr(row, "macd", None))
            macd_signal = self._optional_float(getattr(row, "macd_signal", None))
            if macd is None or macd_signal is None or normalized_direction not in {"BUY", "SELL"}:
                return None
            return macd < macd_signal if normalized_direction == "BUY" else macd > macd_signal
        return None

    def _entry_filter_parameter_text(self, rules: list[dict[str, object]]) -> str:
        if not rules:
            return "SEM_FILTRO_ROBUSTO"
        return " | ".join(
            f"{rule['indicator']} NV-V {float(rule['entry_edge']):+.0%}"
            for rule in rules
        )

    def _entry_filter_rule_label(self, rule: dict[str, object]) -> str:
        return (
            f"{rule['indicator']} V {float(rule['winner_rate']):.0%} x "
            f"NV {float(rule['loser_rate']):.0%} | "
            f"NV-V {float(rule['entry_edge']):+.0%}"
        )
    ...
    def _latest_mt5_forex_row_for_timeframe(
        ...
        *,
        ...
        if not allow_fetch_missing:
            return row
        if normalized_timeframe.upper() == str(
            getattr(row, "timeframe", "") or ""
        ).upper():
            return row
    ...
    def _mt5_research_trade_plan_for_data(
        ...
        *,
        ...
        beta_id = "BETA003"
        beta_version = "FIXED_STOP_MANAGER"
        beta_mode = "FIXED_SL_TP"
        beta_reason = (
            "M1 encerra pelo primeiro toque no SL ou TP definidos pelo Lab."
        )
        plan = self.mt5_research_trade_plan_engine.build_plan(
            MT5ResearchTradePlanInput(
                symbol=symbol,
                timeframe=timeframe,
                decision=decision,
        ...
        return replace(
            ...
            stop_management=LAB_FIXED_EXIT_POLICY,
            stop_management_reason=(
                "M1 preserva o SL inicial e o TP definidos pelo Lab; o Position "
                "Manager apenas audita e nao altera a posicao."
            ),
            beta_mode="FIXED_SL_TP",
            beta_reason=beta_reason,
            diagnostics=tuple(plan.diagnostics)
            + ("M1: SL/TP fixos; Position Manager somente auditoria.",),
        )

    def _mt5_beta_descriptor_from_parameters(
        self,
        parameters: dict[str, object] | None,
        *,
        beta_id: str = "BETA001",
        ...
        """Deriva a Beta operacional pela politica de saida vencedora do Lab."""
        values = parameters or {}
        resolved_beta_id = str(values.get("beta_id") or beta_id or "BETA001").upper()
        resolved_beta_version = str(values.get("beta_version") or beta_version or "BETA v1")
        resolved_beta_mode = str(values.get("beta_mode") or beta_mode or "PROTECT_ONLY")
        resolved_beta_reason = str(
            values.get("beta_reason")
            or beta_reason
            or "Position Manager administra a saida apos a entrada."
        )
        beta_number = self._mt5_beta_number(resolved_beta_id)
        if beta_number is not None and beta_number >= 3:
            return (
                resolved_beta_id,
                resolved_beta_version,
                resolved_beta_mode,
                resolved_beta_reason,
            )
        policy = str(values.get("stop_management", "") or "").upper()
        by_policy = {
            "FIXED_STOP": (
                "BETA003",
                "FIXED_STOP_MANAGER",
                "FIXED_STOP_ONLY",
                "Pesquisa de stop: manter stop inicial em R sem saida FULL.",
            ),
            "BREAK_EVEN": (
                "BETA004",
                "BREAK_EVEN_MANAGER",
                "BREAK_EVEN_ONLY",
                "Pesquisa de stop: proteger capital movendo stop para entrada sem saida FULL.",
            ),
            "ATR_TRAILING_STOP": (
                "BETA005",
                "ATR_TRAILING_STOP_MANAGER",
                "ATR_TRAILING_ONLY",
                "Pesquisa de stop: acompanhar preco com trailing por ATR sem saida FULL.",
            ),
            "CHANDELIER_EXIT": (
                "BETA006",
                "CHANDELIER_STOP_MANAGER",
                "CHANDELIER_ONLY",
                "Pesquisa de stop: seguir maxima/minima por Chandelier sem saida FULL.",
            ),
            "PARABOLIC_SAR": (
                "BETA007",
                "PARABOLIC_SAR_MANAGER",
                "PARABOLIC_SAR_ONLY",
                "Pesquisa de stop: seguir Parabolic SAR sem saida FULL.",
            ),
            "DONCHIAN_CHANNEL_STOP": (
                "BETA008",
                "DONCHIAN_STOP_MANAGER",
                "DONCHIAN_STOP_ONLY",
                "Pesquisa de stop: usar canal Donchian como protecao sem saida FULL.",
            ),
            "MOVING_AVERAGE_EXIT": (
                "BETA009",
                "MOVING_AVERAGE_STOP_MANAGER",
                "MA_STOP_ONLY",
                "Pesquisa de stop: acompanhar media movel sem saida FULL.",
            ),
            "TIME_STOP": (
                "BETA010",
                "TIME_STOP_MANAGER",
                "TIME_STOP_ONLY",
                "Pesquisa de stop: limitar tempo maximo de permanencia sem saida FULL.",
            ),
            "VOLATILITY_STOP": (
                "BETA011",
                "VOLATILITY_STOP_MANAGER",
                "VOLATILITY_STOP_ONLY",
                "Pesquisa de stop: adaptar protecao ao regime de volatilidade sem saida FULL.",
            ),
        }
        return by_policy.get(
            policy,
            (
                resolved_beta_id,
                resolved_beta_version,
    ...
    def _mt5_beta_number(self, beta_id: str) -> int | None:
    ...
    def _theoretical_entry_snapshot(
        ...
        ema_fast = self._ema_last(closes, fast_ma)
        ema_slow = self._ema_last(closes, slow_ma)
        ema_mid = self._ema_last(closes, max(fast_ma + 1, (fast_ma + slow_ma) // 2))
        historical_ema_values = {
            period: self._ema_last(closes, period)
        ...
        atr_average = self._atr_average_from_candles(
            candles,
            volatility_period,
            min(50, max(1, len(candles))),
        )
        macd, macd_signal = self._macd_last(closes, 12, 26, 9)
        tick_volume_average = self._volume_average_from_candles(
            candles,
            min(50, max(1, len(candles))),
        )
        adx_window = candles[-(volatility_period * 3 + 1) :]
        adx = self._adx_from_candles(adx_window, volatility_period)
        bollinger_upper, bollinger_lower = self.mt5_market_data_service._bollinger(
            closes,
            min(20, max(1, len(closes))),
            2.0,
        )
        return SimpleNamespace(
            ...
            tick_volume=(
                int(getattr(candles[-1], "volume", 0) or 0) if candles else None
            ),
            ...
            historical_closes=tuple(closes[-500:]),
            historical_ema_values=historical_ema_values,
        )
    ...
    def _post_rollover_priority_scenarios_for_row(
        ...
        time_context = self._mt5_scenario_time_context(
            row,
            include_live_server_rollover=True,
        )
    ...
    def _mt5_lab_target_rank(
        ...
        sample_sufficient = (
            sample_size >= self.traderia_certification_engine.minimum_sample_size
        )
        positive_edge = profit_factor >= 1.30 and expectancy > 0.0
        return (
            str(getattr(scenario, "status", "")) == "APROVADO",
            bool(getattr(scenario, "ict_minimum_filters_passed", False)),
            sample_sufficient,
            positive_edge,
            meets_target,
            expectancy,
    ...
    def _mt5_research_row_rank(
        ...
        return (
            ...
            confidence,
            score,
            float(getattr(row, "sample_size", 0) or 0),
            str(getattr(row, "timeframe", "") or ""),
        )
    ...
    def _mt5_research_scenarios_for_row(
        ...
        # A aprovacao de entrada do M1 pertence ao Lab e nao pode depender de uma
        # politica de saida que este replay nao executa. As Betas continuam sendo
        # tratadas pelo Position Manager depois que a posicao existe.
        return self._mt5_research_entry_finalists(ranked_entry_scenarios)
    ...
    def _mt5_scenario_parameter_grid(
        ...
        *,
        ...
        for ema_short, ema_long in ((9, 21), (14, 50), (20, 50)):
            for atr_stop_factor in (1.5, 2.0, 2.5):
                for rr in (2.0, 2.5, 3.0):
                    for reversal_strength in (0.0003, 0.0006):
                        grid.append(
                            self._mt5_grid_parameters(
                                "ALPHA016",
                                "BETA002_REVERSAL_SIGNAL",
    ...
    def _mt5_expand_beta_strategy_grid(
        ...
        expanded: list[dict[str, object]] = []
        for parameters in base_grid:
            beta_id = str(parameters.get("beta_id", "") or "").upper()
            if beta_id.startswith("BETA") and beta_id not in {"BETA001", "BETA002"}:
                expanded.append(dict(parameters))
                continue
        ...
        return (
            {
                ...
                "beta_id": "BETA003",
                "beta_version": "FIXED_STOP_MANAGER",
                "beta_mode": "FIXED_STOP_ONLY",
                "beta_reason": "Pesquisa de stop: manter stop inicial em R sem saida FULL.",
            },
            {
                ...
                "beta_id": "BETA004",
                "beta_version": "BREAK_EVEN_MANAGER",
                "beta_mode": "BREAK_EVEN_ONLY",
                "beta_reason": "Pesquisa de stop: proteger capital movendo stop para entrada sem saida FULL.",
            },
            {
                ...
                "beta_reason": "Pesquisa de stop: acompanhar preco com trailing por ATR sem saida FULL.",
            },
            {
                ...
                "beta_mode": "CHANDELIER_ONLY",
                "beta_reason": "Pesquisa de stop: seguir maxima/minima por Chandelier sem saida FULL.",
            },
            {
                ...
                "sar_max_step": "0.20",
                "beta_id": "BETA007",
                "beta_version": "PARABOLIC_SAR_MANAGER",
                "beta_mode": "PARABOLIC_SAR_ONLY",
                "beta_reason": "Pesquisa de stop: seguir Parabolic SAR sem saida FULL.",
            },
            {
                "stop_management": "DONCHIAN_CHANNEL_STOP",
                "donchian_stop_period": "20",
                "beta_id": "BETA008",
                "beta_version": "DONCHIAN_STOP_MANAGER",
                "beta_mode": "DONCHIAN_STOP_ONLY",
                "beta_reason": "Pesquisa de stop: usar canal Donchian como protecao sem saida FULL.",
            },
            {
                ...
                "exit_ma_type": "EMA",
                "beta_id": "BETA009",
                "beta_version": "MOVING_AVERAGE_STOP_MANAGER",
                "beta_mode": "MA_STOP_ONLY",
                "beta_reason": "Pesquisa de stop: acompanhar media movel sem saida FULL.",
            },
            {
                ...
                "beta_id": "BETA010",
                "beta_version": "TIME_STOP_MANAGER",
                "beta_mode": "TIME_STOP_ONLY",
                "beta_reason": "Pesquisa de stop: limitar tempo maximo de permanencia sem saida FULL.",
            },
            {
                ...
                "beta_id": "BETA011",
                "beta_version": "VOLATILITY_STOP_MANAGER",
                "beta_mode": "VOLATILITY_STOP_ONLY",
                "beta_reason": "Pesquisa de stop: adaptar protecao ao regime de volatilidade sem saida FULL.",
            },
        )
    ...
    def _mt5_scenario_for_parameters(
        ...
        *,
        ...
        candidate_row = row
        current_candles = self._latest_mt5_forex_candles(
            str(getattr(row, "pair", "")),
            str(getattr(row, "timeframe", "")),
        )
        if current_candles:
            snapshots = self._mt5_scenario_snapshots(row, current_candles, 2)
            if snapshots and snapshots[-1] is not None:
                candidate_row = snapshots[-1]
        candidate = self._mt5_parameterized_candidate(
            candidate_row,
            model,
            parameters,
        )
        ...
        raw_score = min(
            ...
            + self._exit_management_score_adjustment(candidate_row, parameters)
            + self._beta_strategy_score_adjustment(candidate_row, parameters),
        )
        ...
        evidence = self._mt5_scenario_evidence_for_candidate(
            row,
            model,
            parameters,
            decision,
            score,
            temporal_blocking_enabled=temporal_blocking_enabled,
        )
        lab_confidence = evidence.win_rate
        certification = self._mt5_research_certification_from_evidence(evidence)
        status = "APROVADO" if certification.demo_allowed else "REJEITADO"
        if certification.rejection_reasons:
            reason = (
        ...
        return DashboardMT5ScenarioViewModel(
            ...
            lab_discrimination_summary=evidence.discrimination_summary,
    ...
    def _mt5_scenario_evidence_for_candidate(
        self,
        row: object,
        model: str,
        parameters: dict[str, object],
        ...
        score: float,
        *,
        temporal_blocking_enabled: bool = False,
    ) -> MT5ScenarioHistoricalEvidence:
        """Avalia o setup no historico, independentemente do sinal do ultimo candle."""
        del decision, score, temporal_blocking_enabled
        return self._mt5_scenario_historical_evidence(
            row,
            model,
            parameters,
            "HISTORICAL_REPLAY",
    ...
    def _mt5_server_timestamp(self, symbol: str = "EURUSD") -> str:
        ...
        now = time.monotonic()
        cache_ttl = self._positive_float(
            os.getenv("TRADERIA_MT5_SERVER_TIME_CACHE_SECONDS", "2"),
            2.0,
        )
        if (
            self.mt5_server_timestamp_cache_started > 0.0
            and now - self.mt5_server_timestamp_cache_started < cache_ttl
            and self.mt5_server_timestamp_cache_value != "N/D"
        ):
            return self.mt5_server_timestamp_cache_value
        ...
        if not callable(get_server_time):
            return "N/D"
        try:
            value = str(get_server_time(symbol) or "N/D")
        except (OSError, RuntimeError, ValueError, TypeError):
            value = "N/D"
        if value != "N/D":
            object.__setattr__(self, "mt5_server_timestamp_cache_value", value)
            object.__setattr__(self, "mt5_server_timestamp_cache_started", now)
        elif self.mt5_server_timestamp_cache_value != "N/D":
            try:
                cached = datetime.fromisoformat(
                    self.mt5_server_timestamp_cache_value.replace("Z", "+00:00")
                )
                elapsed = max(0.0, now - self.mt5_server_timestamp_cache_started)
                value = (cached + timedelta(seconds=elapsed)).isoformat()
            except (TypeError, ValueError):
                value = "N/D"
        return value

    def _mt5_scenario_time_context(
        self,
        row: object,
        *,
        include_live_server_rollover: bool = False,
    ) -> object:
        pair = str(getattr(row, "pair", "N/D") or "N/D").upper()
        timeframe = str(getattr(row, "timeframe", "N/D") or "N/D").upper()
        candle_time = str(getattr(row, "last_candle_time", "N/D") or "N/D")
        server_timestamp = (
            self._mt5_server_timestamp(pair)
            if include_live_server_rollover
            else "HISTORICAL_CONTEXT"
        )
        key = (pair, timeframe, candle_time, server_timestamp)
        cached = self.mt5_scenario_time_context_cache.get(key)
        if cached is not None:
            return cached
        context = self.forex_time_layer.classify(
            pair,
            candle_time,
            server_timestamp=(
                server_timestamp if include_live_server_rollover else None
            ),
            allow_static_rollover=not include_live_server_rollover,
        )
        self.mt5_scenario_time_context_cache[key] = context
        return context
    ...
    def _mt5_scenario_historical_evidence(
        ...
        market_key = self._mt5_scenario_market_cache_key(row, candles)
        evidence_key = (
            market_key,
            str(model or "").upper(),
            self._mt5_scenario_parameter_cache_key(parameters),
        )
        cached = self.mt5_scenario_evidence_cache.get(evidence_key)
        if cached is not None:
            return cached

        returns: list[float] = []
        discrimination_events: list[dict[str, bool]] = []
        last_exit_index = -1
        for index, candidate_decision, snapshot in self._mt5_scenario_entry_triggers(
            row,
            candles,
            model,
            parameters,
            ...
            if index <= last_exit_index:
                continue
            outcome, exit_index = self._mt5_initial_plan_replay_outcome(
                candles,
                index,
                candidate_decision,
                snapshot,
            ...
            discrimination_events.append(
                self._scenario_discrimination_event(
                    candles,
                    index,
                    candidate_decision,
                    outcome,
                    cache_namespace=market_key,
                )
            )
            last_exit_index = exit_index
        evidence = self._mt5_scenario_evidence_from_returns(
            returns,
            discrimination_events,
            source="SCENARIO_TRADE_PLAN_REPLAY_V2",
        )
        self.mt5_scenario_evidence_cache[evidence_key] = evidence
        return evidence

    def _mt5_scenario_market_cache_key(
        self,
        row: object,
        candles: list[object],
    ) -> tuple[object, ...]:
        ...
        return (
            ...
            str(getattr(row, "timeframe", "") or "").upper(),
            len(candles),
            str(getattr(first, "data", "") or ""),
            str(getattr(last, "data", "") or ""),
            float(getattr(last, "fechamento", 0.0) or 0.0),
        )

    def _mt5_scenario_parameter_cache_key(
        self,
        parameters: dict[str, object],
        *,
        ...
        allowed = set(entry_keys)
        if not entry_only:
            allowed.update({"rr", "atr_stop_factor"})
        return tuple(
            sorted(
                (str(key), str(value))
                for key, value in parameters.items()
    ...
    def _mt5_scenario_snapshots(
        ...
        market_key = self._mt5_scenario_market_cache_key(row, candles)
        cached = self.mt5_scenario_snapshot_cache.get(market_key)
        if cached is not None:
            return cached
        try:
            lookback = max(
                int(os.getenv("TRADERIA_MT5_LAB_REPLAY_LOOKBACK", "500")),
                250,
            )
        except ValueError:
            lookback = 500
        snapshots: list[object] = [None] * len(candles)
        for index in range(1 if len(candles) > 1 else 0, len(candles)):
            start = max(0, index - lookback + 1)
            snapshots[index] = self._theoretical_entry_snapshot(
                row,
                candles[start : index + 1],
            )
        self.mt5_scenario_snapshot_cache[market_key] = snapshots
        return snapshots

    def _mt5_scenario_entry_triggers(
        self,
        row: object,
        candles: list[object],
        model: str,
        ...
        trigger_key = (
            market_key,
            str(model or "").upper(),
            self._mt5_scenario_parameter_cache_key(parameters, entry_only=True),
        )
        cached = self.mt5_scenario_trigger_cache.get(trigger_key)
        if cached is not None:
            return cached
        snapshots = self._mt5_scenario_snapshots(row, candles, minimum)
        previous_decision = "WAIT"
        triggers: list[tuple[int, str, object]] = []
        for index in range(max(minimum - 1, 0), len(candles)):
            snapshot = snapshots[index]
            if snapshot is None:
                continue
            candidate = self._mt5_parameterized_candidate(snapshot, model, parameters)
            decision = str(candidate.get("decision", "WAIT") or "WAIT").upper()
            if previous_decision == "WAIT" and decision in {"BUY", "SELL"}:
                triggers.append((index, decision, snapshot))
            previous_decision = decision
        self.mt5_scenario_trigger_cache[trigger_key] = triggers
        return triggers

    def _mt5_initial_plan_replay_outcome(
        self,
        candles: list[object],
        entry_index: int,
        direction: str,
        ...
        if trade is None:
            return None, len(candles) - 1 if candles else entry_index
        return trade.return_fraction, trade.exit_index

    def _mt5_initial_plan_replay_trade(
        self,
        candles: list[object],
        entry_index: int,
        direction: str,
        ...
        if entry <= 0.0:
            return None
        try:
            stop_multiplier = max(float(parameters.get("atr_stop_factor", 2.0) or 2.0), 0.0)
            risk_reward = max(float(parameters.get("rr", 0.0) or 0.0), 0.0)
        except (TypeError, ValueError):
            return None
        if stop_multiplier <= 0.0 or risk_reward <= 0.0:
            return None
        atr = max(float(getattr(snapshot, "atr", 0.0) or 0.0), 0.0)
        minimum_percent = float(
            self.mt5_research_trade_plan_engine.configuration.minimum_distance_percent
        )
        distance = max(atr * stop_multiplier, abs(entry) * minimum_percent)
        if distance <= 0.0:
            return None
        normalized_direction = str(direction or "").upper()
        if normalized_direction == "BUY":
            stop = entry - distance
            target = entry + distance * risk_reward
        ...
        for index in range(entry_index + 1, len(candles)):
            ...
            if stop_hit:
                return DashboardMT5LabReplayTradeViewModel(
                    entry_index=entry_index,
                    exit_index=index,
                    entry_time=str(getattr(candles[entry_index], "data", "N/D")),
                    exit_time=str(getattr(candle, "data", "N/D")),
            ...
            if target_hit:
                return DashboardMT5LabReplayTradeViewModel(
                    ...
                    exit_price=target,
                    outcome="WIN",
                    return_fraction=risk_fraction * risk_reward,
                    r_multiple=risk_reward,
                    bars_held=index - entry_index,
                )
        return None

    def _clear_mt5_scenario_caches(self, pair: str = "") -> None:
        pair_key = str(pair or "").upper()
        if not pair_key:
            self.mt5_scenario_snapshot_cache.clear()
            self.mt5_scenario_trigger_cache.clear()
            self.mt5_scenario_evidence_cache.clear()
            self.mt5_scenario_discrimination_cache.clear()
            self.mt5_scenario_time_context_cache.clear()
            return
        for cache in (
            self.mt5_scenario_snapshot_cache,
            self.mt5_scenario_trigger_cache,
            self.mt5_scenario_evidence_cache,
            self.mt5_scenario_discrimination_cache,
        ):
            for key in list(cache):
                market_key = key if cache is self.mt5_scenario_snapshot_cache else key[0]
                if market_key and str(market_key[0]).upper() == pair_key:
                    cache.pop(key, None)
        for key in list(self.mt5_scenario_time_context_cache):
            if str(key[0]).upper() == pair_key:
                self.mt5_scenario_time_context_cache.pop(key, None)
    ...
    def _scenario_evidence_indexes(
        ...
        """Retorna todos os candles elegiveis para evidencia historica."""
        return list(range(max(minimum - 1, 0), max(end_index, 0)))

    def _scenario_evidence_index_batches(
        self,
        minimum: int,
        end_index: int,
        batch_size: int | None = None,
    ) -> list[list[int]]:
        """Quebra todos os pontos elegiveis em lotes sem descartar amostra."""
        indexes = self._scenario_evidence_indexes(minimum, end_index)
        if batch_size is None:
            try:
                batch_size = int(
                    os.getenv("TRADERIA_MT5_LAB_CALCULATION_BATCH_SIZE", "100")
                )
            except ValueError:
                batch_size = 100
    ...
    def _mt5_scenario_evidence_from_returns(
        self,
        returns: list[float],
        discrimination_events: list[dict[str, bool]] | None = None,
        *,
        source: str = "SCENARIO_ALPHA_BACKTEST_SAMPLE",
    ) -> MT5ScenarioHistoricalEvidence:
        ...
        return MT5ScenarioHistoricalEvidence(
            ...
            source=source,
            discrimination_summary=self._scenario_discrimination_summary(
                discrimination_events or [],
            ),
            discrimination_metrics=self._scenario_discrimination_metrics(
                discrimination_events or [],
            ),
        )

    def _scenario_discrimination_event(
        self,
        candles: list[object],
        index: int,
        decision: str,
        ...
        *,
        cache_namespace: tuple[object, ...] | None = None,
    ) -> dict[str, bool]:
        cache_key = (
            cache_namespace,
            int(index),
        ...
        cached = self.mt5_scenario_discrimination_cache.get(cache_key)
        if cached is not None:
            return {"win": adjusted_return > 0.0, **cached}
        history = candles[max(0, index - 100) : index + 1]
        closes = [
            float(getattr(candle, "fechamento", 0.0) or 0.0)
            for candle in history
        ]
        if len(closes) < 6:
            return {"win": adjusted_return > 0.0}
        direction = 1.0 if str(decision).upper() == "BUY" else -1.0
        short = closes[-6:]
        price_delta = short[-1] - short[0]
        recent_rsi = self._rsi_last(closes, min(14, max(len(closes) - 1, 2)))
        previous_rsi = self._rsi_last(closes[:-3], min(14, max(len(closes[:-3]) - 1, 2)))
        rsi_delta = recent_rsi - previous_rsi
        macd_histogram = self._macd_histogram_last(closes)
        previous_macd_histogram = self._macd_histogram_last(closes[:-3])
        atr_recent = self._volatility_last(closes, min(14, len(closes)))
        atr_previous = self._volatility_last(closes[:-3], min(14, max(len(closes[:-3]), 1)))
        momentum = self._momentum_last(closes, min(10, max(len(closes) - 1, 1)))
        previous_momentum = self._momentum_last(
            closes[:-3],
            min(10, max(len(closes[:-3]) - 1, 1)),
        )
        adx_period = min(14, max(len(history) - 1, 2))
        adx = self._adx_from_candles(history, adx_period)
        previous_adx = self._adx_from_candles(history[:-3], adx_period)
        metrics = {
            "RSI divergente": (price_delta * direction > 0.0)
            and (rsi_delta * direction < 0.0),
            "MACD hist divergente": (price_delta * direction > 0.0)
            and ((macd_histogram - previous_macd_histogram) * direction < 0.0),
            "ADX indisponivel": adx is None,
            "ADX baixo": adx is not None and adx < 20.0,
            "ADX caindo": adx is not None and previous_adx is not None and adx < previous_adx,
            "ATR em queda": atr_recent < atr_previous,
            "ATR subindo": atr_recent > atr_previous,
            "Momentum contra": momentum * direction < 0.0,
            "Momentum enfraquecendo": (momentum * direction) < (previous_momentum * direction),
        }
        self.mt5_scenario_discrimination_cache[cache_key] = metrics
        return {"win": adjusted_return > 0.0, **metrics}

    def _macd_histogram_last(self, values: list[float]) -> float:
        if len(values) < 26:
            return 0.0
        macd, signal = self._macd_last(values, 12, 26, 9)
        return macd - signal
    ...
    def _macd_last(
        ...
        if len(values) < max(fast_period, slow_period):
            return 0.0, 0.0
        fast_series = self._ema_series_last_aligned(values, fast_period)
        slow_series = self._ema_series_last_aligned(values, slow_period)
        macd_series = [
            fast - slow
            for fast, slow in zip(fast_series, slow_series)
        ]
        macd = macd_series[-1]
        signal = self._ema_last(macd_series, signal_period)
        return macd, signal

    def _ema_series_last_aligned(
        self,
        values: list[float],
        period: int,
    ) -> list[float]:
        if not values:
            return []
        safe_period = max(int(period or 1), 1)
        multiplier = 2.0 / (safe_period + 1.0)
        seed_window = values[: min(safe_period, len(values))]
    ...
    def _ema_last(self, values: list[float], period: int) -> float:
        if not values:
            return 0.0
        safe_period = max(int(period or 1), 1)
        multiplier = 2.0 / (safe_period + 1.0)
    ...
    def _atr_average_from_candles(
        ...
        if len(candles) < 2:
            return 0.0
        safe_window = max(int(average_window or period or 1), 1)
        sample = candles[-(safe_window + 1):]
        true_ranges = []
        previous_close = float(getattr(sample[0], "fechamento", 0.0) or 0.0)
        for candle in sample[1:]:
            ...
            previous_close = float(getattr(candle, "fechamento", 0.0) or 0.0)
        return sum(true_ranges) / len(true_ranges) if true_ranges else 0.0

    def _volume_average_from_candles(
        self,
        candles: list[object],
        period: int,
    ) -> float:
        if not candles:
            return 0.0
        safe_period = max(int(period or 1), 1)
        sample = candles[-safe_period:]
        values = [float(getattr(candle, "volume", 0.0) or 0.0) for candle in sample]
        return sum(values) / len(values) if values else 0.0

    def _adx_from_candles(
        self,
        candles: list[object],
        period: int,
    ) -> float | None:
        safe_period = max(int(period or 1), 1)
        if len(candles) <= safe_period:
            return None
        plus_dm: list[float] = []
        minus_dm: list[float] = []
        true_ranges: list[float] = []
        for previous, current in zip(candles[:-1], candles[1:]):
            previous_high = float(getattr(previous, "maxima", 0.0) or 0.0)
            previous_low = float(getattr(previous, "minima", 0.0) or 0.0)
            previous_close = float(getattr(previous, "fechamento", 0.0) or 0.0)
            current_high = float(getattr(current, "maxima", 0.0) or 0.0)
            current_low = float(getattr(current, "minima", 0.0) or 0.0)
        ...
        for index in range(safe_period, len(true_ranges) + 1):
            tr_sum = sum(true_ranges[index - safe_period : index])
            if tr_sum == 0.0:
                continue
            plus_di = 100.0 * sum(plus_dm[index - safe_period : index]) / tr_sum
            minus_di = 100.0 * sum(minus_dm[index - safe_period : index]) / tr_sum
        ...
        if not dx_values:
            return None
        return sum(dx_values[-safe_period:]) / len(dx_values[-safe_period:])

    def _scenario_discrimination_summary(
        self,
        events: list[dict[str, bool]],
    ) -> str:
        if not events:
            return "Sem eventos para diferenciar vencedores e nao vencedores."
        metrics = self._scenario_discrimination_metrics(events)
        winners_count = int(metrics.get("_sample", {}).get("winners", 0.0))
        losers_count = int(metrics.get("_sample", {}).get("losers", 0.0))
        if not winners_count or not losers_count:
            return (
                f"Amostra unilateral: {winners_count} vencedores e "
                f"{losers_count} nao vencedores."
            )
        summaries = []
        for indicator, values in metrics.items():
            if indicator == "_sample":
                continue
            winner_rate = float(values.get("winner_rate", 0.0) or 0.0)
            loser_rate = float(values.get("loser_rate", 0.0) or 0.0)
            difference = float(values.get("difference", 0.0) or 0.0)
            summaries.append((difference, indicator, winner_rate, loser_rate))
        summaries.sort(reverse=True)
        parts = []
        for difference, indicator, winner_rate, loser_rate in summaries:
            if abs(difference) < 0.10:
                continue
            label = (
                "mais nos nao vencedores"
                if difference > 0
                else "mais nos vencedores"
            )
            parts.append(
                f"{indicator}: V {winner_rate:.0%} x NV {loser_rate:.0%} ({label})"
            )
        if not parts:
            return "Nenhum indicador discriminou vencedores e nao vencedores com diferenca relevante."
        return " | ".join(parts[:3])

    def _scenario_discrimination_metrics(
        self,
        events: list[dict[str, bool]],
        ...
        winners = [event for event in events if event.get("win")]
        losers = [event for event in events if not event.get("win")]
        ...
        for indicator in indicators:
            winner_rate = (
                sum(1 for event in winners if event.get(indicator)) / len(winners)
                if winners
                else 0.0
            )
            loser_rate = (
                sum(1 for event in losers if event.get(indicator)) / len(losers)
                if losers
                else 0.0
            )
            metrics[indicator] = {
                "winner_rate": winner_rate,
                "loser_rate": loser_rate,
                "difference": loser_rate - winner_rate,
            }
        return metrics
    ...
    def _mt5_parameterized_candidate(
        ...
        row = self._mt5_candidate_row_for_parameters(row, parameters)
        alpha_id = str(parameters.get("alpha", "ALPHA001")).upper()
    ...
    def _mt5_candidate_row_for_parameters(
        self,
        row: object,
        parameters: dict[str, object],
    ) -> object:
        """Aplica as EMAs pesquisadas ao candle historico sem contaminar o runtime."""
        closes = list(getattr(row, "historical_closes", ()) or ())
        ema_values = dict(getattr(row, "historical_ema_values", {}) or {})
        if not closes and not ema_values:
            return row
        try:
            ema_short = max(int(float(parameters.get("ema_curta", 9) or 9)), 1)
            ema_long = max(int(float(parameters.get("ema_longa", 21) or 21)), 1)
        except (TypeError, ValueError):
            return row
        from types import SimpleNamespace

        values = dict(vars(row)) if hasattr(row, "__dict__") else {}
        short_average = float(
            ema_values[ema_short]
            if ema_short in ema_values
            else self._ema_last(closes, ema_short)
        )
        long_average = float(
            ema_values[ema_long]
            if ema_long in ema_values
            else self._ema_last(closes, ema_long)
        )
        values.update(
            short_average=short_average,
            long_average=long_average,
            ema_fast=short_average,
            ema_slow=long_average,
            trend=self._trend_from_averages(short_average, long_average),
        )
    ...
    def _beta002_reversal_signal_parameterized_candidate(
        self,
        row: object,
        parameters: dict[str, object],
    ) -> dict[str, object]:
        missing = self._missing_indicators(row, "trend", "momentum", "volatility")
        if missing:
            return self._indicator_unavailable_candidate(*missing)
        trend = str(getattr(row, "trend", "INDEFINIDA") or "INDEFINIDA").upper()
        momentum = float(getattr(row, "momentum", 0.0) or 0.0)
        volatility = abs(float(getattr(row, "volatility", 0.0) or 0.0))
        confidence = float(getattr(row, "confidence", 0.0) or 0.0)
        reversal_strength = abs(
            float(parameters.get("reversal_strength", 0.0003) or 0.0003)
        )
        volatility_threshold = abs(
            float(parameters.get("volatility_threshold", 0.0) or 0.0)
        )
        rr = float(parameters["rr"])
        atr_stop_factor = float(parameters["atr_stop_factor"])
        parameter_fit = self._mt5_parameter_fit(row, parameters)
        buy = trend == "BAIXA" and momentum > reversal_strength
        sell = trend == "ALTA" and momentum < -reversal_strength
        decision = "BUY" if buy else "SELL" if sell else "WAIT"
        score = 0.0
        if decision != "WAIT" and volatility >= volatility_threshold:
            score = confidence + 0.18
            score += min(abs(momentum) * 35.0, 0.18)
            score += min(volatility * 25.0, 0.12)
            score += self._rr_score_adjustment(rr)
            score += self._atr_score_adjustment(volatility, atr_stop_factor)
            score += parameter_fit
        return {
            ...
            "score": min(score, 1.0),
            "reason": (
                "Reversao candidata: tendencia previa perdeu continuidade e momentum virou contra o fluxo."
                if score > 0
                else "Sem reversao suficiente por momentum/volatilidade."
            ),
        }
