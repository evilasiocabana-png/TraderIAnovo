"""Contrato para registry logico de referencias historicas."""
...
class HistoricalDatasetReferenceRegistry:
    """DTO imutavel para agrupar referencias leves de datasets historicos."""
