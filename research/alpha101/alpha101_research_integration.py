"""Integracao da Alpha101 com a infraestrutura existente de Research."""
...
class Alpha101ResearchIntegration:
    """Permite que a Alpha101 reutilize o ecossistema de Research existente."""
    ...
    def run_research(
        ...
        """Executa a Alpha101 no ResearchPipeline ja existente."""
    ...
    def run_with_runner(
        ...
        """Executa a Alpha101 usando um ResearchRunner configurado."""
        return runner.run(
            experiment=experiment,
            benchmark_results=benchmark_results,
        )
    ...
    def build_campaign(
        ...
        """Monta experimentos Alpha101 usando o CampaignBuilder existente."""
