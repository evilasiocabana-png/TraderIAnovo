"""Integracao da Alpha201 com a infraestrutura existente de Research."""
...
class Alpha201ResearchIntegration:
    """Permite que a Alpha201 reutilize o ecossistema de Research existente."""
    ...
    def run_research(
        ...
        """Executa a Alpha201 no ResearchPipeline ja existente."""
    ...
    def run_with_runner(
        ...
        """Executa a Alpha201 usando um ResearchRunner configurado."""
        return runner.run(
            experiment=experiment,
            benchmark_results=benchmark_results,
        )
    ...
    def build_campaign(
        ...
        """Monta experimentos Alpha201 usando o CampaignBuilder existente."""
