...
Indice oficial das missoes executadas pelo fluxo `codex/inbox`.

| ID | Nome | Status | Inicio | Termino | Duracao | Branch | Commit | Responsavel |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| MISSION_TIA-043_M24_CANONICAL_SETUP_GUARD | Canonicalizar setup M24 e impedir drift de motor, tela, estado e docs | completed | 2026-08-19 | 2026-08-19 | N/D | codex/multi-ea-trading-lab | ad2716d | Codex |
| MISSION_TIA-044_M24_ASYNC_PRICE_RSI_CROSSES | Exigir cruzamentos assincronos de preco/SMA20 e RSI14/50 na INITIAL M24 | completed | 2026-08-19 | 2026-08-19 | N/D | codex/multi-ea-trading-lab | ae5268c | Codex |
| MISSION_TIA-045_M24_CONTINUATION_AFTER_REENTRY_TP | Criar CONTINUATION M24 0,40 apos TP confirmado da REENTRY | completed | 2026-08-19 | 2026-08-19 | N/D | codex/multi-ea-trading-lab | ae5268c | Codex |

## Regras

- Registrar toda missao movida para `processing`.
- Atualizar status para `completed` ou `failed` ao final.
- Registrar commit e branch quando houver commit.
- Registrar blocker em `BLOCKED_ITEMS.md` quando a missao falhar por dependencia.
